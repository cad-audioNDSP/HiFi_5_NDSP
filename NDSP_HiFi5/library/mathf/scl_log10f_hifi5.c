...
{
  /*
   * Reference C code for SCL_LOG10F_ERRH == 0:
   *
   *   float32_t y,e1,e2;
   *   int e;
   *  
  ...
  cf0 = (xtfloatx2)log10f_tbl[0].f; cf1 = (xtfloatx2)log10f_tbl[1].f;
  cf2 = (xtfloatx2)log10f_tbl[2].f; cf3 = (xtfloatx2)log10f_tbl[3].f;
  cf4 = (xtfloatx2)log10f_tbl[4].f; cf5 = (xtfloatx2)log10f_tbl[5].f;
  cf6 = (xtfloatx2)log10f_tbl[6].f; cf7 = (xtfloatx2)log10f_tbl[7].f;
  cf8 = (xtfloatx2)log10f_tbl[8].f; 

  XT_MADDN_SX2(cf2, cf1, fr0);
  XT_MADDN_SX2(cf4, cf3, fr0);
  XT_MADDN_SX2(cf6, cf5, fr0);
  XT_MADDN_SX2(cf8, cf7, fr0);

  g = cf0;
  XT_MADDN_SX2(cf2, g, fr2); g = cf2;
  XT_MADDN_SX2(cf4, g, fr2); g = cf4;
  XT_MADDN_SX2(cf6, g, fr2); g = cf6;
  XT_MADDN_SX2(cf8, g, fr2); g = cf8;

  /* 
   * Compute y = fr*g + ex*log10(2)
   */

  XT_MADDN_SX2( y0, y0, _4log10_2minus1.f );
