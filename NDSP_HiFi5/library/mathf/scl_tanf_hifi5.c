...
float32_t scl_tanf (float32_t x)
{
  ...
  ae_int32x2 sx, sz, s;
  /* Reducted input value and its powers */
  xtfloatx2 p, p2, p3, p4;
  ...
  ae_int64 fstate;
#endif
  /* pi/2 splitted into 24-bit chunks. */
  const union ufloat32uint32 ALIGN(16) c[3] = {
  ...
  cf0 = (xtfloatx2)polytanf_tbl[0].f; cf1 = (xtfloatx2)polytanf_tbl[4].f;
  cf2 = (xtfloatx2)polytanf_tbl[8].f; cf3 = (xtfloatx2)polytanf_tbl[12].f;
  cf4 = (xtfloatx2)polytanf_tbl[16].f; cf5 = (xtfloatx2)polytanf_tbl[20].f;
  cf6 = (xtfloatx2)polytanf_tbl[24].f;

  p2 = XT_MUL_SX2( p, p );
  p3 = XT_MUL_SX2( p2, p );
  p4 = XT_MUL_SX2( p2, p2 );

  MADD_SX2(cf2, p2, cf1); cf1 = cf2;
  MADD_SX2(cf4, p2, cf3); cf2 = cf4;
  MADD_SX2(cf6, p2, cf5); cf3 = cf6;
  z0 = cf0;
  MADD_SX2(cf1, p4, z0); z0 = cf1;
  MADD_SX2(cf2, p4, z0); z0 = cf2;
  MADD_SX2(cf3, p4, z0); z0 = cf3;
...
float32_t scl_tanf(float32_t x)
{
    ...
    */

    {
        ...
        */
        {
            static const union ufloat32uint32 c[3] = {
                        { 0x3fc90fdb }, { 0xb33bbd2e },
                        { 0xa6f72ced }
            };
