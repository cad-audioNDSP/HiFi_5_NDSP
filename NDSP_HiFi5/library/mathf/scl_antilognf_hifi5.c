...
float32_t scl_antilognf( float32_t x )
{
  ...
  g = cf0; t = cf1;
  AE_MULAFP32X2RAS(t, f0, g); g = t; t = cf2;
  AE_MULAFP32X2RAS(t, f0, g); g = t; t = cf3;
  AE_MULAFP32X2RAS(t, f0, g); g = t; t = cf4;
  AE_MULAFP32X2RAS(t, f0, g); g = t; t = cf5;
  AE_MULAFP32X2RAS(t, f0, g); g = t; t = cf6;
  AE_MULAFP32X2RAS(t, f0, g); g = t;
...
float32_t scl_antilognf( float32_t x )
{
  ...
  p = XT_TRUNC_S( XT_MUL_S( x0, XT_FLOAT_S( 1 << 9, 0 ) ), 15 );
  ...
  h = cf0; t = cf1;
  AE_MULAFP32X2RAS(t, f1, h); h = t; t = cf2;
  AE_MULAFP32X2RAS(t, f1, h); h = t; t = cf3;
  AE_MULAFP32X2RAS(t, f1, h); h = t; t = cf4;
  AE_MULAFP32X2RAS(t, f1, h); h = t; t = cf5;
  AE_MULAFP32X2RAS(t, f1, h); h = t; t = cf6;
  AE_MULAFP32X2RAS(t, f1, h); h = t;
