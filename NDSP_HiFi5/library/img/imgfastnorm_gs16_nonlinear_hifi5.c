...
void imgfastnorm_gs16_nonlinear ( void * restrict outImg, const void * restrict inImg, const imgsize_t* sz, const int16_t* tbl)
{
    ...
    for (i = 0; i < h; i++)
    {
        ...
        {                
            ...
            y00 = AE_SEL16_7362(y00, y01);
            y02 = AE_SEL16_7362(y02, y03);
            y0 = AE_SEL16_7632(y00, y02);

            //AE_MOVT16X4(y10, y11, AE_MOVAB4(4));
            //AE_MOVT16X4(y12, y13, AE_MOVAB4(4));
            y10 = AE_SEL16_7362(y10, y11);
            y12 = AE_SEL16_7362(y12, y13);
            ...
            z = AE_MAX16(z, 0);
            AE_S16X4_IP(z, pOut, 4 * sizeof(int16_t));
        }
        //tail
        if (w & 3)
        {
