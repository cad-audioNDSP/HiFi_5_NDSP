...
void img_gs16_rot270_16(void* pScr,void* outImg, imgsize_t * restrict outSz, const void* inImg, const imgsize_t * restrict inSz, int fillColor)
{
  ...
  for (i=0; i<(w>>3); i++)
  {
    src0 = (const ae_int16 *)((uintptr_t)inImg + (((w - 1 - 8 * i - 0) * istride) * sizeof(int16_t)));
    src1 = (const ae_int16 *)((uintptr_t)inImg + (((w - 1 - 8 * i - 1) * istride) * sizeof(int16_t)));
    ...
    dst2 = (ae_int16 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + (2)* ostride)*sizeof(int16_t)) + 8 * i;
    dst3 = (ae_int16 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + (3)* ostride)*sizeof(int16_t)) + 8 * i;
    dst4 = (ae_int16 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + (4)* ostride)*sizeof(int16_t)) + 8 * i;
    dst5 = (ae_int16 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + (5)* ostride)*sizeof(int16_t)) + 8 * i;
    dst6 = (ae_int16 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + (6)* ostride)*sizeof(int16_t)) + 8 * i;
    dst7 = (ae_int16 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + (7)* ostride)*sizeof(int16_t)) + 8 * i;
    __Pragma("loop_count min =1 ")
    for (j=0; j<(h>>3); j++) //27
    {
      aX = AE_LA128_PP(src0); AE_LA16X4X2_IP(x0, y0, aX, castxcc(ae_int16x8, src0)); src0 += -8 - 2 * istride;
      aX = AE_LA128_PP(src1); AE_LA16X4X2_IP(x1, y1, aX, castxcc(ae_int16x8, src1)); src1 += -8 - 2 * istride;
      aX = AE_LA128_PP(src0); AE_LA16X4X2_IP(x2, y2, aX, castxcc(ae_int16x8, src0)); src0 += -8 - 2 * istride;
      aX = AE_LA128_PP(src1); AE_LA16X4X2_IP(x3, y3, aX, castxcc(ae_int16x8, src1)); src1 += -8 - 2 * istride;
      aX = AE_LA128_PP(src0); AE_LA16X4X2_IP(x4, y4, aX, castxcc(ae_int16x8, src0)); src0 += -8 - 2 * istride;
      aX = AE_LA128_PP(src1); AE_LA16X4X2_IP(x5, y5, aX, castxcc(ae_int16x8, src1)); src1 += -8 - 2 * istride;
      aX = AE_LA128_PP(src0); AE_LA16X4X2_IP(x6, y6, aX, castxcc(ae_int16x8, src0)); src0 += 3 * 2 * istride;
      aX = AE_LA128_PP(src1); AE_LA16X4X2_IP(x7, y7, aX, castxcc(ae_int16x8, src1)); src1 += 3 * 2 * istride;
      ...
      AE_SA16X4X2_IP(x0, x4, aY, castxcc(ae_int16x8, dst3)); AE_SA128POS_FP(aY, dst3); dst3 += 8 * ostride - 8;
      AE_SA16X4X2_IP(x1, x5, aY, castxcc(ae_int16x8, dst2)); AE_SA128POS_FP(aY, dst2); dst2 += 8 * ostride - 8;
      AE_SA16X4X2_IP(x2, x6, aY, castxcc(ae_int16x8, dst1)); AE_SA128POS_FP(aY, dst1); dst1 += 8 * ostride - 8;
      AE_SA16X4X2_IP(x3, x7, aY, castxcc(ae_int16x8, dst0)); AE_SA128POS_FP(aY, dst0); dst0 += 8 * ostride - 8;
      ...
      AE_SA16X4X2_IP(y0, y4, aY, castxcc(ae_int16x8, dst7)); AE_SA128POS_FP(aY, dst7); dst7 += 8 * ostride - 8;
      AE_SA16X4X2_IP(y1, y5, aY, castxcc(ae_int16x8, dst6)); AE_SA128POS_FP(aY, dst6); dst6 += 8 * ostride - 8;
      AE_SA16X4X2_IP(y2, y6, aY, castxcc(ae_int16x8, dst5)); AE_SA128POS_FP(aY, dst5); dst5 += 8 * ostride - 8;
      AE_SA16X4X2_IP(y3, y7, aY, castxcc(ae_int16x8, dst4)); AE_SA128POS_FP(aY, dst4); dst4 += 8 * ostride - 8;
    }
  }
  __Pragma("no_reorder");
  for (j = 0; j<(h&7); j++)
  {
    src0 = (const ae_int16 *)((uintptr_t)inImg + ((w - 1 - 0) * istride + (h - 1 - j)) * sizeof(int16_t));
    src1 = (const ae_int16 *)((uintptr_t)inImg + ((w - 1 - 1) * istride + (h - 1 - j)) * sizeof(int16_t));
    src2 = (const ae_int16 *)((uintptr_t)inImg + ((w - 1 - 2) * istride + (h - 1 - j)) * sizeof(int16_t));
    src3 = (const ae_int16 *)((uintptr_t)inImg + ((w - 1 - 3) * istride + (h - 1 - j)) * sizeof(int16_t));
    src4 = (const ae_int16 *)((uintptr_t)inImg + ((w - 1 - 4) * istride + (h - 1 - j)) * sizeof(int16_t));
    src5 = (const ae_int16 *)((uintptr_t)inImg + ((w - 1 - 5) * istride + (h - 1 - j)) * sizeof(int16_t));
    src6 = (const ae_int16 *)((uintptr_t)inImg + ((w - 1 - 6) * istride + (h - 1 - j)) * sizeof(int16_t));
    src7 = (const ae_int16 *)((uintptr_t)inImg + ((w - 1 - 7) * istride + (h - 1 - j)) * sizeof(int16_t));
  ...
  for (i=0; i<(w&7); i++)
  {
    src0 = (const ae_int16 *)((uintptr_t)inImg + (i * istride) * sizeof(int16_t));
    dst0 = (      ae_int16 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + (0)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst1 = (      ae_int16 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + (1)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst2 = (      ae_int16 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + (2)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst3 = (      ae_int16 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + (3)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst4 = (      ae_int16 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + (4)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst5 = (      ae_int16 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + (5)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst6 = (      ae_int16 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + (6)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst7 = (      ae_int16 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + (7)* ostride + (w - 1 - i))*sizeof(int16_t));
    

    for (j = 0; j<(h>>3); j++)
    {
      aX = AE_LA128_PP(src0); AE_LA16X4X2_IP(x0, x1, aX, castxcc(ae_int16x8, src0));
      AE_S16_0_XP(x0, castxcc(ae_int16, dst3), 8 * ostride*sizeof(int16_t));
      x0 = AE_SEL16_4321(x0, x0);
      AE_S16_0_XP(x0, castxcc(ae_int16, dst2), 8 * ostride*sizeof(int16_t));
      x0 = AE_SEL16_4321(x0, x0);
      AE_S16_0_XP(x0, castxcc(ae_int16, dst1), 8 * ostride*sizeof(int16_t));
      x0 = AE_SEL16_4321(x0, x0);
      AE_S16_0_XP(x0, castxcc(ae_int16, dst0), 8 * ostride*sizeof(int16_t));

      AE_S16_0_XP(x1, castxcc(ae_int16, dst7), 8 * ostride*sizeof(int16_t));
      x1 = AE_SEL16_4321(x1, x1);
      AE_S16_0_XP(x1, castxcc(ae_int16, dst6), 8 * ostride*sizeof(int16_t));
      x1 = AE_SEL16_4321(x1, x1);
      AE_S16_0_XP(x1, castxcc(ae_int16, dst5), 8 * ostride*sizeof(int16_t));
      x1 = AE_SEL16_4321(x1, x1);
      AE_S16_0_XP(x1, castxcc(ae_int16, dst4), 8 * ostride*sizeof(int16_t));
    }

    src0 = (const ae_int16 *)((uintptr_t)inImg + (i* istride + (h - 1)) * sizeof(int16_t));
