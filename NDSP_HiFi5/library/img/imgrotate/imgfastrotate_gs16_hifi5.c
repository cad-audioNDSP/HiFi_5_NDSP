...
size_t imgfast_gs16_getScratchSize     (const imgrotate_params_t* params) 
{ 
...
static const tImgRotateApi imgfastrotate_gs16_api=
{
    imgfast_gs16_rotq,
    imgfast_gs16_rotq16,
    img_gs_vshear,
    img_gs_hshear,
    imgfast_gs16_crop,
    imgfast_gs16_getScratchSize,
    IMGFASTROTATE_GS16_MAGIC, /* magic number for identification     */
    2,                      /* bytes per pixel                     */
    1,                      /* 1 - fast, 0 - generic               */
...
-------------------------------------------------------------------------*/
size_t             imgfastrotate_gs16_alloc         ( const imgrotate_params_t * params ) { return imgrotate_alloc(params,&imgfastrotate_gs16_api); }
imgrotate_handle_t imgfastrotate_gs16_init          ( void * objmem, const imgrotate_params_t * params ) { return imgrotate_init(objmem,params,&imgfastrotate_gs16_api); }
void               imgfastrotate_gs16_getOutSize    (imgsize_t * restrict outSz, const imgrotate_params_t * params) { imgrotate_getOutSize(outSz,params,&imgfastrotate_gs16_api); }
void               imgfastrotate_gs16_process       ( imgrotate_handle_t handle, void * restrict pScr, void * restrict outImg, const void * restrict inImg, const imgsize_t *outSz) { imgrotate_process  ( handle, pScr, outImg, inImg,outSz); }
size_t             imgfastrotate_gs16_getScratchSize( const imgrotate_params_t * params ) { return imgrotate_getScratchSize(params,&imgfastrotate_gs16_api); }
