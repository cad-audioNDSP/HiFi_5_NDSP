...
void img_gs16_rot90  (void * pScr, void* outImg, const imgsize_t * restrict outSz, const void* inImg, const imgsize_t * restrict inSz)
{
  ...
  for (i=0; i<(w>>3); i++)
  {
    ...
    dst0 = (ae_int16 *)((uintptr_t)outImg + (((h & 7) + 0)* ostride)*sizeof(int16_t)) + 8 * i;
    dst1 = (ae_int16 *)((uintptr_t)outImg + (((h & 7) + 1)* ostride)*sizeof(int16_t)) + 8 * i;
    dst2 = (ae_int16 *)((uintptr_t)outImg + (((h & 7) + 2)* ostride)*sizeof(int16_t)) + 8 * i;
    dst3 = (ae_int16 *)((uintptr_t)outImg + (((h & 7) + 3)* ostride)*sizeof(int16_t)) + 8 * i;
    dst4 = (ae_int16 *)((uintptr_t)outImg + (((h & 7) + 4)* ostride)*sizeof(int16_t)) + 8 * i;
    dst5 = (ae_int16 *)((uintptr_t)outImg + (((h & 7) + 5)* ostride)*sizeof(int16_t)) + 8 * i;
    dst6 = (ae_int16 *)((uintptr_t)outImg + (((h & 7) + 6)* ostride)*sizeof(int16_t)) + 8 * i;
    dst7 = (ae_int16 *)((uintptr_t)outImg + (((h & 7) + 7)* ostride)*sizeof(int16_t)) + 8 * i;
  ...
  for (j = 0; j<(h&7); j++)
  {
    ...
    dst0 = (ae_int16 *)((uintptr_t)outImg + (j * ostride)*sizeof(int16_t));  
    for (i = 0; i<(w >> 3); i++) //4
    {
  ...
  for (i=0; i<(w&7); i++)
  {
    ...
    dst0 = (      ae_int16 *)((uintptr_t)outImg + (((h & 7) + 0)* ostride  + (w - 1 - i))*sizeof(int16_t));
    dst1 = (      ae_int16 *)((uintptr_t)outImg + (((h & 7) + 1)* ostride  + (w - 1 - i))*sizeof(int16_t));
    dst2 = (      ae_int16 *)((uintptr_t)outImg + (((h & 7) + 2)* ostride  + (w - 1 - i))*sizeof(int16_t));
    dst3 = (      ae_int16 *)((uintptr_t)outImg + (((h & 7) + 3)* ostride  + (w - 1 - i))*sizeof(int16_t));
    dst4 = (      ae_int16 *)((uintptr_t)outImg + (((h & 7) + 4)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst5 = (      ae_int16 *)((uintptr_t)outImg + (((h & 7) + 5)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst6 = (      ae_int16 *)((uintptr_t)outImg + (((h & 7) + 6)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst7 = (      ae_int16 *)((uintptr_t)outImg + (((h & 7) + 7)* ostride + (w - 1 - i))*sizeof(int16_t));
    ...
    dst0 = (      ae_int16 *)((uintptr_t)outImg + (w - 1 - i) *sizeof(int16_t));
    for (j = 0; j<(h & 7); j++)
    {
