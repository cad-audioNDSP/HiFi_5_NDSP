...
size_t img_gu8_getScratchSize     (const imgrotate_params_t* params) 
{ 
...
static const tImgRotateApi imgrotate_gu8_api=
{
    img_gu8_rotq,
    img_gu8_rotq16, 
    img_gs_vshear,
    img_gs_hshear,
    img_gu8_crop,
    img_gu8_getScratchSize,
    IMGROTATE_GU8_MAGIC, /* magic number for identification     */
    1,                  /* bytes per pixel                     */
    0,                  /* 1 - fast, 0 - generic               */
...
-------------------------------------------------------------------------*/
size_t             imgrotate_gu8_alloc         ( const imgrotate_params_t * params ) { return imgrotate_alloc(params,&imgrotate_gu8_api); }
imgrotate_handle_t imgrotate_gu8_init          ( void * objmem, const imgrotate_params_t * params ) { return imgrotate_init(objmem,params,&imgrotate_gu8_api); }
void               imgrotate_gu8_getOutSize    (imgsize_t * restrict outSz, const imgrotate_params_t * params) 
{ 
imgrotate_getOutSize(outSz,params,&imgrotate_gu8_api);
 }
void               imgrotate_gu8_process       ( imgrotate_handle_t handle, void * restrict pScr, void * restrict outImg, const void * restrict inImg, const imgsize_t *outSz) { imgrotate_process  ( handle, pScr, outImg, inImg,outSz); }
size_t             imgrotate_gu8_getScratchSize( const imgrotate_params_t * params ) { return imgrotate_getScratchSize(params,&imgrotate_gu8_api); }
