...
void imgfast_gs8_rotq16(void* pScr, void* outImg, imgsize_t * restrict outSz, const void* inImg, const imgsize_t * restrict inSz, int q, int fillColor)
{
    ...
    case 0:
        // copy
        imgfast_gs8_rot0_16(pScr, outImg, outSz, inImg, inSz, fillColor);
        break;
    case 1:
        // rotate by 90 degrees counterclockwise
        imgfast_gs8_rot90_16(pScr, outImg, outSz, inImg, inSz, fillColor);
        break;
    case 2:
        // flip by 180 degrees
        imgfast_gs8_rot180_16(pScr, outImg, outSz, inImg, inSz, fillColor);
        break;
    case 3:
        // rotate by 270 degrees counterclockwise
        imgfast_gs8_rot270_16(pScr, outImg, outSz, inImg, inSz, fillColor);
        break;
    }
} /* imgfast_gu8_rotq16() */
