...
size_t img_gs16_getScratchSize     (const imgrotate_params_t* params) 
{ 
...
static const tImgRotateApi imgrotate_gs16_api=
{
    img_gs16_rotq,
    img_gs16_rotq16,
    img_gs_vshear,
    img_gs_hshear,
    img_gs16_crop,
    img_gs16_getScratchSize,
    IMGROTATE_GS16_MAGIC, /* magic number for identification     */
    2,                  /* bytes per pixel                     */
    0,                  /* 1 - fast, 0 - generic               */
...
-------------------------------------------------------------------------*/
size_t             imgrotate_gs16_alloc         ( const imgrotate_params_t * params ) { return imgrotate_alloc(params,&imgrotate_gs16_api); }
imgrotate_handle_t imgrotate_gs16_init          ( void * objmem, const imgrotate_params_t * params ) { return imgrotate_init(objmem,params,&imgrotate_gs16_api); }
void               imgrotate_gs16_getOutSize    (imgsize_t * restrict outSz, const imgrotate_params_t * params) { imgrotate_getOutSize(outSz,params,&imgrotate_gs16_api); }
void               imgrotate_gs16_process       ( imgrotate_handle_t handle, void * restrict pScr, void * restrict outImg, const void * restrict inImg, const imgsize_t *outSz) { imgrotate_process  ( handle, pScr, outImg, inImg,outSz); }
size_t             imgrotate_gs16_getScratchSize( const imgrotate_params_t * params ) { return imgrotate_getScratchSize(params,&imgrotate_gs16_api); }
