...
void imgfast_gs16_rot270_16(void* pScr, void* outImg, imgsize_t * restrict outSz, const void* inImg, const imgsize_t * restrict inSz, int fillColor)
{
  ...
  for (i=0; i<(w>>3); i++)
  {
    src0 = (const ae_int16x8 *)((uintptr_t)inImg + ((w - 1 - 8 * i - 0) * istride) * sizeof(int16_t));
    src1 = (const ae_int16x8 *)((uintptr_t)inImg + ((w - 1 - 8 * i - 1) * istride) * sizeof(int16_t));
    src2 = (const ae_int16x8 *)((uintptr_t)inImg + ((w - 1 - 8 * i - 2) * istride) * sizeof(int16_t));
    src3 = (const ae_int16x8 *)((uintptr_t)inImg + ((w - 1 - 8 * i - 3) * istride) * sizeof(int16_t));
    src4 = (const ae_int16x8 *)((uintptr_t)inImg + ((w - 1 - 8 * i - 4) * istride) * sizeof(int16_t));
    src5 = (const ae_int16x8 *)((uintptr_t)inImg + ((w - 1 - 8 * i - 5) * istride) * sizeof(int16_t));
    src6 = (const ae_int16x8 *)((uintptr_t)inImg + ((w - 1 - 8 * i - 6) * istride) * sizeof(int16_t));
    src7 = (const ae_int16x8 *)((uintptr_t)inImg + ((w - 1 - 8 * i - 7) * istride) * sizeof(int16_t));

    dst0 = (ae_int16x8 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + 0 * ostride)*sizeof(int16_t)) + i;
    dst4 = (ae_int16x8 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + 4 * ostride)*sizeof(int16_t)) + i;
    ...
    for (j=0; j<(h>>3); j++)
    {
      ...
      AE_DSEL16X4(x3, x2, z2, z3, dsel1);
      AE_DSEL16X4(x1, x0, z0, z1, dsel1);

      AE_DSEL16X4(z0, z2, x4, x5, dsel0);
      AE_DSEL16X4(z1, z3, x6, x7, dsel0);
      AE_DSEL16X4(x7, x6, z2, z3, dsel1);
      AE_DSEL16X4(x5, x4, z0, z1, dsel1);

      AE_S16X4X2_XP(x0, x4, dst0, ostride*sizeof(int16_t));
      AE_S16X4X2_XP(x1, x5, dst0, ostride*sizeof(int16_t));
      AE_S16X4X2_XP(x2, x6, dst0, ostride*sizeof(int16_t));
      AE_S16X4X2_XP(x3, x7, dst0, 5 * ostride*sizeof(int16_t));

      AE_DSEL16X4(z4, z6, y0, y1, dsel0);
      AE_DSEL16X4(z5, z7, y2, y3, dsel0);
      AE_DSEL16X4(y3, y2, z6, z7, dsel1);
      AE_DSEL16X4(y1, y0, z4, z5, dsel1);


      AE_DSEL16X4(z4, z6, y4, y5, dsel0);
      AE_DSEL16X4(z5, z7, y6, y7, dsel0);
      AE_DSEL16X4(y7, y6, z6, z7, dsel1);
      AE_DSEL16X4(y5, y4, z4, z5, dsel1);


      AE_S16X4X2_XP(y0, y4, dst4, ostride*sizeof(int16_t));
      AE_S16X4X2_XP(y1, y5, dst4, ostride*sizeof(int16_t));
      AE_S16X4X2_XP(y2, y6, dst4, ostride*sizeof(int16_t));
      AE_S16X4X2_XP(y3, y7, dst4, 5 * ostride*sizeof(int16_t));
    }
  }
  __Pragma("no_reorder");
  for (j = 0; j<(h&7); j++)
  {
    src0 = (const ae_int16x8 *)((uintptr_t)inImg + ((w - 1 - 0) * istride + (h - 1 - j)) * sizeof(int16_t));
    src1 = (const ae_int16x8 *)((uintptr_t)inImg + ((w - 1 - 1) * istride + (h - 1 - j)) * sizeof(int16_t));
    src2 = (const ae_int16x8 *)((uintptr_t)inImg + ((w - 1 - 2) * istride + (h - 1 - j)) * sizeof(int16_t));
    src3 = (const ae_int16x8 *)((uintptr_t)inImg + ((w - 1 - 3) * istride + (h - 1 - j)) * sizeof(int16_t));
    src4 = (const ae_int16x8 *)((uintptr_t)inImg + ((w - 1 - 4) * istride + (h - 1 - j)) * sizeof(int16_t));
    src5 = (const ae_int16x8 *)((uintptr_t)inImg + ((w - 1 - 5) * istride + (h - 1 - j)) * sizeof(int16_t));
    src6 = (const ae_int16x8 *)((uintptr_t)inImg + ((w - 1 - 6) * istride + (h - 1 - j)) * sizeof(int16_t));
    src7 = (const ae_int16x8 *)((uintptr_t)inImg + ((w - 1 - 7) * istride + (h - 1 - j)) * sizeof(int16_t));
  ...
  for (i=0; i<(w&7); i++)
  {
    ...
    src0 = (const ae_int16x8 *)((uintptr_t)inImg + (i * istride) * sizeof(int16_t));
    dst0 = (ae_int16x8 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + (0)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst1 = (ae_int16x8 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + (1)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst2 = (ae_int16x8 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + (2)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst3 = (ae_int16x8 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + (3)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst4 = (ae_int16x8 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + (4)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst5 = (ae_int16x8 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + (5)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst6 = (ae_int16x8 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + (6)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst7 = (ae_int16x8 *)((uintptr_t)outImg + ((PADDING*ostride + (ALIGNMENT / 2)) + (7)* ostride + (w - 1 - i))*sizeof(int16_t));
    ...
    src0 = (const ae_int16x8 *)((uintptr_t)inImg + (i* istride + (h - 1)) * sizeof(int16_t));
