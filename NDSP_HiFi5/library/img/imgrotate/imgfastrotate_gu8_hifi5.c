...
static size_t imgfast_gu8_getScratchSize (const imgrotate_params_t* params) 
{ 
...
static const tImgRotateApi imgfastrotate_gu8_api=
{
    imgfast_gu8_rotq,
    imgfast_gu8_rotq16,
    img_gs_vshear,
    img_gs_hshear,
    imgfast_gu8_crop,
    imgfast_gu8_getScratchSize,
    IMGFASTROTATE_GU8_MAGIC, /* magic number for identification     */
    1,                      /* bytes per pixel                     */
    1,                      /* 1 - fast, 0 - generic               */
...
-------------------------------------------------------------------------*/
size_t             imgfastrotate_gu8_alloc          ( const imgrotate_params_t * params ) { return imgrotate_alloc(params,&imgfastrotate_gu8_api); }
imgrotate_handle_t imgfastrotate_gu8_init           ( void * objmem, const imgrotate_params_t * params ) { return imgrotate_init(objmem,params,&imgfastrotate_gu8_api); }
void               imgfastrotate_gu8_getOutSize     (imgsize_t * restrict outSz, const imgrotate_params_t * params) { imgrotate_getOutSize(outSz,params,&imgfastrotate_gu8_api); }
void               imgfastrotate_gu8_process        ( imgrotate_handle_t handle, void * restrict pScr, void * restrict outImg, const void * restrict inImg,const imgsize_t *outSz) { imgrotate_process  ( handle, pScr, outImg, inImg,outSz); }
size_t             imgfastrotate_gu8_getScratchSize ( const imgrotate_params_t * params ) { return imgrotate_getScratchSize(params,&imgfastrotate_gu8_api);}
