...
void imgfast_gs16_rot270 (void* pScr, void* outImg, const imgsize_t * restrict outSz, const void* inImg, const imgsize_t * restrict inSz)
{
  ...
  for (i=0; i<(w>>3); i++)
  {
    ...
    dst0 = (ae_int16x8 *)((uintptr_t)outImg + (0 * ostride)*sizeof(int16_t)) + i;
    dst4 = (ae_int16x8 *)((uintptr_t)outImg + (4 * ostride)*sizeof(int16_t)) + i;
  ...
  for (j = 0; j<(h&7); j++)
  {
    ...
    dst0 = (ae_int16x8 *)((uintptr_t)outImg + ((h - 1 - j) * ostride)*sizeof(int16_t));
  ...
  for (i=0; i<(w&7); i++)
  {
    ...
    dst0 = (ae_int16x8 *)((uintptr_t)outImg + ((0)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst1 = (ae_int16x8 *)((uintptr_t)outImg + ((1)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst2 = (ae_int16x8 *)((uintptr_t)outImg + ((2)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst3 = (ae_int16x8 *)((uintptr_t)outImg + ((3)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst4 = (ae_int16x8 *)((uintptr_t)outImg + ((4)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst5 = (ae_int16x8 *)((uintptr_t)outImg + ((5)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst6 = (ae_int16x8 *)((uintptr_t)outImg + ((6)* ostride + (w - 1 - i))*sizeof(int16_t));
    dst7 = (ae_int16x8 *)((uintptr_t)outImg + ((7)* ostride + (w - 1 - i))*sizeof(int16_t));
    ...
    dst0 = (      ae_int16x8 *)((uintptr_t)outImg + ((h - 1)* ostride + (w - 1 - i))*sizeof(int16_t));
