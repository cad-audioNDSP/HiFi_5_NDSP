...
-------------------------------------------------------------------------*/
static const imgpad_api imgpad_gs16_api=
{
    2,0,
...
{
    imgpad_process(pScr,outImg,inImg,params,&imgpad_gs16_api);
}
/* Returns: size of scratch memory area, in bytes. */
size_t imgpad_gs16_getScratchSize            ( const imgpad_params_t * params ) { return imgpad_getScratchSize(params,&imgpad_gs16_api); }
