...
static void process(void* pScr, void* pCoef, const void* img, void* imgOut, const imgsize_t* in, const imgsize_t* out, int fast)
{
    ...
    for (m = 0; m < wout; m += 4)
    {
        ...
        for (n = 0; n < (hin & ~7); n += 8)
        {
            ...
            AE_MULFD16X16X4WS(Y0, Y1, x00, x20, w0, w1);
            AE_MULFD16X16X4WS(Y2, Y3, x40, x60, w2, w3);
            Y0 = AE_ADD32(Y0, Y2);
            Y1 = AE_ADD32(Y1, Y3);
            y0 = AE_TRUNCA16X4F32S(Y0, Y1, 1);

            AE_MULFD16X16X4WS(Y0, Y1, x10, x30, w0, w1);
            AE_MULFD16X16X4WS(Y2, Y3, x50, x70, w2, w3);
            Y0 = AE_ADD32(Y0, Y2);
            Y1 = AE_ADD32(Y1, Y3);
            y4 = AE_TRUNCA16X4F32S(Y0, Y1, 1);
            ...
            AE_MULFD16X16X4WS(Y0, Y1, x00, x20, w4, w5);
            AE_MULFD16X16X4WS(Y2, Y3, x40, x60, w6, w7);
            Y0 = AE_ADD32(Y0, Y2);
            Y1 = AE_ADD32(Y1, Y3);
            y1 = AE_TRUNCA16X4F32S(Y0, Y1, 1);

            AE_MULFD16X16X4WS(Y0, Y1, x10, x30, w4, w5);
            AE_MULFD16X16X4WS(Y2, Y3, x50, x70, w6, w7);
            Y0 = AE_ADD32(Y0, Y2);
            Y1 = AE_ADD32(Y1, Y3);
            y5 = AE_TRUNCA16X4F32S(Y0, Y1, 1);
            ...
            AE_MULFD16X16X4WS(Y0, Y1, x00, x20, w8, w9);
            AE_MULFD16X16X4WS(Y2, Y3, x40, x60, w10, w11);
            Y0 = AE_ADD32(Y0, Y2);
            Y1 = AE_ADD32(Y1, Y3);
            y2 = AE_TRUNCA16X4F32S(Y0, Y1, 1);

            AE_MULFD16X16X4WS(Y0, Y1, x10, x30, w8, w9);
            AE_MULFD16X16X4WS(Y2, Y3, x50, x70, w10, w11);
            Y0 = AE_ADD32(Y0, Y2);
            Y1 = AE_ADD32(Y1, Y3);
            y6 = AE_TRUNCA16X4F32S(Y0, Y1, 1);
            ...
            AE_MULFD16X16X4WS(Y0, Y1, x00, x20, w12, w13);
            AE_MULFD16X16X4WS(Y2, Y3, x40, x60, w14, w15);
            Y0 = AE_ADD32(Y0, Y2);
            Y1 = AE_ADD32(Y1, Y3);
            y3 = AE_TRUNCA16X4F32S(Y0, Y1, 1);

            AE_MULFD16X16X4WS(Y0, Y1, x10, x30, w12, w13);
            AE_MULFD16X16X4WS(Y2, Y3, x50, x70, w14, w15);
            Y0 = AE_ADD32(Y0, Y2);
            Y1 = AE_ADD32(Y1, Y3);
            y7 = AE_TRUNCA16X4F32S(Y0, Y1, 1);
