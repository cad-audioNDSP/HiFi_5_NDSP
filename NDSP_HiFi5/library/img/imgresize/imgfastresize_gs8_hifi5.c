...
-------------------------------------------------------------------------*/
size_t imgfastresize_gs8_alloc  ( const imgresize_params_t * params ) { return imgresize_alloc(params); }
imgresize_handle_t imgfastresize_gs8_init  ( void * objmem, const imgresize_params_t * params ) { return imgresize_init(objmem,params,&imgcopy_api_gs8fast_temp,&imgcopy_api_temp_gs8fast,2);}
void imgfastresize_gs8_process  ( imgresize_handle_t handle, void * restrict pScr, void * restrict outImg, const void * restrict inImg) { return imgresize_process(handle,pScr,outImg,inImg); }
size_t imgfastresize_gs8_getScratchSize  ( const imgresize_params_t * params ) { return imgresize_getScratchSize(params,&imgcopy_api_gs8fast_temp,&imgcopy_api_temp_gs8fast);}
