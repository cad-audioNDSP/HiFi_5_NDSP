...
-------------------------------------------------------------------------*/
size_t imgresize_gu8_alloc    ( const imgresize_params_t * params ) { return imgresize_alloc(params); }
imgresize_handle_t imgresize_gu8_init    ( void * objmem, const imgresize_params_t * params ) { return imgresize_init(objmem,params,&imgcopy_api_gu8_temp,&imgcopy_api_temp_gu8,3);}
void imgresize_gu8_process    ( imgresize_handle_t handle, void * restrict pScr, void * restrict outImg, const void * restrict inImg) { return imgresize_process(handle,pScr,outImg,inImg); }
size_t imgresize_gu8_getScratchSize    ( const imgresize_params_t * params ) { return imgresize_getScratchSize(params,&imgcopy_api_gu8_temp,&imgcopy_api_temp_gu8);}
