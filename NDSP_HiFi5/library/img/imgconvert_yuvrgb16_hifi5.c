                        ...
                        const imgsize_t* sz)
{
    ...
    NASSERT_ALIGN(inImgY, 2);
    NASSERT_ALIGN(inImgU, 2);
    NASSERT_ALIGN(inImgV, 2);
    ...
    for (i = 0; i < h; i++)
    {
        ...
        for (j = 0; j < (w >> 2); j++)
        {           
            AE_LA16X4_IP(y, aly, pInY);
            AE_LA16X4_IP(v, alv, pInV);
            y = AE_MAX16(0, y);
            v = AE_MAX16(0, v);
            v = AE_SUB16(v, 16384);
    ...
    for (i = 0; i < h; i++)
    {
        ...
        for (j = 0; j < (w >> 3); j++)
        {           
            AE_LA16X4X2_IP(y0, y1, aly, pInY);
            AE_LA16X4X2_IP(u0, u1, alu, pInU);
            AE_LA16X4X2_IP(v0, v1, alv, pInV);
            ...
            AE_SA16X4X2_IP(r0, r1, alr, pOutR);
            AE_SA16X4X2_IP(g0, g1, alg, pOutG);
            AE_SA16X4X2_IP(b0, b1, alb, pOutB);
        }
        if (w & 7)
        {     
            int off = (w & 7) <<1;      
