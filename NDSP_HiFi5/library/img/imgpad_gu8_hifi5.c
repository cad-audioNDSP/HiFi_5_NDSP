...
static const imgpad_api imgpad_gu8_api=
{
    1,0,
...
{
    imgpad_process(pScr,outImg,inImg,params,&imgpad_gu8_api);
}
/* Returns: size of scratch memory area, in bytes. */
size_t imgpad_gu8_getScratchSize            ( const imgpad_params_t * params ) { return imgpad_getScratchSize(params,&imgpad_gu8_api); }
