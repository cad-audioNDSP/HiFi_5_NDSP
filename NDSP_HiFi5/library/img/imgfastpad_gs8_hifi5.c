...
-------------------------------------------------------------------------*/
static const imgpad_api imgfastpad_gs8_api=
{
    1,1,
    imgcopyLeftRightBorders_gs8,
    imgcopyUpBtmBorders_gs8,
    imgcopyVert_gs8,
    imgcopyHorz_gs8,
    imgsubcopy_gs8
};
...
{
    imgpad_process(pScr,outImg,inImg,params,&imgfastpad_gs8_api);
}
/* Returns: size of scratch memory area, in bytes. */
size_t imgfastpad_gs8_getScratchSize        ( const imgpad_params_t * params ){ return imgpad_getScratchSize(params,&imgfastpad_gs8_api);  }
