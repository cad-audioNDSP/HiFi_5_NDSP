...
-------------------------------------------------------------------------*/
static const imgpad_api imgfastpad_gs16_api=
{
    2,1,
    imgcopyLeftRightBorders_gs16,
    imgcopyUpBtmBorders_gs16,
    imgcopyVert_gs16,
    imgcopyHorz_gs16,
    imgsubcopy_gs16
};
...
{
    imgpad_process(pScr,outImg,inImg,params,&imgfastpad_gs16_api);
}
/* Returns: size of scratch memory area, in bytes. */
size_t imgfastpad_gs16_getScratchSize      ( const imgpad_params_t * params ) { return imgpad_getScratchSize(params,&imgfastpad_gs16_api);  }
