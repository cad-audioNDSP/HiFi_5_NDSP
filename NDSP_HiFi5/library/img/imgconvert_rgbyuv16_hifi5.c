                          ...
                          const imgsize_t* sz)
{
    ...
    for (i = 0; i < h; i++)
    {
        ...
        for (j = 0; j < (w >> 3); j++)
        {           
            AE_LA16X4X2_IP(r0, r1, alr, pInR);
            AE_LA16X4X2_IP(g0, g1, alg, pInG);
            AE_LA16X4X2_IP(b0, b1, alb, pInB);
            ...
            AE_SA16X4X2_IP(y0, y1, aly, pOutY);
            AE_SA16X4X2_IP(u0, u1, alu, pOutU);
            AE_SA16X4X2_IP(v0, v1, alv, pOutV);
        }
        if (w & 7)
        {    
            int off = (w & 7) << 1;       
