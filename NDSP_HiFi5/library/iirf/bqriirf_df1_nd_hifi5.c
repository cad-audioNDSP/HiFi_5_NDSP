...
DISCARD_FUN(size_t,bqriirf_df1_nd_alloc,( int M ))
DISCARD_FUN(size_t, bqriirf_df1_nd_groupDelay, (bqriirf_df1_nd_handle_t  _bqriir))
DISCARD_FUN(bqriirf_df1_nd_handle_t,bqriirf_df1_nd_init,( void * objmem, int M,
...
{
  NASSERT( M >= 0 );
  return sizeof(bqriirf_df1_nd_t)+9*M*sizeof(float32_t)+(sizeof(xtfloatx4)-1);
} // bqriirf_df1_nd_alloc()
...
{
  NASSERT( M >= 0 );
  return sizeof(bqriirf_df1_nd_t)+9*M*sizeof(float32_t)+7;
} // bqriirf_df1_nd_alloc()
bqriirf_df1_nd_handle_t bqriirf_df1_nd_init( void * objmem, int M,
                                               const float32_t     * coef_sos,
                                               int16_t         gain )
