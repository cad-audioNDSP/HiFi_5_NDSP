...
*/
const union ufloat32uint32 ALIGN(32) log10f_tbl[LOGF10_TBL_ORDER] =
...
const union ufloat32uint32 ALIGN(32) log10_2 = { 0x3e9a209b };
const union ufloat32uint32 ALIGN(32) _4log10_2minus1 = { 0x3e5104d4 };    /* 4*log10(2)-1 */
#elif LOG10F_ALG==1
/*
