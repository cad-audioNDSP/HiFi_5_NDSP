...
const union ufloat32uint32 ALIGN(32) sinf_maxval = { 0x47c90e00 };
...
*/
const union ufloat64uint64 ALIGN(32) pi4fc[] =
{
...
*/
const union ufloat32uint32 ALIGN(32) polysinf_tbl[]=
{ 
...
/* 
   ...
   p=polyfit(x,y,6); p=p(1:2:end); p(end)=[];
*/
const union ufloat32uint32 ALIGN(32) polycosf_tbl[] =
{
#if (SINCOSF_ALG==0) | (SINCOSF_ALG==1)
