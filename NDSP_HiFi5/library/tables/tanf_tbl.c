...
const float32_t ALIGN(32) tanf_maxval = 9099.f; /* domain ranges - zero outside */
...
#if TANF_ALG==0
// table of  TANF_ALG==1 with replication
const union ufloat32uint32 ALIGN(32) polytanf_tbl[28] = {
    {0x3b8beb97}, {0x3b8beb97}, // c0
    {0x3b8beb97}, {0x3b8beb97}, // c0
    {0x39996b33}, {0x39996b33}, // c1
    {0x39996b33}, {0x39996b33}, // c1
    {0x3c2f1d4e}, {0x3c2f1d4e}, // c2
    {0x3c2f1d4e}, {0x3c2f1d4e}, // c2
    {0x3caec172}, {0x3caec172}, // c3
    {0x3caec172}, {0x3caec172}, // c3
    {0x3d5d65cf}, {0x3d5d65cf}, // c4
    {0x3d5d65cf}, {0x3d5d65cf}, // c4
    {0x3e0886df}, {0x3e0886df}, // c5
    {0x3e0886df}, {0x3e0886df}, // c5
    {0x3eaaaab1}, {0x3eaaaab1}, // c6
    {0x3eaaaab1}, {0x3eaaaab1}  // c6
};
#elif TANF_ALG==1
const union ufloat32uint32 ALIGN(32) polytanf_tbl[POLYTAN_LEN +1]=
#if POLYTAN_LEN==7
    {
