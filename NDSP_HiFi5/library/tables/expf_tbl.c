...
*/
const int32_t ALIGN(32) expftbl_Q30[8] =
{    234841,
    1329551,
   10400465,
   59570027,
...
const union ufloat32uint32 ALIGN(32) expfminmax[2] =  /* minimum and maximum arguments of expf() input */
{
...
const union ufloat32uint32 ALIGN(32) log2_e[2] =
{
...
num2hex(single(p));
*/
const union ufloat32uint32 ALIGN(32) expftblf[] =
{
  { 0x39655635 },
  { 0x3aa24c7a },
  { 0x3c1eb2d1 },
