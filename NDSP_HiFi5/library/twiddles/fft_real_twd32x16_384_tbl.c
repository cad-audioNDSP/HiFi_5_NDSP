...
{
    &__cfft_32x16_descr192,
    __fft_real16_tw
};
static const fft_real_x16_descr_t __rifft_descr =
{
    &__cifft_32x16_descr192,
    __fft_real16_tw
};
const fft_handle_t rnfft32x16_384 =  (const fft_handle_t)&__rfft_descr;
const fft_handle_t rinfft32x16_384 = (const fft_handle_t)&__rifft_descr;
