...
static const complex_fract32 ALIGN(32) dct4_twd_64[]=
{
...
static const complex_fract32 ALIGN(32) dct3_64[]=
{
...
static const complex_fract32 ALIGN(32) rfft_32[]=
{
    {{(int32_t)0X7D8A5F40UL,(int32_t)0X18F8B83CUL}},
    {{(int32_t)0X7641AF3DUL,(int32_t)0X30FBC54DUL}},
    {{(int32_t)0X6A6D98A4UL,(int32_t)0X471CECE7UL}},
...
static const complex_fract32 ALIGN(32) fft_16[]=
{
    {{(int32_t)0X7FFFFFFFUL,(int32_t)0000000000UL}},
    {{(int32_t)0X7FFFFFFFUL,(int32_t)0000000000UL}},
    {{(int32_t)0X7FFFFFFFUL,(int32_t)0000000000UL}},
