...
/****************** stage 1 radix 4 ******************/
ALIGN(32) static const int32_t __fft60_tw1[] = 
{
...
/****************** stage 2 radix 3 ******************/
ALIGN(32) static const int32_t __fft60_tw2[] = 
{
...
{
    __fft60_tw1, __fft60_tw2, NULL
};
const fft_cplx32x32_descr_t __cfft_descr60_32x32 = 
{
    N, 
    s2_tab, 
    s3_tab, 
...
const fft_cplx32x32_descr_t __cifft_descr60_32x32 =
{
    N, 
    is2_tab, 
    is3_tab, 
...
const fft_handle_t cnfft32_60 = (const fft_handle_t)&__cfft_descr60_32x32;
const fft_handle_t cinfft32_60 = (const fft_handle_t)&__cifft_descr60_32x32;
