...
ALIGN(32) static const int32_t __fft_real_tw[] =
{
    ...
    (int32_t)0x7FFB0260, (int32_t)0xFDC41E9B,
    ...
    (int32_t)0x6FF389DF, (int32_t)0xC1F1C224,
    (int32_t)0x6ED9EBA1, (int32_t)0xC0000000,
    (int32_t)0x6DB7A87A, (int32_t)0xBE133B7C,
    ...
    (int32_t)0x41ECC484, (int32_t)0x92485786,
    (int32_t)0x40000000, (int32_t)0x9126145F,
    (int32_t)0x3E0E3DDC, (int32_t)0x900C7621,
    ...
    (int32_t)0x023BE165, (int32_t)0x8004FDA0,
};

static const fft_real32x32_descr_t __rfft_descr =
{
    (const fft_handle_t)&__cfft_descr180_32x32,
    __fft_real_tw
};

static const fft_real32x32_descr_t __rifft_descr =
{
    (const fft_handle_t)&__cifft_descr180_32x32,
    __fft_real_tw
};

const fft_handle_t rnfft32_360=  (const fft_handle_t)&__rfft_descr;
const fft_handle_t rinfft32_360 = (const fft_handle_t)&__rifft_descr;
