...
/****************** stage 1 radix 4 ******************/
ALIGN(32) static const int32_t __fft180_tw1[] = 
{
...
/****************** stage 2 radix 3 ******************/
ALIGN(32) static const int32_t __fft180_tw2[] = 
{
...
/****************** stage 3 radix 3 ******************/
ALIGN(32) static const int32_t __fft180_tw3[] = 
{
    (int32_t)0x7FFFFFFF, (int32_t)0x00000000, (int32_t)0x7FFFFFFF, (int32_t)0x00000000, 
    (int32_t)0x74EF0EBC, (int32_t)0xCBF00DBE, (int32_t)0x55A6125C, (int32_t)0xA0E0A15F, 
    (int32_t)0x55A6125C, (int32_t)0xA0E0A15F, (int32_t)0xF29ECFB2, (int32_t)0x80B381AC, 
...
{
    __fft180_tw1, __fft180_tw2, __fft180_tw3, NULL
};
const fft_cplx32x32_descr_t __cfft_descr180_32x32 =
{
    N, 
    s2_tab, 
    s3_tab, 
...
const fft_cplx32x32_descr_t __cifft_descr180_32x32 =
{
    N, 
    is2_tab, 
    is3_tab, 
...
const fft_handle_t cnfft32_180 = (const fft_handle_t)&__cfft_descr180_32x32;
const fft_handle_t cinfft32_180 = (const fft_handle_t)&__cifft_descr180_32x32;
