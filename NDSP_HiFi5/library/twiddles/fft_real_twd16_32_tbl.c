...
/* Twiddles tables for fft_real32x16, ifft_real32x16, fft_real16x16, ifft_real16x16, N=32 */
...
const fft_handle_t rfft16_32 =  (const fft_handle_t)&__rfft_descr;
const fft_handle_t rifft16_32 = (const fft_handle_t)&__rifft_descr;
