...
static const complex_fract32 ALIGN(32) dct4_twd_128[]=
{
...
static const complex_fract32 ALIGN(32) dct3_128[]=
{
...
static const complex_fract32 ALIGN(32) rfft_64[]=
{
    {{(int32_t)0X7F62368FUL,(int32_t)0x0C8BD35EUL}},
    {{(int32_t)0X7D8A5F40UL,(int32_t)0x18F8B83CUL}},
    {{(int32_t)0X7A7D055BUL,(int32_t)0x25280C5EUL}},
...
static const complex_fract32 ALIGN(32) fft_32[]=
{
    {{(int32_t)0X7FFFFFFFUL,(int32_t)0x00000000UL}},
    {{(int32_t)0X7FFFFFFFUL,(int32_t)0x00000000UL}},
    {{(int32_t)0X7FFFFFFFUL,(int32_t)0x00000000UL}},
