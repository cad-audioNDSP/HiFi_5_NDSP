...
{
    (const fft_handle_t)&__cfft_descr12_32x32,
    __fft_real_tw
};

static const fft_real32x32_descr_t __rifft_descr =
{
    (const fft_handle_t)&__cifft_descr12_32x32,
    __fft_real_tw
};

const fft_handle_t rnfft32_24 =  (const fft_handle_t)&__rfft_descr;
const fft_handle_t rinfft32_24 = (const fft_handle_t)&__rifft_descr;
