...
static const uint64_t ALIGN(32) twd_split32[16]=
{
  /*
     NOTE: 32-bit halves of numbers are swapped
     for optimization purposes
     1st number is omitted
  */
...
static const int32_t ALIGN(32) twd_dct32[32*2]=
{
  /*
...
static const complex_fract32 ALIGN(32) twd_fft32[2*3*8] = 
{
