...
static const complex_fract32 ALIGN(32) dct4_twd_512[]=
{
...
static const complex_fract32 ALIGN(32) dct3_512[]=
{
...
static const complex_fract32 ALIGN(32) rfft_256[]=
{
    {{(int32_t)0X7FF62182UL,(int32_t)0x03242ABFUL}},
    {{(int32_t)0X7FD8878EUL,(int32_t)0x0647D97CUL}},
    {{(int32_t)0X7FA736B4UL,(int32_t)0x096A9049UL}},
...
static const complex_fract32 ALIGN(32) fft_128[]=
{
    {{(int32_t)0X7FFFFFFF,(int32_t)0000000000UL}},
    {{(int32_t)0X7FFFFFFF,(int32_t)0000000000UL}},
    {{(int32_t)0X7FFFFFFF,(int32_t)0000000000UL}},
