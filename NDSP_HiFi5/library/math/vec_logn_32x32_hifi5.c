...
void vec_logn_32x32 (int32_t * restrict y,const int32_t * restrict x, int N)
{
  ...
  if (N<=0) return;
  vsw = AE_MOVDA32X2(1488522236, 1488522236);
  ...
  for (n=0; n<(N>>2); n++)
  {
    ...
    AE_MULF2P32X4RAS(e0, e1, e0, e1, vsw, vsw);

    c0 = AE_L32_I((const ae_int32 *)logn_tbl_Q31, 4 * 0);
    c1 = AE_L32_I((const ae_int32 *)logn_tbl_Q31, 4 * 1);
    c2 = AE_L32_I((const ae_int32 *)logn_tbl_Q31, 4 * 2);
    c3 = AE_L32_I((const ae_int32 *)logn_tbl_Q31, 4 * 3);
    c4 = AE_L32_I((const ae_int32 *)logn_tbl_Q31, 4 * 4);
    c5 = AE_L32_I((const ae_int32 *)logn_tbl_Q31, 4 * 5);
