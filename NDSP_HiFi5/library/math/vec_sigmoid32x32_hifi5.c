...
void vec_sigmoid32x32(int32_t* restrict y, const int32_t* restrict x, int N)
{
  ...
  for (n=0; n<(N>>2); n++)
  {
    ...
    sign0 = AE_LT32(x0, 0);
    sign1 = AE_LT32(x1, 0);
    AE_MULF2P32X4RAS(z0, z1, x0, x1, 774541002, 774541002);
    x0 = AE_ABS32S(z0);
    x1 = AE_ABS32S(z1);
    e0 = AE_SRAI32(x0, 23);
    e1 = AE_SRAI32(x1, 23);
    ...
    /* 0.96-x/2 */
    z0 = z1 = 1030792151;
    AE_MULSF2P32X4RAS(z0, z1, x0, x1, 0x20000000, 0x20000000);
    t0 = z0; t1 = z1;
    ...
    //AE_MULF2P32X4RAS(t0,t1,z0,z1,0x40000000,0x40000000);
