...
void vec_antilog2_32x32 (int32_t * restrict y, const int32_t* restrict x, int N)
{
  ...
  for (n=0; n<(N>>2); n++)
  {
    ...
    e0 = AE_SUB32(15, e0);
    e1 = AE_SUB32(15, e1);
    x0 = AE_AND32(x0, AE_MOVDA32X2(0x1ffffff, 0x1ffffff));
    x1 = AE_AND32(x1, AE_MOVDA32X2(0x1ffffff, 0x1ffffff));

    x0 = AE_SUB32(x0, AE_MOVDA32X2(0x2000000, 0x2000000));
    x1 = AE_SUB32(x1, AE_MOVDA32X2(0x2000000, 0x2000000));
