...
#define SCR_SZ (MAX_ALLOCA_SZ/sizeof(int32_t))
    ...
    ae_int32 ALIGN(32) scratch[SCR_SZ];
    int n;
    ...
    while(N>7)
    {
        ...
        for (n=0; n<(M>>2); n++)
        {
            ...
            AE_L64_IP(z0,pFracRd,sizeof(int64_t));
            AE_L64_IP(z1,pFracRd,sizeof(int64_t));
            AE_L64_IP(z2,pFracRd,sizeof(int64_t));
            AE_L64_IP(z3,pFracRd,sizeof(int64_t));
            ...
            AE_MOVD32X4(e0,e1,0x40000000,0x40000000); 
            AE_MULSF2P32X4RAS(e0,e1,x0,x1,y0,y1); AE_MULAF2P32X4RAS(y0,y1,y0,y1,AE_ADD32S(e0,e0),AE_ADD32S(e1,e1));
            AE_S32X2X2_IP(y0,y1,castxcc(ae_int32x4,pScr),sizeof(ae_int32x4));
        }
        ...
        */
        ...
        for (n=0; n<M; n++)
        {
            ...
            {
               ae_int32x2 t;
               AE_L32_IP(t,castxcc(ae_int32,pScr),sizeof(ae_int32)); y=AE_MOVINT64_FROMINT32X2(t);
            }
    ...
    for (n=0; n<N; n++)
    {
        ...
        e=0x40000000; AE_MULSFP32X2RAS(e,x,y); AE_MULAFP32X2RAS(y,y,AE_ADD32S(e,e));
        e=0x40000000; AE_MULSFP32X2RAS(e,x,y); AE_MULAFP32X2RAS(y,y,AE_ADD32S(e,e));
        e=0x40000000; AE_MULSFP32X2RAS(e,x,y); AE_MULAFP32X2RAS(y,y,AE_ADD32S(e,e));
        AE_S32_H_IP(y,castxcc(ae_int32,pScr),sizeof(ae_int32));
    }
    /* last 2 iterations are done in better accuracy: 
        first one use simpler computation of 1-x*y, next 
        one adds more 8 bits for precision of this matter 
    ...
    */
    ...
    for (m=0; m<N; m+=SCR_SZ,exp+=SCR_SZ,frac+=SCR_SZ)
    {
        ...
        if (M&2)
        {
            ...
            e=0x40000000; AE_MULSFP32X2RAS(e,x,y); AE_MULAFP32X2RAS(y,y,AE_ADD32S(e,e));
            e=0x40000000; AE_MULSFP32X2RAS(e,x,y); AE_MULAFP32X2RAS(y,y,AE_ADD32S(e,e));
            AE_S32X2_IP(y,castxcc(ae_int32x2,pScr),sizeof(ae_int32x2));
        }
