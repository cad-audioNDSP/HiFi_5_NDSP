...
ANNOTATE_FUN(bqriirf_df1_nd, "Bi-quad Real Block IIR, DFI (floating point data)  no delay version                             ");
ANNOTATE_FUN(bqriirf_df2_nd, "Bi-quad Real Block IIR, DFII (floating point data)  no delay version                            ");
ANNOTATE_FUN(bqriirf_df2t_nd, "Bi-quad Real Block IIR, DFIIt (floating point data) no delay version                           ");
ANNOTATE_FUN(bqciirf_df1_nd, "Bi-quad Real Block IIR, DFI (complex floating point data)  no delay version                     ");
ANNOTATE_FUN(bqriir16x16_df1_nd, "Bi-quad Real Block IIR, DFI (16-bit data, 16-bit coefficients, 16-bit intermediate stage outputs), no delay version  ");
ANNOTATE_FUN(bqriir16x16_df2_nd, "Bi-quad Real Block IIR, DFII (16-bit data, 16-bit coefficients, 16-bit intermediate stage outputs), no delay version ");
ANNOTATE_FUN(bqriir32x16_df1_nd, "Bi-quad Real Block IIR, DFI (32-bit data, 16-bit coefficients, 32-bit intermediate stage outputs), no delay version  ");
ANNOTATE_FUN(bqriir32x16_df2_nd, "Bi-quad Real Block IIR, DFII (32-bit data, 16-bit coefficients, 32-bit intermediate stage outputs), no delay version ");
ANNOTATE_FUN(bqriir32x32_df1_nd, "Bi-quad Real Block IIR, DFI (32-bit data, 32-bit coefficients, 32-bit intermediate stage outputs), no delay version  ");
ANNOTATE_FUN(bqriir32x32_df2_nd, "Bi-quad Real Block IIR, DFII (32-bit data, 32-bit coefficients, 32-bit intermediate stage outputs), no delay version ");
...
ANNOTATE_FUN(stereo_bqriir16x16_df1_nd, "Bi-quad Stereo Block Stereo IIR, DFI (16-bit data, 16-bit coefficients, 16-bit intermediate stage outputs)  no delay version ");
ANNOTATE_FUN(stereo_bqriir32x16_df1_nd, "Bi-quad Stereo Block Stereo IIR, DFI (32-bit data, 16-bit coefficients, 32-bit intermediate stage outputs)  no delay version ");
ANNOTATE_FUN(stereo_bqriir32x32_df1_nd, "Bi-quad Stereo Block Stereo IIR, DFI (32-bit data, 32-bit coefficients, 32-bit intermediate stage outputs)  no delay version ");
ANNOTATE_FUN(stereo_bqriirf_df1_nd, "Bi-quad Real Block Stereo IIR, DFI (floating point data)  no delay version                                                 ");
...
ANNOTATE_FUN(kalmanupd1_32x32, "Kalman Filter Update (32-bit data, 32-bit coefficients)                                          ");
ANNOTATE_FUN(kalmanupd1f, "Kalman Filter Update (floating point data)                                                       ");
