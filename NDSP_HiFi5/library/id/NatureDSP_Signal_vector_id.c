...
ANNOTATE_FUN(vec_dot_batch_fp16,       "Vector Dot product, batch mode (half precision data)");
...
ANNOTATE_FUN(vec_dot_batch_fp16_fast,  "Vector Dot product, batch mode (half precision data)");
