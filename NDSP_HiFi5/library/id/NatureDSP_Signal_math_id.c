...
ANNOTATE_FUN(vec_tanh_fp16,         "Vector Hyperbolic Tangent (half precision data)");
ANNOTATE_FUN(scl_tanh_fp16,         "Scalar Hyperbolic Tangent (half precision data)");
...
ANNOTATE_FUN(vec_sigmoid_fp16,      "Vector Sigmoid (half precision data)");
ANNOTATE_FUN(scl_sigmoid_fp16,      "Scalar Sigmoid (half precision data)");
