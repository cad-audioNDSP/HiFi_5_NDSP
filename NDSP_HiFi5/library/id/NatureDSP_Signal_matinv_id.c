...
ANNOTATE_FUN(cmtx_inv2x2f,   "Gauss-Jordan matrix inversion (complex floating point data)");
ANNOTATE_FUN(cmtx_inv3x3f,   "Gauss-Jordan matrix inversion (complex floating point data)");
ANNOTATE_FUN(cmtx_inv4x4f,   "Gauss-Jordan matrix inversion (complex floating point data)");
ANNOTATE_FUN(cmtx_inv6x6f,   "Gauss-Jordan matrix inversion (complex floating point data)");
ANNOTATE_FUN(cmtx_inv8x8f,   "Gauss-Jordan matrix inversion (complex floating point data)");
ANNOTATE_FUN(cmtx_inv10x10f, "Gauss-Jordan matrix inversion (complex floating point data)");

ANNOTATE_FUN(mtx_gjelim2x2f,   "Gauss-Jordan linear equations solver (floating point data)");
ANNOTATE_FUN(mtx_gjelim3x3f,   "Gauss-Jordan linear equations solver (floating point data)");
ANNOTATE_FUN(mtx_gjelim4x4f,   "Gauss-Jordan linear equations solver (floating point data)");
ANNOTATE_FUN(mtx_gjelim6x6f,   "Gauss-Jordan linear equations solver (floating point data)");
ANNOTATE_FUN(mtx_gjelim8x8f,   "Gauss-Jordan linear equations solver (floating point data)");
ANNOTATE_FUN(mtx_gjelim10x10f, "Gauss-Jordan linear equations solver (floating point data)");
ANNOTATE_FUN(cmtx_gjelim2x2f,  "Gauss-Jordan linear equations solver (complex floating point data)");
ANNOTATE_FUN(cmtx_gjelim3x3f,  "Gauss-Jordan linear equations solver (complex floating point data)");
ANNOTATE_FUN(cmtx_gjelim4x4f,  "Gauss-Jordan linear equations solver (complex floating point data)");
ANNOTATE_FUN(cmtx_gjelim6x6f,  "Gauss-Jordan linear equations solver (complex floating point data)");
ANNOTATE_FUN(cmtx_gjelim8x8f,  "Gauss-Jordan linear equations solver (complex floating point data)");
ANNOTATE_FUN(cmtx_gjelim10x10f,"Gauss-Jordan linear equations solver (complex floating point data)");
