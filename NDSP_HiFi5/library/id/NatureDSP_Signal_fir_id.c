...
ANNOTATE_FUN(gccphat32x32,        "Gerenalized Cross-Correlation Phase Transform (32-bit data, 32-bit outputs)              ");
ANNOTATE_FUN(gccphatf,            "Gerenalized Cross-Correlation Phase Transform (floating point data)                      ");
...
ANNOTATE_FUN(conv2d_gen_3x3_16x16           ,"2D Convolution - generic version ( 3x3 16-bit kernel, 16-bit data )                              ");
ANNOTATE_FUN(conv2d_gen_5x5_16x16           ,"2D Convolution - generic version ( 5x5 16-bit kernel, 16-bit data )                              ");
ANNOTATE_FUN(conv2d_gen_11x7_16x16          ,"2D Convolution - generic version ( 11x7 16-bit kernel, 16-bit data )                             ");
ANNOTATE_FUN(conv2d_gen_3x3_8x16            ,"2D Convolution - generic version ( 3x3 8-bit kernel, 16-bit data )                               ");
ANNOTATE_FUN(conv2d_gen_5x5_8x16            ,"2D Convolution - generic version ( 5x5 8-bit kernel, 16-bit data )                               ");
ANNOTATE_FUN(conv2d_gen_11x7_8x16           ,"2D Convolution - generic version ( 11x7 8-bit kernel, 16-bit data )                              ");
ANNOTATE_FUN(conv2d_gen_3x3_8x8             ,"2D Convolution - generic version ( 3x3 8-bit kernel, 8-bit data )                                ");
ANNOTATE_FUN(conv2d_gen_5x5_8x8             ,"2D Convolution - generic version ( 5x5 8-bit kernel, 8-bit data )                                ");
ANNOTATE_FUN(conv2d_gen_11x7_8x8            ,"2D Convolution - generic version ( 11x7 8-bit kernel, 8-bit data )                               ");
ANNOTATE_FUN(conv2d_gen_3x3f                ,"2D Convolution - generic version ( 3x3 kernel, floating point data )                             ");
ANNOTATE_FUN(conv2d_gen_5x5f                ,"2D Convolution - generic version ( 5x5 kernel, floating point data )                             ");
ANNOTATE_FUN(conv2d_gen_11x7f               ,"2D Convolution - generic version ( 11x7 kernel, floating point data )                            ");
ANNOTATE_FUN(conv2d_gen_3x3_fp16            ,"2D Convolution - generic version ( 3x3 kernel, half precision data )                             ");
ANNOTATE_FUN(conv2d_gen_5x5_fp16            ,"2D Convolution - generic version ( 5x5 kernel, half precision data )                             ");
ANNOTATE_FUN(conv2d_gen_11x7_fp16           ,"2D Convolution - generic version ( 11x7 kernel, half precision data )                            ");
...
ANNOTATE_FUN(conv2d_3x3_fp16,           "2D Convolution ( 3x3 kernel, half precision data )                             ");
ANNOTATE_FUN(conv2d_5x5_fp16,           "2D Convolution ( 5x5 kernel, half precision data )                             ");
ANNOTATE_FUN(conv2d_11x7_fp16,          "2D Convolution ( 11x7 kernel, half precision data )                            ");
ANNOTATE_FUN(rppafir32x32_process,  "Polyphase Analysis Real FIR filter (32-bit data, 32-bit coefficients, 32-bit outputs) ");
ANNOTATE_FUN(rppsfir32x32_process,  "Polyphase Synthesis Real FIR filter (32-bit data, 32-bit coefficients, 32-bit outputs) ");
ANNOTATE_FUN(cppafir32x32_process,  "Polyphase Analysis Complex FIR filter (32-bit data, 32-bit coefficients, 32-bit outputs) ");
ANNOTATE_FUN(cppsfir32x32_process,  "Polyphase Synthesis Complex FIR filter (32-bit data, 32-bit coefficients, 32-bit outputs) ");
ANNOTATE_FUN(rppafirf_process,      "Polyphase Analysis Real FIR filter (floating point data, floating point coefficients) ");
ANNOTATE_FUN(rppsfirf_process,      "Polyphase Synthesis Real FIR filter (floating point data, floating point coefficients) ");
ANNOTATE_FUN(cppafirf_process,      "Polyphase Analysis Complex FIR filter (floating point data, floating point coefficients) ");
ANNOTATE_FUN(cppsfirf_process,      "Polyphase Synthesis Complex FIR filter (floating point data, floating point coefficients) ");
