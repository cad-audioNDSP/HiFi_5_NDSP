...
ANNOTATE_FUN(cmtx_mpyt32x32_fast,   "Fast Matrix Multiply Transpose (32-bit complex data)");
ANNOTATE_FUN(cmtx_mpytf_fast,       "Fast Matrix Multiply Transpose (complex floating-point data)");
ANNOTATE_FUN(cmtx_lrmpy32x32_fast,   "Fast Three Matrices Product (32-bit complex data)");
ANNOTATE_FUN(cmtx_lrmpyf_fast,       "Fast Three Matrices Product (complex floating-point data)");
ANNOTATE_FUN(cmtx_vecmpyt32x32_fast, "Fast Vector by Vector Multiply (32-bit complex data)");
ANNOTATE_FUN(cmtx_vecmpytf_fast,     "Fast Vector by Vector Multiply (complex floating-point data)");
