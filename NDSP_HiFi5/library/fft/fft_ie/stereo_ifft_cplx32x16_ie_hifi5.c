...
int stereo_ifft_cplx32x16_ie(complex_fract32* y,complex_fract32* x, const complex_fract16* twd, int twdstep, int N, int scalingOpt)
{
    ...
    ae_int32x4 * restrict p_y3l = p_y0l + (N>>2);
    ae_int32x4 * restrict p_y2l = p_y3l + (N>>2);
    ae_int32x4 * restrict p_y1l = p_y2l + (N>>2);
    ...
    if ( (i&1)!=0 )
    {
        ...
        /* first butterfly */
        {
            ...
            AE_S32X2X2_I(vB00, vB01, (ae_int32x4*)p_y0l, 0);
            AE_S32X2X2_I(vB10, vB11, (ae_int32x4*)p_y1l, 0);
            AE_S32X2X2_I(vB20, vB21, (ae_int32x4*)p_y2l, 0);
            AE_S32X2X2_I(vB30, vB31, (ae_int32x4*)p_y3l, 0);
        }
        p_y0l = p_y1l + (N>>2);
        ...
        for (i = 1; i<(N >> 2); i++)
        {
            ...
            AE_S32X2X2_X(vB00, vB01, (ae_int32x4*)p_y0l, negi0);
            AE_S32X2X2_X(vB10, vB11, (ae_int32x4*)p_y1l, negi0);
            AE_S32X2X2_X(vB20, vB21, (ae_int32x4*)p_y2l, negi0);
            AE_S32X2X2_X(vB30, vB31, (ae_int32x4*)p_y3l, negi0);
    ...
    else
    {
        ...
        /* first butterfly */
        {
            ...
            AE_S32X2X2_I(vA00, vA01, (ae_int32x4*)p_y0l, 0);
            AE_S32X2X2_I(vA10, vA11, (ae_int32x4*)p_y1l, 0);
            AE_S32X2X2_I(vA20, vA21, (ae_int32x4*)p_y2l, 0);
            AE_S32X2X2_I(vA30, vA31, (ae_int32x4*)p_y3l, 0);
        ...
        for (i = 1; i<(N >> 2); i++)
        {
            ...
            AE_S32X2X2_X(vA00, vA01, (ae_int32x4*)p_y0l, negi0);
            AE_S32X2X2_X(vA10, vA11, (ae_int32x4*)p_y1l, negi0);
            AE_S32X2X2_X(vA20, vA21, (ae_int32x4*)p_y2l, negi0);
            AE_S32X2X2_X(vA30, vA31, (ae_int32x4*)p_y3l, negi0);
        }
    }
