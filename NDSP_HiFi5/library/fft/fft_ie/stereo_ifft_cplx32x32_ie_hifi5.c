...
static int ifft_cplx_inner_32x32_scl2(
        ...
        for (stride = N / 16; stride>4; stride /= 4, twdstep *= 4)
        {
            ...
            for (m = 0; m*(4 * stride)<N; m++)
            {
                ...
                for (n = 0; n<stride; n++)
                {
                    ...
                    AE_ADDANDSUB32JS(c3, c1, b2, b3);

                    AE_ADDANDSUB32S(f0, f2, e0, e1);
                    AE_ADDANDSUB32JS(f3, f1, e2, e3);

                    c1 = AE_MULFCJ32RAS(c1, tw1);
                    c2 = AE_MULFCJ32RAS(c2, tw2);
                    c3 = AE_MULFCJ32RAS(c3, tw3);

                    f1 = AE_MULFCJ32RAS(f1, tw1);
                    f2 = AE_MULFCJ32RAS(f2, tw2);
                    f3 = AE_MULFCJ32RAS(f3, tw3);
    ...
    // Perform the next to last stage.
    {
        ...
        if (stride == 4)
        {
            ...
            for (n = 0; n<N / (4 * 4); n++)
            {
                ...
                c1 = AE_MULFCJ32RAS(c1, tw11);
                c2 = AE_MULFCJ32RAS(c2, tw21);
                c3 = AE_MULFCJ32RAS(c3, tw31);

                f1 = AE_MULFCJ32RAS(f1, tw11);
                f2 = AE_MULFCJ32RAS(f2, tw21);
                f3 = AE_MULFCJ32RAS(f3, tw31);
                ...
                c1 = AE_MULFCJ32RAS(c1, tw12);
                c2 = AE_MULFCJ32RAS(c2, tw22);
                c3 = AE_MULFCJ32RAS(c3, tw32);

                f1 = AE_MULFCJ32RAS(f1, tw12);
                f2 = AE_MULFCJ32RAS(f2, tw22);
                f3 = AE_MULFCJ32RAS(f3, tw32);
                ...
                c1 = AE_MULFCJ32RAS(c1, tw13);
                c2 = AE_MULFCJ32RAS(c2, tw23);
                c3 = AE_MULFCJ32RAS(c3, tw33);

                f1 = AE_MULFCJ32RAS(f1, tw13);
                f2 = AE_MULFCJ32RAS(f2, tw23);
                f3 = AE_MULFCJ32RAS(f3, tw33);
        ...
        else if (stride == 2)
        {
            ...
            for (n = 0; n<N / (2 * 4); n++)
            {
                ...
                AE_ADDANDSUB32S(c0, c2, b0, b1);
                AE_ADDANDSUB32S(c3, c1, b2, b3);

                AE_ADDANDSUB32S(f0, f2, e0, e1);
                AE_ADDANDSUB32S(f3, f1, e2, e3);
...
static int ifft_cplx_inner_32x32_scl3(
    complex_fract32 * restrict y,
    complex_fract32 * restrict x,
    const complex_fract32 *    twd,
    int                        twdstep,
...
int stereo_ifft_cplx32x32_ie(complex_fract32* y, complex_fract32* x, const complex_fract32* twd, int twdstep, int N, int scalingOpt)
{
    ...
    if (scalingOpt == 2)
    {
        ...
        */
        ...
        for (n = 0; n<N / 4; n++)
        {
            ...
            AE_ADDANDSUB32JS(a3, a1, b2, b3);

            AE_ADDANDSUB32S(c0, c2, d0, d1);
            AE_ADDANDSUB32JS(c3, c1, d2, d3);

            a1 = AE_MULFCJ32RAS(a1, tw1);
            a2 = AE_MULFCJ32RAS(a2, tw2);
            a3 = AE_MULFCJ32RAS(a3, tw3);
        ...
        // Perform second through the next to last stages.
        {
            ...
            (void)shift2;
            nsa = 3 - shift1;
            shiftSum += ifft_cplx_inner_32x32_scl2(x, y, twd, twdstep, &nsa, N);
        }
    }
    else  /* if (scalingOpt == 2) */
    {
        ...
        */
        ...
        nsa = 0;
        shiftSum += ifft_cplx_inner_32x32_scl3(x, y, twd, twdstep, &nsa, N);
    }       /*if (scalingOpt == 2)*/
