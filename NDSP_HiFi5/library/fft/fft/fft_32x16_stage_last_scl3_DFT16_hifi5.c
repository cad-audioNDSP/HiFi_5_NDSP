...
int fft_32x16_stage_last_scl3_DFT16(const int16_t *tw, const int32_t *x, int32_t *y, int N, int *v, int tw_step, int *bexp)
{
    ...
    px1 = (const ae_int32x2 *)(stride*sizeof(complex_fract32)+(uintptr_t)px0);
    px2 = (const ae_int32x2 *)(stride*sizeof(complex_fract32)+(uintptr_t)px1);
    px3 = (const ae_int32x2 *)(stride*sizeof(complex_fract32)+(uintptr_t)px2);
    py0 = (ae_int32x2 *)y;
    ...
    for (j = 0; j < stride; j++)
    {
        /* 19 cycles per pipeline stage in steady state with unroll=1 */

        AE_L32X2_XP(x0, px0, 4 * stride*sizeof(complex_fract32));
        AE_L32X2_XP(x1, px1, 4 * stride*sizeof(complex_fract32));
        AE_L32X2_XP(x2, px2, 4 * stride*sizeof(complex_fract32));
        AE_L32X2_XP(x3, px3, 4 * stride*sizeof(complex_fract32));
        AE_L32X2_XP(x4, px0, 4 * stride*sizeof(complex_fract32));
        AE_L32X2_XP(x5, px1, 4 * stride*sizeof(complex_fract32));
        AE_L32X2_XP(x6, px2, 4 * stride*sizeof(complex_fract32));
        AE_L32X2_XP(x7, px3, 4 * stride*sizeof(complex_fract32));
        AE_L32X2_XP(x8, px0, 4 * stride*sizeof(complex_fract32));
        AE_L32X2_XP(x9, px1, 4 * stride*sizeof(complex_fract32));
        AE_L32X2_XP(x10, px2, 4 * stride*sizeof(complex_fract32));
        AE_L32X2_XP(x11, px3, 4 * stride*sizeof(complex_fract32));
        AE_L32X2_XP(x12, px0, (1 - 12 * stride)*sizeof(complex_fract32));
        AE_L32X2_XP(x13, px1, (1 - 12 * stride)*sizeof(complex_fract32));
        AE_L32X2_XP(x14, px2, (1 - 12 * stride)*sizeof(complex_fract32));
        AE_L32X2_XP(x15, px3, (1 - 12 * stride)*sizeof(complex_fract32));
...
} /* fft_32x16_stage_last_scl3_DFT16() */ 
