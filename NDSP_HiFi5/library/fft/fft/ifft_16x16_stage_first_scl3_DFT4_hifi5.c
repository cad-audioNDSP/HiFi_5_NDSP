...
#define shift 3
	...
	{ 
		...
		ae_int32x2 a01, a11, a21, a31;

		AE_L32X2X2_IP (a0, a01, castxcc(ae_int32x4, px0), 2 * sizeof(ae_int16x4));
		AE_LA32X2X2_IP(a1, a11, va1,castxcc(ae_int32x4, px1));
		AE_L32X2X2_IP (a2, a21, castxcc(ae_int32x4, px2), 2 * sizeof(ae_int16x4));
		AE_LA32X2X2_IP(a3, a31, va3,castxcc(ae_int32x4, px3));
		x0 = AE_MOVINT16X4_FROMINT32X2(a0);
		x1 = AE_MOVINT16X4_FROMINT32X2(a1);
		x2 = AE_MOVINT16X4_FROMINT32X2(a2);
		x3 = AE_MOVINT16X4_FROMINT32X2(a3);
		x01 = AE_MOVINT16X4_FROMINT32X2(a01);
		x11 = AE_MOVINT16X4_FROMINT32X2(a11);
		x21 = AE_MOVINT16X4_FROMINT32X2(a21);
		x31 = AE_MOVINT16X4_FROMINT32X2(a31);
	...
	if (stride & 3)
	{
		...
		AE_L32X2_IP(a0, castxcc(ae_int32x2, px0), sizeof(ae_int16x4));
		AE_L32X2_IP(a1, castxcc(ae_int32x2, px1), sizeof(ae_int16x4));
		AE_L32X2_IP(a2, castxcc(ae_int32x2, px2), sizeof(ae_int16x4));
		AE_L32X2_IP(a3, castxcc(ae_int32x2, px3), sizeof(ae_int16x4));
		x0 = AE_MOVINT16X4_FROMINT32X2(a0);
		x1 = AE_MOVINT16X4_FROMINT32X2(a1);
		x2 = AE_MOVINT16X4_FROMINT32X2(a2);
		x3 = AE_MOVINT16X4_FROMINT32X2(a3);
