...
/*
 *  32x16 FFT/IFFT intermediate stage Radix 5, scalingOption=3, v=4
 */
...
#define shift 3
  ...
  WUR_AE_SAR(shift);
    ...
    for (i = 0; i < (stride >> 2); i++)
    {
      ...
      AE_S32X2X2_XP(x40, x41, castxcc(ae_int32x4, py0), 4 * sizeof(ae_int32x2));
      ...
      AE_S32X2X2_XP(x40, x41, castxcc(ae_int32x4, py1), 4 * sizeof(ae_int32x2));
    }
