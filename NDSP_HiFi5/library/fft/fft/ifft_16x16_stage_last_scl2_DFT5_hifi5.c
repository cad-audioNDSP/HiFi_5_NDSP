...
/*
*  Last stage of FFT 16x16, radix-5, static scaling
*/
int ifft_16x16_stage_last_scl2_DFT5(const int16_t *tw, const int16_t *x, int16_t *y, int N, int *v, int tw_step, int *bexp)
{
    ...
    a0 = AE_L16X4_I((ae_int16x4*)DFT5_twd, 0 * sizeof(a0));
    a1 = AE_L16X4_I((ae_int16x4*)DFT5_twd, 1 * sizeof(a0));
    a2 = AE_L16X4_I((ae_int16x4*)DFT5_twd, 2 * sizeof(a0));
    a3 = AE_L16X4_I((ae_int16x4*)DFT5_twd, 3 * sizeof(a0));
    ...
    { /* 18 cycles per pipeline stage in steady state with unroll=1 */
        ...
        /* DFT4 without scaling */
        DFT4XI2_NOSCALING(z0, z1, z2, z3);
