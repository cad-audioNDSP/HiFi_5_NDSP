...
int fft_16x16_stage_inner_scl2_DFT4x2_v4(const int16_t *tw, const int16_t *x, int16_t *y, int N, int *v, int tw_step, int *bexp)
{
    ...
    for (i = 0; i < (N >> 4); i++)
    {
        ...
        aX = AE_LA64_PP(ptwd32);
        AE_LA16X4_IP(tw2, aX, castxcc(ae_int16x4, ptwd32));
        tw1 = AE_SEL16_7632(tw2, tw2);
        tw2 = AE_SEL16_5410(tw2, tw2);
        AE_L32_IP(t3, ptwd32, sizeof(complex_fract16));
        ...
        AE_S16X4X2RNG_XP(x00, x01, castxcc(ae_int16x8, py0), 2 * 4 * 2 * sizeof(int16_t));
        AE_S16X4X2RNG_XP(x20, x21, castxcc(ae_int16x8, py0), -4 * 2 * (int)sizeof(int16_t));
        AE_S16X4X2RNG_XP(x10, x11, castxcc(ae_int16x8, py0), 2 * 4 * 2 * sizeof(int16_t));
        AE_S16X4X2RNG_XP(x30, x31, castxcc(ae_int16x8, py0), 4 * 2 * sizeof(int16_t));
    } 
    ...
    *v *= R;
    return shift;
} /* fft_16x16_stage_inner_scl2_DFT4x2_v4 */
