...
int ifft_16x16_stage_last_scl3_DFT16(const int16_t *tw, const int16_t *x, int16_t *y, int N, int *v, int tw_step, int *bexp)
{
    ...
    for (j = 0; j < (stride >> 1); j++)
    {
        ...
        AE_S32X2_XP(AE_MOVINT32X2_FROMINT16X4(x0 ), py0, stride*sizeof(complex_fract16));
        AE_S32X2_XP(AE_MOVINT32X2_FROMINT16X4(x4 ), py0, stride*sizeof(complex_fract16));
        AE_S32X2_XP(AE_MOVINT32X2_FROMINT16X4(x8 ), py0, stride*sizeof(complex_fract16));
        AE_S32X2_XP(AE_MOVINT32X2_FROMINT16X4(x12), py0, stride*sizeof(complex_fract16));
        AE_S32X2_XP(AE_MOVINT32X2_FROMINT16X4(x1 ), py0, stride*sizeof(complex_fract16));
        AE_S32X2_XP(AE_MOVINT32X2_FROMINT16X4(x5 ), py0, stride*sizeof(complex_fract16));
        AE_S32X2_XP(AE_MOVINT32X2_FROMINT16X4(x9 ), py0, stride*sizeof(complex_fract16));
        AE_S32X2_XP(AE_MOVINT32X2_FROMINT16X4(x13), py0, stride*sizeof(complex_fract16));
        AE_S32X2_XP(AE_MOVINT32X2_FROMINT16X4(x2 ), py0, stride*sizeof(complex_fract16));
        AE_S32X2_XP(AE_MOVINT32X2_FROMINT16X4(x6 ), py0, stride*sizeof(complex_fract16));
        AE_S32X2_XP(AE_MOVINT32X2_FROMINT16X4(x10), py0, stride*sizeof(complex_fract16));
        AE_S32X2_XP(AE_MOVINT32X2_FROMINT16X4(x14), py0, stride*sizeof(complex_fract16));
        AE_S32X2_XP(AE_MOVINT32X2_FROMINT16X4(x3 ), py0, stride*sizeof(complex_fract16));
        AE_S32X2_XP(AE_MOVINT32X2_FROMINT16X4(x7 ), py0, stride*sizeof(complex_fract16));
        AE_S32X2_XP(AE_MOVINT32X2_FROMINT16X4(x11), py0, stride*sizeof(complex_fract16));
        AE_S32X2_XP(AE_MOVINT32X2_FROMINT16X4(x15), py0, (2 - 15 * stride)*sizeof(complex_fract16));
    }
    return 2 * shift;
}
