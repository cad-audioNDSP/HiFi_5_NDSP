...
int ifft_cplxf_ie    (complex_float* y,complex_float* x, const complex_float* twd, int twdstep, int N)
{
    ...
    * all permutations are deferred until the last stage.                       */
    ...
    else
    {
        xtfloatx2 a4, a5, a6, a7;
        xtfloatx2 b4, b5, b6, b7;
        xtfloatx2 d4, d5, d6, d7;
        xtfloatx2 e4, e5, e6, e7;
   ...
   permutation.*/
    ...
    if(stride==0)
    {
        ...
        for ( n=0; n<(N>>1); n++ )
        {
            ...
            /* Divide data by the FFT size. */
            b0_re = XT_MUL_S(XT_ADD_S(a0_re , a1_re),recipN); b0_im = XT_MUL_S(XT_ADD_S(a0_im , a1_im),recipN);
            b1_re = XT_MUL_S(XT_SUB_S(a0_re , a1_re),recipN); b1_im = XT_MUL_S(XT_SUB_S(a0_im , a1_im),recipN);
