...
void mtx_inv10x10f(void * pScr,float32_t* x) 
{
...

    {
        ...
        for(n=0; n<N; n+=2)
        {
            ...
            xtfloatx2 b0,b1,b2,b3,b4;
            AE_LASX2X2_IP(a0,a1,aX,pX);
            AE_LASX2X2_IP(a2,a3,aX,pX);
            AE_LASX2X2_IP(a4,b0,aX,pX);
            AE_LASX2X2_IP(b1,b2,aX,pX);
            AE_LASX2X2_IP(b3,b4,aX,pX);
            AE_SSX2X2_IP(a0,a1,pA,sizeof(xtfloatx4));
            AE_SSX2X2_IP(a2,a3,pA,sizeof(xtfloatx4));
            AE_SSX2X2_IP(a4,XT_CONST_S(0),pA,sizeof(xtfloatx4));
            AE_SSX2X2_IP(XT_CONST_S(0),XT_CONST_S(0),pA,sizeof(xtfloatx4));
            AE_SSX2X2_IP(XT_CONST_S(0),XT_CONST_S(0),pA,sizeof(xtfloatx4));
            XT_SSX(XT_CONST_S(1),(xtfloat*)pA,(-N+n)*sizeof(float32_t));
            AE_SSX2X2_IP(b0,b1,pA,sizeof(xtfloatx4));
            AE_SSX2X2_IP(b2,b3,pA,sizeof(xtfloatx4));
            AE_SSX2X2_IP(b4,XT_CONST_S(0),pA,sizeof(xtfloatx4));
            AE_SSX2X2_IP(XT_CONST_S(0),XT_CONST_S(0),pA,sizeof(xtfloatx4));
            AE_SSX2X2_IP(XT_CONST_S(0),XT_CONST_S(0),pA,sizeof(xtfloatx4));
            XT_SSX(XT_CONST_S(1),(xtfloat*)pA,(-N+n+1)*sizeof(float32_t));
        }
    }
    /* Gauss elimination */
    for(k=0; k<N; k++)
    {
        ...
        xtfloatx2 Amax0,Amax1,Amax2,Amax3,Amax4,Amax5,Amax6,Amax7,Amax8,Amax9;
        xtfloatx2 amax;
        ...
        AE_LSX2X2_I (Ak8,Ak9,(const xtfloatx4*)pA, 4*sizeof(xtfloatx4));
        ...
        AE_LSX2X2_I (Amax8,Amax9,(const xtfloatx4*)pAwr, 4*sizeof(xtfloatx4));
        ...
        AE_SSX2X2_IP(Amax8,Amax9,castxcc(xtfloatx4,pA), sizeof(xtfloatx4));
        __Pragma("no_reorder")
        ...
        * pivot element during swapping rows  */
        ...
        for (n=0; n<N-1; n++)
        {
            xtfloatx2 c,An0,An1,An2,An3,An4,An5,An6,An7,An8,An9;
            ...
            AE_LSX2X2_I (An8,An9,pA,8*sizeof(xtfloatx2));
            ...
            MSUB_SX2X2(An8,An9,Ak8,Ak9,c,c);
            ...
            AE_SSX2X2_I (An8,An9,pAwr,8*sizeof(xtfloatx2));
    ...
    /* copy to x */
    {
        ...
        for(n=0; n<N; n+=2)
        {
            xtfloatx2 a0,a1,a2,a3,a4;
            xtfloatx2 b0,b1,b2,b3,b4;
            b0=XT_LSX2X ((const xtfloatx2*)pA,(N-1)*sizeof(xtfloatx2));
            a0=XT_LSX2I ((const xtfloatx2*)pA,(-1)*(int)sizeof(xtfloatx2));
            AE_LSX2X2_IP(a1,a2,pA,  sizeof(xtfloatx4));
            AE_LSX2X2_XP(a3,a4,pA,4*sizeof(xtfloatx4));
            AE_LSX2X2_IP(b1,b2,pA,  sizeof(xtfloatx4));
            AE_LSX2X2_XP(b3,b4,pA,4*sizeof(xtfloatx4));

            AE_SASX2X2_IP(a0,a1,aX,pX);
            AE_SASX2X2_IP(a2,a3,aX,pX);
            AE_SASX2X2_IP(a4,b0,aX,pX);
            AE_SASX2X2_IP(b1,b2,aX,pX);
            AE_SASX2X2_IP(b3,b4,aX,pX);
        }
        AE_SA128POS_FP(aX,pX);
    }
}

size_t mtx_inv10x10f_getScratchSize() { return 2*10*10*sizeof(float32_t); }
#elif (HAVE_FPU) 
// code for scalar FPU
void mtx_inv10x10f(void * pScr,float32_t* x) 
{
    ...
    xtfloat * restrict pAn8;
    xtfloat * restrict pAn9;
    ...
    WUR_AE_CEND0  ((uintptr_t)(A+2*N*N));
    {
        ...
        for(n=0; n<N; n++)
        {
            ...
            AE_S32X2_IP(a4,pA,sizeof(ae_int32x2));
    ...
    for(k=0; k<N; k++)
    {
        ...
        __Pragma("no_reorder")
        {
            ...
            xtfloat c1,c2,c3,c4,c5,c6,c7,c8,c9;
            ...
            pAn8=(xtfloat*)pAn7   ; AE_ADDCIRC_XC(castxcc(ae_int64,pAn8),2*N*sizeof(xtfloat));
            pAn9=(xtfloat*)pAn8   ; AE_ADDCIRC_XC(castxcc(ae_int64,pAn9),2*N*sizeof(xtfloat));
            ...
            c8=XT_LSI(pAn8,0*sizeof(xtfloat));
            c9=XT_LSI(pAn9,0*sizeof(xtfloat));
            for (m=k; m<2*N; m++)
            {
                xtfloat akm,an1,an2,an3,an4,an5,an6,an7,an8,an9;
                ...
                XT_MSUB_S(an8,akm,c8);
                XT_MSUB_S(an9,akm,c9);
                ...
                XT_SSIP(an8,pAn8,sizeof(xtfloat));
                XT_SSIP(an9,pAn9,sizeof(xtfloat));
            }
        }
        __Pragma("no_reorder")
    }
    /* copy to x */
    {
        ...
        for(n=0; n<N; n++)
        {
            ...
            a4=AE_L32X2_I(pA,4*sizeof(ae_int32x2));
...
#else
DISCARD_FUN(void, mtx_inv10x10f, (void* pScr, float32_t* x))
