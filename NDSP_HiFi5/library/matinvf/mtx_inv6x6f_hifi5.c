...
void mtx_inv6x6f(void * pScr,float32_t* x)
{
...

    {
        ...
        for(n=0; n<N; n+=2)
        {
            ...
            AE_LASX2X2_IP(a2,b0,aX,pX);
            AE_LASX2X2_IP(b1,b2,aX,pX);
            AE_SSX2X2_IP(a0,a1,pA,sizeof(xtfloatx4));
            AE_SSX2X2_IP(a2,XT_CONST_S(0),pA,sizeof(xtfloatx4));
            ...
            AE_SSX2X2_IP(b2,XT_CONST_S(0),pA,sizeof(xtfloatx4));
            AE_SSX2X2_IP(XT_CONST_S(0),XT_CONST_S(0),pA,sizeof(xtfloatx4));
    ...
    /* copy to x */
    {
        ...
        for(n=0; n<N; n+=2)
        {
            ...
            AE_LSX2X2_IP(a1,a2,pA,3*sizeof(xtfloatx4));
            AE_LSX2X2_IP(b1,b2,pA,3*sizeof(xtfloatx4));

            AE_SASX2X2_IP(a0,a1,aX,pX);
            AE_SASX2X2_IP(a2,b0,aX,pX);
