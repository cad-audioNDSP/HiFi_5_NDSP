    ...
    const complex_float * y)
{
    ...
    const xtfloatx2 * restrict pR7 = (const xtfloatx2*)(R + (8 * 7) / 2 + 0); //N*(N-1)/2
    const xtfloatx2 * restrict pR6 = (const xtfloatx2*)(R + (8 * 7) / 2 + 1);
    const xtfloatx2 * restrict pR5 = (const xtfloatx2*)(R + (8 * 7) / 2 + 2);
    const xtfloatx2 * restrict pR4 = (const xtfloatx2*)(R + (8 * 7) / 2 + 3);
    const xtfloatx2 * restrict pR3 = (const xtfloatx2*)(R + (8 * 7) / 2 + 4);
    const xtfloatx2 * restrict pR2 = (const xtfloatx2*)(R + (8 * 7) / 2 + 5);
    const xtfloatx2 * restrict pR1 = (const xtfloatx2*)(R + (8 * 7) / 2 + 6);
    const xtfloatx4 * restrict pY = (const xtfloatx4*)(y + 6);
    const xtfloatx4 * restrict pD = (const xtfloatx4*)(D + 6);
    xtfloatx4 * restrict pX = (xtfloatx4*)(x + 6);
    xtfloatx2 D0, D1;
    xtfloatx2 R0, R1, R2, R3, R4, R5, R6;
    xtfloatx2 X0, X1, X2, X3, X4, X5, X6, X7, Xt;
	...
	XT_LSX2XP(R0, pR2, -SZ_CF32 * 7); // N-1
	XT_LSX2IP(R1, pR2, 0);
	...
	// X3
	Xt = XT_CONST_S(0);
	XT_LSX2XP(R0, pR3, -SZ_CF32 * 7);
	XT_LSX2XP(R1, pR3, -SZ_CF32 * 6);
	XT_LSX2IP(R2, pR3, 0);
	...
	XT_LSX2XP(R0, pR4, -SZ_CF32 * 7);
	XT_LSX2XP(R1, pR4, -SZ_CF32 * 6);
	XT_LSX2XP(R2, pR4, -SZ_CF32 * 5);
	XT_LSX2IP(R3, pR4, 0);
	...
	// X5
	Xt = XT_CONST_S(0);
	XT_LSX2XP(R0, pR5, -SZ_CF32 * 7);
	XT_LSX2XP(R1, pR5, -SZ_CF32 * 6);
	XT_LSX2XP(R2, pR5, -SZ_CF32 * 5);
	XT_LSX2XP(R3, pR5, -SZ_CF32 * 4);
	XT_LSX2IP(R4, pR5, 0);
	...
	X5 = XT_ADD_SX2(X5, Xt);
	X5 = XT_MUL_SX2(X5, D1);
	AE_SSX2X2_IP(X5, X4, pX, -2 * SZ_CF32);

	// X6
	Xt = XT_CONST_S(0);
	AE_LSX2X2_IP(D1, D0, pD, -2 * SZ_CF32);
	AE_LSX2X2_IP(X7, X6, pY, -2 * SZ_CF32);
	XT_LSX2XP(R0, pR6, -SZ_CF32 * 7);
	XT_LSX2XP(R1, pR6, -SZ_CF32 * 6);
	XT_LSX2XP(R2, pR6, -SZ_CF32 * 5);
	XT_LSX2XP(R3, pR6, -SZ_CF32 * 4);
	XT_LSX2XP(R4, pR6, -SZ_CF32 * 3);
	XT_LSX2IP(R5, pR6, 0);
	...
	// X7
	Xt = XT_CONST_S(0);
	XT_LSX2XP(R0, pR7, -SZ_CF32 * 7);
	XT_LSX2XP(R1, pR7, -SZ_CF32 * 6);
	XT_LSX2XP(R2, pR7, -SZ_CF32 * 5);
	XT_LSX2XP(R3, pR7, -SZ_CF32 * 4);
	XT_LSX2XP(R4, pR7, -SZ_CF32 * 3);
	XT_LSX2XP(R5, pR7, -SZ_CF32 * 2);
	XT_LSX2IP(R6, pR7, 0);
	...
	X7 = XT_ADD_SX2(X7, Xt);
	X7 = XT_MUL_SX2(X7, D1);
	AE_SSX2X2_IP(X7, X6, pX, -2 * SZ_CF32);
}
    ...
    const complex_float * y)
{
    ...
    const xtfloat * restrict pR7 = (const xtfloat*)(R + (8 * 7) / 2 + 0) + 1; //N*(N-1)/2
    const xtfloat * restrict pR6 = (const xtfloat*)(R + (8 * 7) / 2 + 1) + 1;
    const xtfloat * restrict pR5 = (const xtfloat*)(R + (8 * 7) / 2 + 2) + 1;
    const xtfloat * restrict pR4 = (const xtfloat*)(R + (8 * 7) / 2 + 3) + 1;
    const xtfloat * restrict pR3 = (const xtfloat*)(R + (8 * 7) / 2 + 4) + 1;
    const xtfloat * restrict pR2 = (const xtfloat*)(R + (8 * 7) / 2 + 5) + 1;
    const xtfloat * restrict pR1 = (const xtfloat*)(R + (8 * 7) / 2 + 6) + 1;
    const xtfloat * restrict pY = (const xtfloat*)(y + 7) + 1;
    const xtfloat * restrict pD = (const xtfloat*)(D + 7) + 1;
    xtfloat * restrict pX = (xtfloat*)(x + 7) + 1;
    xtfloat D0_re, D0_im;
    xtfloat R1_re, R2_re, R3_re, R4_re, R5_re, R6_re, R7_re;
    xtfloat R1_im, R2_im, R3_im, R4_im, R5_im, R6_im, R7_im;
    xtfloat X0_re, X1_re, X2_re, X3_re, X4_re, X5_re, X6_re, X7_re;
    xtfloat X0_im, X1_im, X2_im, X3_im, X4_im, X5_im, X6_im, X7_im;
    ...
    XT_LSXP(R2_re, pR2, -7 * SZ_CF32 + SZ_F32); //N-1
    ...
    XT_LSXP(R5_re, pR5, -7 * SZ_CF32 + SZ_F32); //N-1
    ...
    XT_LSXP(R5_im, pR5, -SZ_F32);
    XT_LSXP(R5_re, pR5, -5 * SZ_CF32 + SZ_F32);
    ...
    XT_LSXP(R6_re, pR6, -7 * SZ_CF32 + SZ_F32); //N-1
    ...
    XT_LSXP(R7_re, pR7, -7 * SZ_CF32 + SZ_F32); //N-1
...
#else
DISCARD_FUN(void, cmatcholbkwsubst8x8f, (void * pScr,
    complex_float * x,
    const complex_float * R,
    const complex_float * D,
    const complex_float * y))
