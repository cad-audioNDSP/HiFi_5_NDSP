    ...
    const float32_t* restrict Z)
{
    ...
    {
        pY = (xtfloatx4*)y;
        XT_LSX2IP(Yw0, pA, 4 * SZ_F32);
        XT_LSX2IP(Yw1, pA, 4 * SZ_F32);
        XT_LSX2IP(Yw2, pA, 4 * SZ_F32);
        XT_LSX2XP(Yw3, pA, (-4 * 3 + 2)*SZ_F32);
    ...
    const float32_t* restrict y)
{
    ...
    const xtfloatx4 * restrict pY = (xtfloatx4*)(y + (4 * 4 - 4));
	xtfloatx2 Xw01, Xw23;
	xtfloatx2 Xw01t, Xw23t;
	xtfloatx2 Xr01, Xr23;
    xtfloat R0, R0t, D0;
    ...
    for (k = 4 - 1; k >= 0; k-=2)
    {
        ...
        pX = (xtfloatx4*)(x + 4 * 4 - 4); // last 2 elements in X
        ...
        for (m = 0; m < 4 - k - 1; m++)
        {
            ...
            XT_LSXP(R0, pR0, -(3 - m)*SZ_F32);
			MSUB_SX2X2(Xw01, Xw23, Xr01, Xr23, R0, R0);
			XT_LSXP(R0t, pR1, -(3 - m)*SZ_F32);
