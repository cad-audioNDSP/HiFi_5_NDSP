...
{
    static const f_cplxcholFwdrecf f_Fwdrec[4] = { cplxcholFwdrec1f, cplxcholFwdrec2f, cplxcholFwdrec3f, cplxcholFwdrec4f };
    int n;
    ...
    // compute A'*A
    cmatcholpreprocess4x4f(NULL, prep, A, sigma2);
    ...
    for (n = 0; n<4; n++)
    {
        ...
        cplxcholDiagUpdf(y, D + n, prep + n*4 + n, n);
    }
}
...
#else
DISCARD_FUN(void, cmatcholdecomp4x4f, (void * pScr,
	complex_float * R,
	complex_float * D,
	const complex_float * A,
	const float32_t sigma2))
