	...
	const complex_float * Z, int stride)
{
	...
	Y0 = XT_MUL_SX2(Z0, D0);
	XT_SSX2IP(Y0, castxcc(xtfloatx2, pY), 1 * SZ_CF32);
	...
	Y1 = XT_MUL_SX2(Z1, D1);
	XT_SSX2IP(Y1, castxcc(xtfloatx2, pY), 1 * SZ_CF32);
	...
	Y2 = XT_MUL_SX2(Z2, D2);
	XT_SSX2I(Y2, (xtfloatx2*)pY, 0 * SZ_CF32);
	...
	Y3 = XT_MUL_SX2(Z3, D3);
	XT_SSX2I(Y3, (xtfloatx2*)pY, 1 * SZ_CF32);
	...
	Y4 = XT_MUL_SX2(Z4, D4);
	XT_SSX2I(Y4, (xtfloatx2*)pY, 2 * SZ_CF32);
	...
	Y5 = XT_MUL_SX2(Z5, D5);
	XT_SSX2I(Y5, (xtfloatx2*)pY, 3 * SZ_CF32);
	...
	Y6 = XT_MUL_SX2(Z6, D6);
	XT_SSX2I(Y6, (xtfloatx2*)pY, 4 * SZ_CF32);
	...
	Y7 = XT_MUL_SX2(Z7, D7);
	XT_SSX2I(Y7, (xtfloatx2*)pY, 5 * SZ_CF32);

	// Y8
	XT_LSX2XP(Z8, pZ, stride*SZ_CF32);
	AE_LSX2X2_I(D8, D9, (xtfloatx4*)pD, 8 * SZ_CF32);
	AE_LSX2X2_I(R0, R1, (xtfloatx4*)pR8, 0 * SZ_CF32);
	AE_LSX2X2_I(R2, R3, (xtfloatx4*)pR8, 2 * SZ_CF32);
	AE_LSX2X2_I(R4, R5, (xtfloatx4*)pR8, 4 * SZ_CF32);
	AE_LSX2X2_I(R6, R7, (xtfloatx4*)pR8, 6 * SZ_CF32);
	MADDMUX_SX2X2(Z8, Z8t, R0, R1, Y0, Y1, 2);
	MADDMUX_SX2X2(Z8, Z8t, R0, R1, Y0, Y1, 1);
	MADDMUX_SX2X2(Z8, Z8t, R2, R3, Y2, Y3, 2);
	MADDMUX_SX2X2(Z8, Z8t, R2, R3, Y2, Y3, 1);
	MADDMUX_SX2X2(Z8, Z8t, R4, R5, Y4, Y5, 2);
	MADDMUX_SX2X2(Z8, Z8t, R4, R5, Y4, Y5, 1);
	MADDMUX_SX2X2(Z8, Z8t, R6, R7, Y6, Y7, 2);
	MADDMUX_SX2X2(Z8, Z8t, R6, R7, Y6, Y7, 1);
	Z8 = XT_ADD_SX2(Z8, Z8t);
	Y8 = XT_MUL_SX2(Z8, D8);
	XT_SSX2I(Y8, (xtfloatx2*)pY, 6 * SZ_CF32);

	// Y9
	XT_LSX2XP(Z9, pZ, stride*SZ_CF32);
	R0 = XT_LSX2I((pR9-1), 1 * SZ_CF32);
	AE_LSX2X2_I(R1, R2, (xtfloatx4*)(pR9 - 1), 2 * SZ_CF32);
	AE_LSX2X2_I(R3, R4, (xtfloatx4*)(pR9 - 1), 4 * SZ_CF32);
	AE_LSX2X2_I(R5, R6, (xtfloatx4*)(pR9 - 1), 6 * SZ_CF32);
	AE_LSX2X2_I(R7, R8, (xtfloatx4*)(pR9 - 1), 8 * SZ_CF32);
	XT_MADDMUX_S(Z9, R0, Y0, 2);
	XT_MADDMUX_S(Z9t, R0, Y0, 1);
	MADDMUX_SX2X2(Z9, Z9t, R1, R2, Y1, Y2, 2);
	MADDMUX_SX2X2(Z9, Z9t, R1, R2, Y1, Y2, 1);
	MADDMUX_SX2X2(Z9, Z9t, R3, R4, Y3, Y4, 2);
	MADDMUX_SX2X2(Z9, Z9t, R3, R4, Y3, Y4, 1);
	MADDMUX_SX2X2(Z9, Z9t, R5, R6, Y5, Y6, 2);
	MADDMUX_SX2X2(Z9, Z9t, R5, R6, Y5, Y6, 1);
	MADDMUX_SX2X2(Z9, Z9t, R7, R8, Y7, Y8, 2);
	MADDMUX_SX2X2(Z9, Z9t, R7, R8, Y7, Y8, 1);
	Z9 = XT_ADD_SX2(Z9, Z9t);
	Y9 = XT_MUL_SX2(Z9, D9);
	XT_SSX2I(Y9, (xtfloatx2*)pY, 7 * SZ_CF32);
}
#elif (HAVE_FPU)
#define SZ_F32 (sizeof(float32_t))
#define SZ_CF32 (2*SZ_F32)
