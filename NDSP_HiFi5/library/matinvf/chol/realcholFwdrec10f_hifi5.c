    ...
    const float32_t * Z, int stride)
{
    ...
    xtfloat Z0, Z1, Z2, Z3, Z4, Z5, Z6, Z7, Z8, Z9;
    xtfloat D0, D1, D2, D3, D4, D5, D6, D7, D8, D9;
    xtfloat Y0, Y1, Y2, Y3, Y4, Y5, Y6, Y7, Y8, Y9;
    xtfloat R0, R1, R2, R3, R4, R5, R6, R7, R8;
    ...
    // Y9
    XT_LSXP(Z9, pZ, stride*SZ_F32);
    XT_LSIP(D9, pD, SZ_F32);
    XT_LSIP(R0, pR9, SZ_F32);
    XT_LSIP(R1, pR9, SZ_F32);
    XT_LSIP(R2, pR9, SZ_F32);
    XT_LSIP(R3, pR9, SZ_F32);
    XT_LSIP(R4, pR9, SZ_F32);
    XT_LSIP(R5, pR9, SZ_F32);
    XT_LSIP(R6, pR9, SZ_F32);
    XT_LSIP(R7, pR9, SZ_F32);
    XT_LSIP(R8, pR9, 0);
    XT_MSUB_S(Z9, R0, Y0);
    XT_MSUB_S(Z9, R1, Y1);
    XT_MSUB_S(Z9, R2, Y2);
