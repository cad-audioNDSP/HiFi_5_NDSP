	...
	const complex_float * Z, int stride)
{
	...
	xtfloatx2 Z1t, Z2t, Z3t, Z4t, Z5t, Z6t, Z7t, Z8t;
	xtfloatx2 D0, D1, D2, D3, D4, D5, D6, D7, D8;
	xtfloatx2 Y0, Y1, Y2, Y3, Y4, Y5, Y6, Y7, Y8;
	xtfloatx2 R0, R1, R2, R3, R4, R5, R6, R7;

	Z1t = Z2t = Z3t = Z4t = Z5t = Z6t = Z7t = Z8t = XT_CONST_S(0);
	// Y0
	XT_LSX2XP(Z0, pZ, stride*SZ_CF32);
	AE_LSX2X2_IP(D0, D1, castxcc(xtfloatx4, pD), 2 * SZ_CF32);
	Y0 = XT_MUL_SX2(Z0, D0);
	...
	Y1 = XT_MUL_SX2(Z1, D1);
	XT_SSX2I(Y1, (xtfloatx2*)pY, 0 * SZ_CF32);

	// Y2
	XT_LSX2XP(Z2, pZ, stride*SZ_CF32);
	AE_LSX2X2_I(D2, D3, (xtfloatx4*)pD, 0 * SZ_CF32);
	...
	Y2 = XT_MUL_SX2(Z2, D2);
	XT_SSX2I(Y2, (xtfloatx2*)pY, 1 * SZ_CF32);
	...
	Y3 = XT_MUL_SX2(Z3, D3);
	XT_SSX2I(Y3, (xtfloatx2*)pY, 2 * SZ_CF32);

	// Y4
	XT_LSX2XP(Z4, pZ, stride*SZ_CF32);
	AE_LSX2X2_I(D4, D5, (xtfloatx4*)pD, 2 * SZ_CF32);
	...
	Y4 = XT_MUL_SX2(Z4, D4);
	XT_SSX2I(Y4, (xtfloatx2*)pY, 3 * SZ_CF32);
	...
	Y5 = XT_MUL_SX2(Z5, D5);
	XT_SSX2I(Y5, (xtfloatx2*)pY, 4 * SZ_CF32);

	// Y6
	XT_LSX2XP(Z6, pZ, stride*SZ_CF32);
	AE_LSX2X2_I(D6, D7, (xtfloatx4*)pD, 4 * SZ_CF32);
	...
	Y6 = XT_MUL_SX2(Z6, D6);
	XT_SSX2I(Y6, (xtfloatx2*)pY, 5 * SZ_CF32);
	...
	Y7 = XT_MUL_SX2(Z7, D7);
	XT_SSX2I(Y7, (xtfloatx2*)pY, 6 * SZ_CF32);

	// Y8
	XT_LSX2XP(Z8, pZ, stride*SZ_CF32);
	D8 = AE_LSX2I(pD, 6 * SZ_CF32);
	...
	Y8 = XT_MUL_SX2(Z8, D8);
	XT_SSX2I(Y8, (xtfloatx2*)pY, 7 * SZ_CF32);
}
#elif (HAVE_FPU)
#define SZ_F32 (sizeof(float32_t))
#define SZ_CF32 (2*SZ_F32)
    ...
    const complex_float * Z, int stride)
{
    ...
    xtfloat Y0_re, Y1_re, Y2_re, Y3_re, Y4_re, Y5_re, Y6_re, Y7_re, Y8_re;
    xtfloat Y0_im, Y1_im, Y2_im, Y3_im, Y4_im, Y5_im, Y6_im, Y7_im, Y8_im;
    xtfloat R_re, R_im;
    xtfloat D_re, D_im;
