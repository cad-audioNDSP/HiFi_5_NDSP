    ...
    const float32_t* restrict Z)
{
	int n, m;
	xtfloat R0, R0t, D0;
	xtfloatx2 Yr01, Yr23, Yr45, Yr67;
	xtfloatx2 Yw0, Yw1, Yw2, Yw3, Yw4, Yw5, Yw6, Yw7;
	xtfloatx2 Yw01, Yw23, Yw45, Yw67;
	xtfloatx2 Yw01t, Yw23t, Yw45t, Yw67t;
	...
	{
		pY = (xtfloatx4*)y;
		XT_LSX2XP(Yw0, pA, 8 * SZ_F32);
		XT_LSX2XP(Yw1, pA, 8 * SZ_F32);
		XT_LSX2XP(Yw2, pA, 8 * SZ_F32);
		XT_LSX2XP(Yw3, pA, 8 * SZ_F32);
		XT_LSX2XP(Yw4, pA, 8 * SZ_F32);
		XT_LSX2XP(Yw5, pA, 8 * SZ_F32);
		XT_LSX2XP(Yw6, pA, 8 * SZ_F32);
		XT_LSX2XP(Yw7, pA, (-8 * 7 + 2)*SZ_F32);
		...
		Yw67t = XT_SEL32_LL_SX2(Yw6, Yw7);
		pRt = pR + n + 1;
		for (m = 0; m<n; m++)
		{
			AE_LSX2X2_IP(Yr01, Yr23, pY, 4 * SZ_F32);
			AE_LSX2X2_IP(Yr45, Yr67, pY, 4 * SZ_F32);

			XT_LSIP(R0, pR, SZ_F32);
			XT_LSIP(R0t, pRt, SZ_F32);
			MSUB_SX2X2(Yw01, Yw23, R0, R0, Yr01, Yr23);
			MSUB_SX2X2(Yw01t, Yw23t, R0t, R0t, Yr01, Yr23);
			MSUB_SX2X2(Yw45, Yw67, R0, R0, Yr45, Yr67);
			MSUB_SX2X2(Yw45t, Yw67t, R0t, R0t, Yr45, Yr67);

		}

		XT_LSIP(D0, pD, SZ_F32);
		MUL_SX2X2(Yw01, Yw23, Yw01, Yw23, D0, D0);
		MUL_SX2X2(Yw45, Yw67, Yw45, Yw67, D0, D0);

		Yr01 = Yw01; Yr23 = Yw23; Yr45 = Yw45; Yr67 = Yw67;
		...
		MUL_SX2X2(Yw45t, Yw67t, Yw45t, Yw67t, D0, D0);

		AE_SSX2X2_IP(Yw01, Yw23, pY, 4 * SZ_F32);
		AE_SSX2X2_IP(Yw45, Yw67, pY, 4 * SZ_F32);
		AE_SSX2X2_IP(Yw01t, Yw23t, pY, 4 * SZ_F32);
		AE_SSX2X2_IP(Yw45t, Yw67t, pY, 4 * SZ_F32);
		pR = pRt + 1;
	}
}
/*
    ...
    const float32_t* restrict y)
{
	...
	const xtfloat * restrict tpR = (xtfloat*)(R + 8 * 9 / 2 - 1); //last element in R
	const xtfloat * restrict pD = (xtfloat*)(D + (8 - 1));
	const xtfloatx4 * restrict pY = (xtfloatx4*)(y + (8 * 8 - 4));
	xtfloatx2 Xw01, Xw23, Xw45, Xw67;
	xtfloatx2 Xw01t, Xw23t, Xw45t, Xw67t;
	xtfloatx2 Xr01, Xr23, Xr45, Xr67;
	xtfloat R0, R0t, D0;

	for (k = 8 - 1; k >= 0; k -= 2)
	{

		pX = (xtfloatx4*)(x + 8 * 8 - 4); // last 2 elements in X
		pR0 = (xtfloat*)(tpR--); //points to the end of row k in R
		pR1 = (xtfloat*)(tpR--); //points to the end of row k in R

		AE_LSX2X2_IP(Xw45, Xw67, pY, -4 * SZ_F32);
		AE_LSX2X2_IP(Xw01, Xw23, pY, -4 * SZ_F32);
		AE_LSX2X2_IP(Xw45t, Xw67t, pY, -4 * SZ_F32);
		AE_LSX2X2_IP(Xw01t, Xw23t, pY, -4 * SZ_F32);

		for (m = 0; m < 8 - k - 1; m++)
		{
			AE_LSX2X2_IP(Xr45, Xr67, pX, -4 * SZ_F32);
			AE_LSX2X2_IP(Xr01, Xr23, pX, -4 * SZ_F32);

			XT_LSXP(R0, pR0, -(7 - m)*SZ_F32);
			MSUB_SX2X2(Xw01, Xw23, Xr01, Xr23, R0, R0);
			MSUB_SX2X2(Xw45, Xw67, Xr45, Xr67, R0, R0);
			XT_LSXP(R0t, pR1, -(7 - m)*SZ_F32);
			MSUB_SX2X2(Xw01t, Xw23t, Xr01, Xr23, R0t, R0t);
			MSUB_SX2X2(Xw45t, Xw67t, Xr45, Xr67, R0t, R0t);
		}
		XT_LSXP(D0, pD, -SZ_F32);
		MUL_SX2X2(Xw01, Xw23, Xw01, Xw23, D0, D0);
		MUL_SX2X2(Xw45, Xw67, Xw45, Xw67, D0, D0);

		Xr01 = Xw01; Xr23 = Xw23; Xr45 = Xw45; Xr67 = Xw67;

		XT_LSXP(R0, pR1, -k * SZ_F32);
		MSUB_SX2X2(Xw01t, Xw23t, Xr01, Xr23, R0, R0);
		MSUB_SX2X2(Xw45t, Xw67t, Xr45, Xr67, R0, R0);

		XT_LSXP(D0, pD, -SZ_F32);
		MUL_SX2X2(Xw01t, Xw23t, Xw01t, Xw23t, D0, D0);
		MUL_SX2X2(Xw45t, Xw67t, Xw45t, Xw67t, D0, D0);

		AE_SSX2X2_IP(Xw45, Xw67, pX, -4 * SZ_F32);
		AE_SSX2X2_IP(Xw01, Xw23, pX, -4 * SZ_F32);
		AE_SSX2X2_IP(Xw45t, Xw67t, pX, -4 * SZ_F32);
		AE_SSX2X2_IP(Xw01t, Xw23t, pX, -4 * SZ_F32);
    ...
    const float32_t  sigma2)
{
    ...
    matcholdecomp8x8f(pScr, R, D, A, sigma2);
    rfwd8x8f(y, R, D, A);
    rbkw8x8f(x, R, D, y);
}
...
size_t   matcholpseudoinv8x8f_getScratchSize()
{
    ...
    s_dc = matcholdecomp8x8f_getScratchSize();
    ...
    const float32_t* restrict Z)
{
    ...
    int n, m;
    xtfloat R0, D0;
    xtfloat Yr0, Yr1, Yr2, Yr3, Yr4, Yr5, Yr6, Yr7;
    xtfloat Yw0, Yw1, Yw2, Yw3, Yw4, Yw5, Yw6, Yw7;
    xtfloat * restrict pY;
    const xtfloat * restrict pR = (const xtfloat *)R;
    const xtfloat * restrict pD = (const xtfloat *)D;
    ...
    {
        pY = (xtfloat*)y;
        XT_LSIP(Yw0, pA, 8 * SZ_F32);
        XT_LSIP(Yw1, pA, 8 * SZ_F32);
        XT_LSIP(Yw2, pA, 8 * SZ_F32);
        XT_LSIP(Yw3, pA, 8 * SZ_F32);
        XT_LSIP(Yw4, pA, 8 * SZ_F32);
        XT_LSIP(Yw5, pA, 8 * SZ_F32);
        XT_LSIP(Yw6, pA, 8 * SZ_F32);
        XT_LSXP(Yw7, pA, (-8 * (8 - 1) + 1)*SZ_F32);
    ...
    const float32_t* restrict y)
{
    ...
    xtfloat * restrict pX;
    const xtfloat * restrict pR;
    const xtfloat * restrict tpR = (xtfloat*)(R + 8 * (8 + 1) / 2 - 1); //last element in R
    const xtfloat * restrict pD = (xtfloat*)(D + (8 - 1));
    const xtfloat * restrict pY = (xtfloat*)(y + (8 * 8 - 1));
    xtfloat Xw0, Xw1, Xw2, Xw3, Xw4, Xw5, Xw6, Xw7;
    xtfloat Xr0, Xr1, Xr2, Xr3, Xr4, Xr5, Xr6, Xr7;
    xtfloat R0, D0;

    for (k = 8 - 1; k >= 0; k--)
    {
        {
            pX = (xtfloat*)(x + 8 * 8 - 1); // last element in X
...
#else
DISCARD_FUN(void, matcholpseudoinv8x8f, (void* pScr,
	float32_t *R,
	const float32_t * A,
	const float32_t  sigma2))
