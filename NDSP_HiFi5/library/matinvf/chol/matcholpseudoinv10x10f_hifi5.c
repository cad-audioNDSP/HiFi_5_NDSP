    ...
    const float32_t* restrict Z)
{
	...
	xtfloatx2 Yw01t, Yw23t, Yw45t, Yw67t, Yw89t;
	...
	{
		pY = (xtfloatx2*)y;
		XT_LSX2XP(Yw0, pA, 10 * SZ_F32);
		XT_LSX2XP(Yw1, pA, 10 * SZ_F32);
		XT_LSX2XP(Yw2, pA, 10 * SZ_F32);
		XT_LSX2XP(Yw3, pA, 10 * SZ_F32);
		XT_LSX2XP(Yw4, pA, 10 * SZ_F32);
		XT_LSX2XP(Yw5, pA, 10 * SZ_F32);
		XT_LSX2XP(Yw6, pA, 10 * SZ_F32);
		XT_LSX2XP(Yw7, pA, 10 * SZ_F32);
		XT_LSX2XP(Yw8, pA, 10 * SZ_F32);
		XT_LSX2XP(Yw9, pA, (-10 * 9 + 2)*SZ_F32);
		...
		for (m = 0; m<n; m++)
		{
			...
			AE_LSX2IP(Yr67, pY, 2 * SZ_F32);
			AE_LSX2IP(Yr89, pY, 2 * SZ_F32);
			...
			MSUB_SX2X2(Yw89, Yw89t, R0, R0t, Yr89, Yr89);
		}

		XT_LSIP(D0, pD, SZ_F32);
		MUL_SX2X2(Yw01, Yw23, Yw01, Yw23, D0, D0);
		MUL_SX2X2(Yw45, Yw67, Yw45, Yw67, D0, D0);
		Yw89 = MUL_SX2(Yw89, D0);

		Yr01 = Yw01; Yr23 = Yw23; Yr45 = Yw45; Yr67 = Yw67; Yr89 = Yw89;

		XT_LSIP(R0t, pRt, SZ_F32);
		MSUB_SX2X2(Yw01t, Yw23t, R0t, R0t, Yr01, Yr23);
		MSUB_SX2X2(Yw45t, Yw67t, R0t, R0t, Yr45, Yr67);
		MSUB_SX2(Yw89t, R0t, Yr89);

		XT_LSIP(D0, pD, SZ_F32);
		MUL_SX2X2(Yw01t, Yw23t, Yw01t, Yw23t, D0, D0);
		MUL_SX2X2(Yw45t, Yw67t, Yw45t, Yw67t, D0, D0);
		Yw89t = MUL_SX2(Yw89t, D0);

		AE_SSX2X2_IP(Yw01, Yw23, castxcc(xtfloatx4, pY), 4 * SZ_F32);
		AE_SSX2X2_IP(Yw45, Yw67, castxcc(xtfloatx4, pY), 4 * SZ_F32);
		AE_SSX2X2_IP(Yw89, Yw01t, castxcc(xtfloatx4, pY), 4 * SZ_F32);
		AE_SSX2X2_IP(Yw23t, Yw45t, castxcc(xtfloatx4, pY), 4 * SZ_F32);
		AE_SSX2X2_IP(Yw67t, Yw89t, castxcc(xtfloatx4, pY), 4 * SZ_F32);
		pR = pRt + 1;
	}
}
/*
    ...
    const float32_t* restrict y)
{
	...
	const xtfloat * restrict tpR = (xtfloat*)(R + 10 * 11 / 2 - 1); //last element in R
	const xtfloat * restrict pD = (xtfloat*)(D + (10 - 1));
	const xtfloatx4 * restrict pY = (xtfloatx4*)(y + (10 * 10 - 4));
	xtfloatx2 Xw01, Xw23, Xw45, Xw67, Xw89;
	xtfloatx2 Xw01t, Xw23t, Xw45t, Xw67t, Xw89t;
	...
	for (k = 10 - 1; k >= 0; k -= 2)
	{
		...
		for (m = 0; m < 10 - k - 1; m++)
		{
			...
			MSUB_SX2X2(Xw89, Xw89t, Xr89, Xr89, R0, R0t);
		}
		...
		Xr01 = Xw01; Xr23 = Xw23; Xr45 = Xw45; Xr67 = Xw67; Xr89 = Xw89;

		XT_LSXP(R0, pR1, -k * SZ_F32);
		MSUB_SX2X2(Xw01t, Xw23t, Xr01, Xr23, R0, R0);
		MSUB_SX2X2(Xw45t, Xw67t, Xr45, Xr67, R0, R0);
		MSUB_SX2(Xw89t, Xr89, R0);

		XT_LSXP(D0, pD, -SZ_F32);
		MUL_SX2X2(Xw01t, Xw23t, Xw01t, Xw23t, D0, D0);
		MUL_SX2X2(Xw45t, Xw67t, Xw45t, Xw67t, D0, D0);
		Xw89t = XT_MUL_SX2(Xw89t, D0);

		pX--;
		AE_SSX2X2_IP(Xw67, Xw89, castxcc(xtfloatx4, pX), -4 * SZ_F32);
		AE_SSX2X2_IP(Xw23, Xw45, castxcc(xtfloatx4, pX), -4 * SZ_F32);
		AE_SSX2X2_IP(Xw89t, Xw01, castxcc(xtfloatx4, pX), -4 * SZ_F32);
		AE_SSX2X2_IP(Xw45t, Xw67t, castxcc(xtfloatx4, pX), -4 * SZ_F32);
