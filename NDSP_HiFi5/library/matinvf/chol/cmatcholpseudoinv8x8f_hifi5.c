    ...
    const complex_float* restrict Z)
{
	...
	int n, m;
	xtfloatx2 R0, D0;
	xtfloatx2 Yr0, Yr1, Yr2, Yr3, Yr4, Yr5, Yr6, Yr7;
	xtfloatx2 Yw0, Yw1, Yw2, Yw3, Yw4, Yw5, Yw6, Yw7;
	xtfloatx2 Yw0t, Yw1t, Yw2t, Yw3t, Yw4t, Yw5t, Yw6t, Yw7t;
		...
		//for (p = 0; p<P; p++)
	{
		...
		XT_LSX2XP(Yw4, pA, 8 * SZ_CF32);
		XT_LSX2XP(Yw5, pA, 8 * SZ_CF32);
		XT_LSX2XP(Yw6, pA, 8 * SZ_CF32);
		XT_LSX2XP(Yw7, pA, (-8 * 7 + 1)*SZ_CF32);
    ...
    const complex_float* restrict y)
{
	...
	const xtfloatx4 * restrict pY = (xtfloatx4*)(y + (8 * 8 - 2));
	xtfloatx2 X0, X1, X2, X3, X4, X5, X6, X7;
	xtfloatx2 Xw0, Xw1, Xw2, Xw3, Xw4, Xw5, Xw6, Xw7;
	xtfloatx2 Xw0t, Xw1t, Xw2t, Xw3t, Xw4t, Xw5t, Xw6t, Xw7t;
	xtfloatx2 R0, D0;
	...
	for (k = 8 - 1; k >= 0; k--)
	{
		//for (p = 0; p < P; p++)
		{
			pX = (xtfloatx4*)(x + 8 * 8 - 2); // last element in X
