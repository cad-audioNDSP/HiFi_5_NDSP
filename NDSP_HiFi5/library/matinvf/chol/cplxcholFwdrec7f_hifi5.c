	...
	const complex_float * Z, int stride)
{
	...
	xtfloatx2 Z0, Z1, Z2, Z3, Z4, Z5, Z6;
	xtfloatx2 Z1t, Z2t, Z3t, Z4t, Z5t, Z6t;
	xtfloatx2 D0, D1, D2, D3, D4, D5, D6;
	xtfloatx2 Y0, Y1, Y2, Y3, Y4, Y5, Y6;
	xtfloatx2 R0, R1, R2, R3, R4, R5;

	Z1t = Z2t = Z3t = Z4t = Z5t = Z6t = XT_CONST_S(0);
	// Y0
    ...
    const complex_float * Z, int stride)
{
    ...
    xtfloat Y0_re, Y1_re, Y2_re, Y3_re, Y4_re, Y5_re, Y6_re;
    xtfloat Y0_im, Y1_im, Y2_im, Y3_im, Y4_im, Y5_im, Y6_im;
    xtfloat R_re, R_im;
    xtfloat D_re, D_im;
