	...
	const float32_t  sigma2)
{
	...
	xtfloatx2 Acc00, Acc01, Acc02, Acc03, Acc04, Acc05;
	xtfloatx2        Acc11, Acc12, Acc13, Acc14, Acc15;
	xtfloatx2               Acc22, Acc23, Acc24, Acc25;
	xtfloatx2                      Acc33, Acc34, Acc35;
	xtfloatx2                             Acc44, Acc45;
	xtfloatx2                                    Acc55;
	xtfloatx2 Apn0, Apn1, Apn2, Apn3, Apn4, Apn5;
	Acc00 = Acc11 = Acc22 = Acc33 = Acc44 = Acc55 = sigma_w_zeros;
	CONST_SX2X2(Acc01, Acc02, 0);
	CONST_SX2X2(Acc03, Acc04, 0);
	CONST_SX2X2(Acc05, Acc12, 0);
	CONST_SX2X2(Acc13, Acc14, 0);
	CONST_SX2X2(Acc15, Acc23, 0);
	CONST_SX2X2(Acc24, Acc25, 0);
	CONST_SX2X2(Acc34, Acc35, 0);
	Acc45 = XT_CONST_S(0);
	...
	for (p = 0; p < 6; p++)
	{
		...
		MADDMUX_SX2X2(Acc15, Acc22, Apn1, Apn2, Apn5, Apn2, 0);
		MADDMUX_SX2X2(Acc15, Acc22, Apn1, Apn2, Apn5, Apn2, 3);
		MADDMUX_SX2X2(Acc23, Acc24, Apn2, Apn2, Apn3, Apn4, 0);
		MADDMUX_SX2X2(Acc23, Acc24, Apn2, Apn2, Apn3, Apn4, 3);

		MADDMUX_SX2X2(Acc25, Acc33, Apn2, Apn3, Apn5, Apn3, 0);
		MADDMUX_SX2X2(Acc25, Acc33, Apn2, Apn3, Apn5, Apn3, 3);
    ...
    const float32_t  sigma2)
{
    ...
    for (m = 0; m < 6; m += 2)
    {
        ...
        for (p = 0; p < 6; p++)
        {
            re_Apm0 = Af[(p * 6 + (m + 0)) * 2 + 0];
            re_Apm1 = Af[(p * 6 + (m + 1)) * 2 + 0];
            im_Apm0 = Af[(p * 6 + (m + 0)) * 2 + 1];
            im_Apm1 = Af[(p * 6 + (m + 1)) * 2 + 1];
        ...
        Rf[((m + 0) * 6 + (m + 0)) * 2 + 0] = re_acc00;
        Rf[((m + 0) * 6 + (m + 0)) * 2 + 1] = im_acc00;
        Rf[((m + 0) * 6 + (m + 1)) * 2 + 0] = re_acc01;
        Rf[((m + 0) * 6 + (m + 1)) * 2 + 1] = im_acc01;
        Rf[((m + 1) * 6 + (m + 0)) * 2 + 0] = re_acc01;
        Rf[((m + 1) * 6 + (m + 0)) * 2 + 1] = -im_acc01;
        Rf[((m + 1) * 6 + (m + 1)) * 2 + 0] = re_acc11;
        Rf[((m + 1) * 6 + (m + 1)) * 2 + 1] = im_acc11;
        ...
        for (n = m + 2; n < 6; n += 2)
        {
            ...
            for (p = 0; p < 6; p++)
            {
                re_Apm0 = Af[(p * 6 + (m + 0)) * 2 + 0];
                re_Apm1 = Af[(p * 6 + (m + 1)) * 2 + 0];
                re_Apn0 = Af[(p * 6 + (n + 0)) * 2 + 0];
                re_Apn1 = Af[(p * 6 + (n + 1)) * 2 + 0];
                im_Apm0 = Af[(p * 6 + (m + 0)) * 2 + 1];
                im_Apm1 = Af[(p * 6 + (m + 1)) * 2 + 1];
                im_Apn0 = Af[(p * 6 + (n + 0)) * 2 + 1];
                im_Apn1 = Af[(p * 6 + (n + 1)) * 2 + 1];
            ...
            Rf[((m + 0) * 6 + (n + 0)) * 2 + 0] = re_acc00;
            Rf[((m + 0) * 6 + (n + 0)) * 2 + 1] = im_acc00;
            Rf[((m + 0) * 6 + (n + 1)) * 2 + 0] = re_acc01;
            Rf[((m + 0) * 6 + (n + 1)) * 2 + 1] = im_acc01;
            Rf[((m + 1) * 6 + (n + 0)) * 2 + 0] = re_acc10;
            Rf[((m + 1) * 6 + (n + 0)) * 2 + 1] = im_acc10;
            Rf[((m + 1) * 6 + (n + 1)) * 2 + 0] = re_acc11;
            Rf[((m + 1) * 6 + (n + 1)) * 2 + 1] = im_acc11;

            Rf[((m + 0) + (n + 0) * 6) * 2 + 0] = re_acc00;
            Rf[((m + 0) + (n + 0) * 6) * 2 + 1] = -im_acc00;
            Rf[((m + 0) + (n + 1) * 6) * 2 + 0] = re_acc01;
            Rf[((m + 0) + (n + 1) * 6) * 2 + 1] = -im_acc01;
            Rf[((m + 1) + (n + 0) * 6) * 2 + 0] = re_acc10;
            Rf[((m + 1) + (n + 0) * 6) * 2 + 1] = -im_acc10;
            Rf[((m + 1) + (n + 1) * 6) * 2 + 0] = re_acc11;
            Rf[((m + 1) + (n + 1) * 6) * 2 + 1] = -im_acc11;
        }
    }
}
...
#else
DISCARD_FUN(void, cmatcholpreprocess6x6f, (void* pScr,
	complex_float *R,
	const complex_float * A,
	const float32_t  sigma2))
