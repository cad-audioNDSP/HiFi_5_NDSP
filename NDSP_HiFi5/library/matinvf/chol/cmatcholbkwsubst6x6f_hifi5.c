    ...
    const complex_float * y)
{
    ...
    const xtfloatx4 * restrict pY = (const xtfloatx4*)(y + 4);
    const xtfloatx4 * restrict pD = (const xtfloatx4*)(D + 4);
    xtfloatx4 * restrict pX = (xtfloatx4*)(x + 4);
    xtfloatx2 D0, D1;
    xtfloatx2 R0, R1, R2, R3, R4;
	...
	XT_LSX2XP(R0, pR2, -SZ_CF32 * 5); // N-1
	XT_LSX2IP(R1, pR2, 0);
	...
	// X3
	Xt = XT_CONST_S(0);
	XT_LSX2XP(R0, pR3, -SZ_CF32 * 5);
	XT_LSX2XP(R1, pR3, -SZ_CF32 * 4);
	XT_LSX2IP(R2, pR3, 0);
	...
	XT_LSX2XP(R0, pR4, -SZ_CF32 * 5);
	XT_LSX2XP(R1, pR4, -SZ_CF32 * 4);
	XT_LSX2XP(R2, pR4, -SZ_CF32 * 3);
	XT_LSX2IP(R3, pR4, 0);
	...
	// X5
	Xt = XT_CONST_S(0);
	XT_LSX2XP(R0, pR5, -SZ_CF32 * 5);
	XT_LSX2XP(R1, pR5, -SZ_CF32 * 4);
	XT_LSX2XP(R2, pR5, -SZ_CF32 * 3);
	XT_LSX2XP(R3, pR5, -SZ_CF32 * 2);
	XT_LSX2IP(R4, pR5, 0);
