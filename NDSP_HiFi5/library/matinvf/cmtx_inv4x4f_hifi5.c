...
void cmtx_inv4x4f(void * pScr,complex_float* x)
{
    ...
    for(n=0; n<N; n++)
    {
        ...
        AE_LASX2X2_IP (An2,An3,ax,pk);
        AE_SSX2X2_IP(An0,An1,pA,sizeof(xtfloatx4));
        AE_SSX2X2_IP(An2,An3,pA,sizeof(xtfloatx4));
    ...
    for(k=0; k<N; k++)
    {
        ...
        AE_LSX2X2_I (Ak6,Ak7,pk, 3*sizeof(xtfloatx4));
        ...
        AE_SSX2X2_I (Ak6,Ak7,pk, 3*sizeof(xtfloatx4));
        ...
        AE_LSX2X2_I (An6,An7,pA0, 3*sizeof(xtfloatx4));
        ...
        AE_SSX2X2_I (An6,An7,pA0, 3*sizeof(xtfloatx4));
        ...
        AE_LSX2X2_I (An6,An7,pA1, 3*sizeof(xtfloatx4));
        MADDMUXQ_S(An0,An1,Ak0,Ak1,Ank,2); MADDMUXQ_S(An0,An1,Ak0,Ak1,Ank,3);
        MADDMUXQ_S(An2,An3,Ak2,Ak3,Ank,2); MADDMUXQ_S(An2,An3,Ak2,Ak3,Ank,3);
        MADDMUXQ_S(An4,An5,Ak4,Ak5,Ank,2); MADDMUXQ_S(An4,An5,Ak4,Ak5,Ank,3);
        MADDMUXQ_S(An6,An7,Ak6,Ak7,Ank,2); MADDMUXQ_S(An6,An7,Ak6,Ak7,Ank,3);
        ...
        AE_SSX2X2_I (An6,An7,pA1, 3*sizeof(xtfloatx4));
        ...
        AE_LSX2X2_I (An4,An5,pA2, 2*sizeof(xtfloatx4));
        AE_LSX2X2_I (An6,An7,pA2, 3*sizeof(xtfloatx4));
        MADDMUXQ_S(An0,An1,Ak0,Ak1,Ank,2); MADDMUXQ_S(An0,An1,Ak0,Ak1,Ank,3);
        MADDMUXQ_S(An2,An3,Ak2,Ak3,Ank,2); MADDMUXQ_S(An2,An3,Ak2,Ak3,Ank,3);
        MADDMUXQ_S(An4,An5,Ak4,Ak5,Ank,2); MADDMUXQ_S(An4,An5,Ak4,Ak5,Ank,3);
        MADDMUXQ_S(An6,An7,Ak6,Ak7,Ank,2); MADDMUXQ_S(An6,An7,Ak6,Ak7,Ank,3);
        AE_SSX2X2_I (An2,An3,pA2, 1*sizeof(xtfloatx4));
        AE_SSX2X2_I (An4,An5,pA2, 2*sizeof(xtfloatx4));
        AE_SSX2X2_I (An6,An7,pA2, 3*sizeof(xtfloatx4));
        AE_SSX2X2_XC(An0,An1,pA2, N*sizeof(xtfloatx4));
        __Pragma("no_reorder")
    }
    /* copy to x */
    ax=AE_ZALIGN128();
    ...
    for(n=0; n<N; n++)
    {
        ...
        AE_LSX2X2_XP(An2,An3,pA, (1+N/2)*sizeof(xtfloatx4));
        AE_SASX2X2_IP(An0,An1,ax,pk);
        AE_SASX2X2_IP(An2,An3,ax,pk);
    }
    AE_SA128POS_FP(ax,pk);
}
size_t cmtx_inv4x4f_getScratchSize() { return 32*sizeof(complex_float); }
#elif (HAVE_FPU)
// code for scalar FPU
...
void cmtx_inv4x4f(void * pScr,complex_float* restrict x) 
{
    const int N=4;
    int p,n,m,k;
    complex_float r;
    ...
    for(n=0; n<N; n++)
    {
        ...
        AE_L32X2X2_XP(x2,x3,castxcc(ae_int32x4,pArd),(N/2+1)*sizeof(ae_int32x4));
        AE_SA32X2X2_IP(x0,x1,aX,castxcc(ae_int32x4,pAwr));
        AE_SA32X2X2_IP(x2,x3,aX,castxcc(ae_int32x4,pAwr));
    }
    AE_SA128POS_FP(aX,pAwr);
}
size_t cmtx_inv4x4f_getScratchSize() { const int N=4; return 2*N*N*sizeof(complex_float); }
#else
DISCARD_FUN(void, cmtx_inv4x4f, (void* pScr, complex_float* x))
