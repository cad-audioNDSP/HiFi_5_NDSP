...
void cmtx_inv6x6f(void * pScr,complex_float* x)
{
    ...
    for(k=0; k<N; k++)
    {
        ...
        xtfloatx2 Bn0,Bn1,Bn2,Bn3,Bn4,Bn5;
        xtfloatx2 Bk0,Bk1,Bk2,Bk3,Bk4,Bk5;
        ...
        AE_LSX2X2_I (Bk0,Bk1,pAwr, 3*sizeof(xtfloatx4));
        AE_LSX2X2_I (Bk2,Bk3,pAwr, 4*sizeof(xtfloatx4));
        AE_LSX2X2_I (Bk4,Bk5,pAwr, 5*sizeof(xtfloatx4));
        ...
        AE_LSX2X2_I (Bn0,Bn1,pA, 3*sizeof(xtfloatx4));
        AE_LSX2X2_I (Bn2,Bn3,pA, 4*sizeof(xtfloatx4));
        AE_LSX2X2_I (Bn4,Bn5,pA, 5*sizeof(xtfloatx4));
        __Pragma("no_reorder")
        ...
        AE_SSX2X2_I (Bk0,Bk1,pA, 3*sizeof(xtfloatx4));
        AE_SSX2X2_I (Bk2,Bk3,pA, 4*sizeof(xtfloatx4));
        AE_SSX2X2_I (Bk4,Bk5,pA, 5*sizeof(xtfloatx4));
        __Pragma("no_reorder")
        ...
        AE_SSX2X2_I (Bk0,Bk1,pAwr, 3*sizeof(xtfloatx4));
        AE_SSX2X2_I (Bk2,Bk3,pAwr, 4*sizeof(xtfloatx4));
        AE_SSX2X2_I (Bk4,Bk5,pAwr, 5*sizeof(xtfloatx4));
        ...
        for (n=0; n<N-1; n++)
        {
            ...
            AE_SSX2X2_I (Bn0,Bn1,pAwr, 3*sizeof(xtfloatx4));
            AE_SSX2X2_I (Bn2,Bn3,pAwr, 4*sizeof(xtfloatx4));
            AE_SSX2X2_I (Bn4,Bn5,pAwr, 5*sizeof(xtfloatx4));
    ...
    for(n=0; n<N; n++)
    {
        ...
        AE_LSX2X2_XP(An4,An5,pA, (1+N/2)*sizeof(xtfloatx4));
...
size_t cmtx_inv6x6f_getScratchSize()   { return 2*6*6*sizeof(complex_float); }
#elif (HAVE_FPU)
// code for scalar FPU
...
void cmtx_inv6x6f(void * pScr,complex_float* restrict x) 
{
    const int N=6;
    int p,n,m,k;
    complex_float r;
    ...
    for(n=0; n<N; n++)
    {
        ...
        AE_L32X2X2_XP(x4,x5,castxcc(ae_int32x4,pArd),(N/2+1)*sizeof(ae_int32x4));
...
size_t cmtx_inv6x6f_getScratchSize() { const int N=6; return 2*N*N*sizeof(complex_float); }
#else
DISCARD_FUN(void, cmtx_inv6x6f, (void* pScr, complex_float* x))
