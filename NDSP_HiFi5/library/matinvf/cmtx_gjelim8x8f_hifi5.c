...
void  cmtx_gjelim8x8f  (void* pScr, complex_float *y, const complex_float* A,const complex_float * x)
{
    ...
    for(n=0; n<N; n++)
    {
        xtfloatx2 An0,An1,An2,An3,An4,An5,An6,An7,Bn0;
...
size_t cmtx_gjelim8x8f_getScratchSize   () { const int N=8; return (N+2)*N*sizeof(complex_float);  }
#elif (HAVE_FPU)
// code for scalar FPU
...
void  cmtx_gjelim8x8f(void* pScr, complex_float *restrict y, const complex_float* restrict A,const complex_float * restrict x) 
{
    const int N=8;
    int k,n;
...
size_t cmtx_gjelim8x8f_getScratchSize   () { const int N=8; return (N+2)*N*sizeof(complex_float);  }
#else 
DISCARD_FUN(void, cmtx_gjelim8x8f, (void* pScr, complex_float *y, const complex_float* A, const complex_float * x))
