...
void vec_dot_batch8x8_fast  (int16_t * restrict z, const int8_t * restrict x,const cint8ptr_t * restrict y,int rsh, int N, int M)
{
    int m;
    int n;
    int endN;
    const ae_int8x16* restrict y_0;
    const ae_int8x16* restrict y_1;
    const ae_int8x16* restrict y_2;
    const ae_int8x16* restrict y_3;
    ...
    ae_int8x8 Y0_7_0, Y0_7_1, Y0_7_2, Y0_7_3;
    ae_int8x8 Y8_15_0, Y8_15_1, Y8_15_2, Y8_15_3;
    ...
    for (m = 0; m < M; m=m+4) 
    {
        ...
        acc6 = AE_ZERO64();
        acc7 = AE_ZERO64();
        y_0 = (const ae_int8x16*) y[m  ];
        y_1 = (const ae_int8x16*) y[m+1];
        y_2 = (const ae_int8x16*) y[m+2];
        y_3 = (const ae_int8x16*) y[m+3];
        _x  = (const ae_int8x16*) x;

        for (n=0 ; n < endN; n = n + 16) 
        {
            AE_L8X8X2_IP (X0_7  , X8_15  ,  _x, 16); 
            AE_L8X8X2_IP (Y0_7_0, Y8_15_0, y_0, 16); 
            AE_L8X8X2_IP (Y0_7_1, Y8_15_1, y_1, 16); 
            AE_L8X8X2_IP (Y0_7_2, Y8_15_2, y_2, 16); 
            AE_L8X8X2_IP (Y0_7_3, Y8_15_3, y_3, 16); 

            AE_MULAAAA2Q8(acc0, acc4, X0_7, Y0_7_0);
            AE_MULAAAA2Q8(acc1, acc5, X0_7, Y0_7_1);
            AE_MULAAAA2Q8(acc2, acc6, X0_7, Y0_7_2);
            AE_MULAAAA2Q8(acc3, acc7, X0_7, Y0_7_3);

            AE_MULAAAA2Q8(acc0, acc4, X8_15, Y8_15_0);
            AE_MULAAAA2Q8(acc1, acc5, X8_15, Y8_15_1);
            AE_MULAAAA2Q8(acc2, acc6, X8_15, Y8_15_2);
            AE_MULAAAA2Q8(acc3, acc7, X8_15, Y8_15_3);
        ...
        if (N&15) // if N%16!=0 
        {
            ...
            Y0_7_0 = AE_L8X8_I ((const ae_int8x8*)y_0, 0); 
            Y0_7_1 = AE_L8X8_I ((const ae_int8x8*)y_1, 0); 
            Y0_7_2 = AE_L8X8_I ((const ae_int8x8*)y_2, 0); 
            Y0_7_3 = AE_L8X8_I ((const ae_int8x8*)y_3, 0); 
