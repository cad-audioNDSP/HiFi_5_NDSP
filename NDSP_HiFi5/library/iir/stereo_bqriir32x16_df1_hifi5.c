...
#else
  NASSERT(  M > 0 );
  return ( ALIGNED_SIZE( sizeof(stereo_bqriir32x16_df1_t), sizeof(void *) )
                                                             ...
                                                             int16_t         gainr )
{
  ...
  ptr = objmem;
  stereo_bqriir = (stereo_bqriir32x16_df1_ptr_t)ALIGNED_ADDR( ptr, sizeof(void *) );
  ptr           = stereo_bqriir + 1;
...
{
#if (ALG_STEREO_32X16_DF1_ND == 1)
    return stereo_bqriir32x16_df1_nd_groupDelay(_bqriir);
#else
    return 0;
#endif
