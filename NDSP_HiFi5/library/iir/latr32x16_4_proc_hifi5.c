...
void latr32x16_4_proc( int32_t * restrict r,     // r[N]     [out   ] Q31
                  ...
                  int16_t scale, int N, int M )   // scale    [in    ] Q15
{
  ...
  // Q1.30
  dl_32 = AE_L32X2_I( D, +0 );
  dl_10 = AE_L32X2_I( D, +8 );
  ...
  for ( n=0; n<N; n++ )
  {
    ...
    // d2 d1
    select_f32x2_lh( dl_21, dl_32, dl_10,1 );
    ...
    // d1; d0 = p0
    select_f32x2_ll( dl_10, dl_10, p0,1 );
  ...
  // Q1.30
  AE_S32X2_I( dl_32, D, +0 );
  AE_S32X2_I( dl_10, D, +8 );
