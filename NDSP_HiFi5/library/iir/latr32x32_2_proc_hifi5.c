...
/*
  NatureDSP Signal Processing Library. IIR part
    Lattice Block Real IIR, 32x32-bit, M==2
...
void latr32x32_2_proc(       int32_t * restrict r,     // r[N]     [out   ] Q31
                             ...
                             int32_t scale, int N, int M )  // scale    [in    ] Q31
{
    ...
    for ( n=0; n<N; n++ )
    {
        ...
        AE_MULSSFD32S_HH_LL(q0,d01,c01);
        t0=AE_ROUND32X2F64SASYM(q0,q0);
        d01=AE_SEL32_HH(0,d01);
        AE_MULAFP32X2RS(d01,t0,AE_MOVDA32X2(0x7fffffff,coef[0]));
        // Make the output sample.
        rn=AE_TRUNCI32F64S_L(rn,q0,1);
        AE_S32_L_IP(rn,pr,4);
    }
