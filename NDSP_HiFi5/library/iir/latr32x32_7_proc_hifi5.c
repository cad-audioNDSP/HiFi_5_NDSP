...
/*
  NatureDSP Signal Processing Library. IIR part
    Lattice Block Real IIR, 32x32-bit, M=7
...
void latr32x32_7_proc(       int32_t * restrict r,     // r[N]     [out   ] Q31
                             ...
                             int32_t scale, int N, int M )  // scale    [in    ] Q31
{
    ...
    int _scale=scale>>1,_c5;
    const ae_int32* restrict px=(const ae_int32*)x;
          ae_int32* restrict pr=(      ae_int32*)r;
    ae_int32x2 s,c01,c12,c23,c34,c45,c67,c_0,xn,rn,c5;
    ae_f32x2 d67,d45,d23,d01,_t0;
    ae_f64 q0,q1;
    ...
    for ( n=0; n<N; n++ )
    {
        ...
        AE_MULSF32S_HH(q0,d67,c67);
        AE_MULSF32S_LL(q0,d45,c45);
        _t0=AE_ROUND32X2F64SASYM(q0,q0);
        d67=AE_SEL32_LL(d45,d45);
        XT_MOVEQZ(_c5,_c5,_c5);     // cache c5 in AR
        c5=AE_MOVDA32(_c5);

        AE_MULAFP32X2RS(d67,_t0,c5);

        AE_MULSF32S_HH(q0,d45,c45);
        q1=q0;
        //c23=AE_L32X2_I(pc,8);
        AE_MULSF32S_LL(q1,d23,c23);
        _t0=AE_ROUND32X2F64SASYM(q1,q0);
        d45=AE_SEL32_LH(d23,d45);
        AE_MULAFP32X2RS(d45,_t0,c34);
