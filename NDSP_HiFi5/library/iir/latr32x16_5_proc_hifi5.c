...
void latr32x16_5_proc( int32_t * restrict r,     // r[N]     [out   ] Q31
                  ...
                  int16_t scale, int N, int M )   // scale    [in    ] Q15
{
  ...
  // Q1.30
  dl_43 = AE_L32X2_I( D,  +0 );
  dl_21 = AE_L32X2_I( D,  +8 );
  dl_0z = AE_L32X2_I( D, +16 );
  ...
  for ( n=0; n<N; n++ )
  {
    ...
    // d3 d2
    select_f32x2_lh( dl_43, dl_43, dl_21,0 );
    ...
    // d1 d0
    select_f32x2_lh( dl_21, dl_21, dl_0z,0 );
    ...
    // d0 = p0; 0
    select_f32x2_ll( dl_0z, p1, dl_0z,0 );
  ...
  // Q1.30
  AE_S32X2_I( dl_43, D,  +0 );
  AE_S32X2_I( dl_21, D,  +8 );
  AE_S32X2_I( dl_0z, D, +16 );
