...
size_t stereo_bqriir16x16_df1_alloc( int M )
{
  ...
  return ( ALIGNED_SIZE( sizeof(stereo_bqriir16x16_df1_t), 4 )
                                                             ...
                                                             int16_t         gainr )
{
  ...
  ptr = objmem;
  stereo_bqriir = (stereo_bqriir16x16_df1_ptr_t)ALIGNED_ADDR( ptr, 4 );
  ptr       = stereo_bqriir + 1;
  ...
  ASSERT( (int8_t*)ptr - (int8_t*)objmem <= (int)stereo_bqriir16x16_df1_alloc(M ) );
