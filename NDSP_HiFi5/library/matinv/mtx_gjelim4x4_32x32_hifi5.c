...
/* ------------------------------------------------------------------------ */
/*
 * Real Matrix Gauss-Jordan Elimination for linear equation problem 4x4, 32-bit 
   fixed point API
...
int  mtx_gjelim4x4_32x32  (void* pScr, int32_t *y, const int32_t* A,const int32_t * x, int qA, int qX) 
{
    ...
    for (k=0; k<N; k++)
    {
        ...
        ae_int16x4 minnsaB0,minnsaB1,minnsaC;
        pB=(ae_int32x2*)B;
        pC=(ae_int32x2*)C;
        {
            ...
            minnsaB0=AE_NSA32X4(b0,b1);
            minnsaB1=AE_NSA32X4(b2,b3);
        ...
        // Gauss-Jordan elimination
        {
            ...
            {
                ae_int32x2 b0,b1,b2,b3,b4,b5,b6,b7,c0,c1;
                AE_L32X2X2_IP (b0,b1,castxcc(ae_int32x4,pB),sizeof(ae_int32x4));
                AE_L32X2X2_IP (b2,b3,castxcc(ae_int32x4,pB),sizeof(ae_int32x4));
