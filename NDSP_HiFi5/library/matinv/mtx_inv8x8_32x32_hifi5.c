...
int  mtx_inv8x8_32x32  (void* pScr, int32_t *x, int qX)
{
    ...
    for (k=0; k<N; k++)
    {
        ...
        // Gauss-Jordan elimination: might be made using curcular addressing on B/C
        {
            ...
            AE_L32X2X2_XC (Bk0,Bk1,castxcc(ae_int32x4,pB),4*sizeof(ae_int32x2));
            pT=(ae_int32x2*)(T+k);
...
//            NASSERT(e>0);
            ...
            for (i=0; i<N-1; i++)
            {
                ...
                AE_L32X2X2_XC (Bin0,Bin1,castxcc(ae_int32x4,pB),4*sizeof(ae_int32x2));
                ...
                AE_S32X2X2_XC (Bin0,Bin1,castxcc(ae_int32x4,pBwr),4*sizeof(ae_int32x2));
            }
            AE_L32_XC1(Ti,castxcc(ae_int32,pT),sizeof(int32_t));
            ...
            AE_S32X2X2_XC (Bk0,Bk1,castxcc(ae_int32x4,pBwr),4*sizeof(ae_int32x2));
            __Pragma("no_reorder");
        }
        pB=(ae_int32x2*)(B+k);
