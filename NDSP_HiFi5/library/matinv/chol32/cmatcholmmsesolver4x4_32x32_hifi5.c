    ...
    const int32_t sigma2, int qRA,int qYBRA,int qXYR)
{
    ...
    tcmatcholmmsesolver_32x32_getScratch (&scr, pScr, 4);
    pScr=scr.pEnd;
       cmatcholdecomp4x4_32x32(pScr, scr.R, scr.D, A, sigma2, qRA);
    cmatcholfwdsubst4x4_32x32(pScr, scr.y, scr.R, scr.D, A, B, qYBRA);
    cmatcholbkwsubst4x4_32x32(pScr, x, scr.R, scr.D, scr.y, qXYR);
}
size_t  cmatcholmmsesolver4x4_32x32_getScratchSize()
{
    tcmatcholmmsesolver_32x32_Scratch scr;
    size_t sz;
    tcmatcholmmsesolver_32x32_getScratch (&scr, NULL, 4);
    sz = XT_MAX(XT_MAX(    cmatcholdecomp4x4_32x32_getScratchSize(),
                  cmatcholfwdsubst4x4_32x32_getScratchSize()),
