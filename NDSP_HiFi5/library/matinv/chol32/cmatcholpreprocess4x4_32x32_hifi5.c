...
#define N 4
    ...
    for (m=0; m<N; m+=2)
    {
        ...
        for (n=m; n<N; n++)
        {
			...
			AE_L32X2X2_IP(akmreim0, akmreim1, pAm, N*sizeof(ae_int32x2));
            AE_L32X2_IP(aknreim ,pAn,N*sizeof(ae_int32x2));
			...
			AE_L32X2X2_IP(akmreim0, akmreim1, pAm, -(N - 1)*N*(int)sizeof(ae_int32x2));
...
size_t  cmatcholpreprocess4x4_32x32_getScratchSize()   { return 0; }
