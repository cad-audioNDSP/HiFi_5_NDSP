    ...
    const int32_t sigma2, int qRA,int qYBRA,int qXYR)
{
    ...
    tmatcholmmsesolver_32x32_getScratch (&scr, pScr, 8);
    pScr=scr.pEnd;
       matcholdecomp8x8_32x32(pScr, scr.R, scr.D, A, sigma2, qRA);
    matcholfwdsubst8x8_32x32(pScr, scr.y, scr.R, scr.D, A, B, qYBRA);
    matcholbkwsubst8x8_32x32(pScr, x, scr.R, scr.D, scr.y, qXYR);
}
size_t  matcholmmsesolver8x8_32x32_getScratchSize()
{
    tmatcholmmsesolver_32x32_Scratch scr;
    size_t sz;
    tmatcholmmsesolver_32x32_getScratch (&scr, NULL, 8);
    sz = MAX(MAX(    matcholdecomp8x8_32x32_getScratchSize(),
                  matcholfwdsubst8x8_32x32_getScratchSize()),
                  matcholbkwsubst8x8_32x32_getScratchSize());
    return sz+scr.sz;
}
