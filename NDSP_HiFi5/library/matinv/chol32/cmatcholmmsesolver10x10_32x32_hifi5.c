...
{
    tcmatcholmmsesolver_32x32_Scratch scr;
    NASSERT(x);
    NASSERT(A);
    NASSERT(B);
    ...
    tcmatcholmmsesolver_32x32_getScratch (&scr, pScr, 10);
    pScr=scr.pEnd;
       cmatcholdecomp10x10_32x32(pScr, scr.R, scr.D, A, sigma2, qRA);
    cmatcholfwdsubst10x10_32x32(pScr, scr.y, scr.R, scr.D, A, B, qYBRA);
    cmatcholbkwsubst10x10_32x32(pScr, x, scr.R, scr.D, scr.y, qXYR);
}
size_t  cmatcholmmsesolver10x10_32x32_getScratchSize()
{
    tcmatcholmmsesolver_32x32_Scratch scr;
    size_t sz;
    tcmatcholmmsesolver_32x32_getScratch (&scr, NULL, 10);
    sz = XT_MAX(XT_MAX(    cmatcholdecomp10x10_32x32_getScratchSize(),
                  cmatcholfwdsubst10x10_32x32_getScratchSize()),
                  cmatcholbkwsubst10x10_32x32_getScratchSize());
    return sz+scr.sz;
}
