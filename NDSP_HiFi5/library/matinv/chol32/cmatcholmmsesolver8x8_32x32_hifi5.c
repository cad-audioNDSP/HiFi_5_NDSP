    ...
    const int32_t sigma2, int qRA,int qYBRA,int qXYR)
{
    ...
    tcmatcholmmsesolver_32x32_getScratch (&scr, pScr, 8);
    pScr=scr.pEnd;
       cmatcholdecomp8x8_32x32(pScr, scr.R, scr.D, A, sigma2, qRA);
    cmatcholfwdsubst8x8_32x32(pScr, scr.y, scr.R, scr.D, A, B, qYBRA);
    cmatcholbkwsubst8x8_32x32(pScr, x, scr.R, scr.D, scr.y, qXYR);
}
size_t  cmatcholmmsesolver8x8_32x32_getScratchSize()
{
    tcmatcholmmsesolver_32x32_Scratch scr;
    size_t sz;
    tcmatcholmmsesolver_32x32_getScratch (&scr, NULL, 8);
    sz = XT_MAX(XT_MAX(    cmatcholdecomp8x8_32x32_getScratchSize(),
                  cmatcholfwdsubst8x8_32x32_getScratchSize()),
                  cmatcholbkwsubst8x8_32x32_getScratchSize());
    return sz+scr.sz;
}
