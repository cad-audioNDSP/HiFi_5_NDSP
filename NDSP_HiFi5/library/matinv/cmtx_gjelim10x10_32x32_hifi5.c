...
int  cmtx_gjelim10x10_32x32  (void* pScr, complex_fract32 *y, const complex_fract32* A,const complex_fract32 * x, int qA, int qX)
{
    ...
    for (k=0; k<N; k++)
    {
        ...
        pC=(ae_int32x2 *)C;
        {
            ...
            for(n=0; n<(N); n++) 
            {
                ae_int32x2 b0,b1,b2,b3,b4,b5,b6,b7,b8,b9,c0;
                ...
                AE_L32X2X2_IP(b8,b9,castxcc(ae_int32x4,pB),2*sizeof(ae_int32x2));
                ...
                minnsaB0=AE_MIN16(minnsaB0,AE_NSA32X4(b8,b9));
        ...
        case 0: // k=0...3
            {
                ...
                ae_int32x2 Cin;
                ae_int32x2 Ti,Ckn;
                ae_int32x2 Bk0,Bk1,Bk2,Bk3,Bk4,Bk5,Bk6,Bk7,Bk8,Bk9;
                pB=(ae_int32x2 *)B;
                pC=(ae_int32x2 *)C;
                pBwr=(ae_int32x2 *)B;
                pCwr=(ae_int32x2 *)C;
                ...
                for (n=0; n<N; n++)
                {
                    ...
                    AE_L32X2X2_IP(b8,b9,castxcc(ae_int32x4,pB),sizeof(ae_int32x4));
                    ...
                    AE_MUL2P32X4(b8,b9,b8,b9,expB_coef,expB_coef);
                    ...
                    AE_S32X2X2_IP(b8,b9,castxcc(ae_int32x4,pBwr),sizeof(ae_int32x4));
                ...
                AE_L32X2X2_I (Bk8,Bk9,(const ae_int32x4*)pB,4*sizeof(ae_int32x4));
                ...
                for (i=0; i<N-1; i++)
                {
                    ae_int32x2 Bin0,Bin1,Bin2,Bin3,Bin4,Bin5,Bin6,Bin7,Bin8,Bin9;
                    Ti=AE_L32X2_I(pT,0);
                    Ti=AE_NEG32S(Ti);
                    ...
                    AE_L32X2X2_I (Bin8,Bin9,(const ae_int32x4*)pB,4*sizeof(ae_int32x4));
                    ...
                    AE_MULF2P32X4RAS(Bin8,Bin9,Bin8,Bin9,esh_coef,esh_coef);
                    ...
                    AE_MULAFC32RAS(Bin8,Bk8,Ti);
                    AE_MULAFC32RAS(Bin9,Bk9,Ti);
                    ...
                    AE_S32X2X2_I (Bin8,Bin9,(ae_int32x4*)pBwr,4*sizeof(ae_int32x4));
                ...
                Bk8=AE_MULFC32RAS(Bk8,Ti);
                Bk9=AE_MULFC32RAS(Bk9,Ti);
                ...
                AE_S32X2X2_I (Bk8,Bk9,(ae_int32x4*)pBwr,4*sizeof(ae_int32x4));
        ...
        case 1: // k=4...7
            {
                ...
                ae_int32x2 Cin;
                ae_int32x2 Ti,Ckn;
                ae_int32x2 Bk4,Bk5,Bk6,Bk7,Bk8,Bk9;
                pB=((ae_int32x2 *)B)+4;
                pC=(ae_int32x2 *)C;
                pBwr=((ae_int32x2 *)B)+4;
                pCwr=(ae_int32x2 *)C;
                ...
                for (n=0; n<N; n++)
                {
                    ae_int32x2 b4,b5,b6,b7,b8,b9,c0;
                    AE_L32X2X2_IP(b4,b5,castxcc(ae_int32x4,pB),sizeof(ae_int32x4));
                    AE_L32X2X2_IP(b6,b7,castxcc(ae_int32x4,pB),sizeof(ae_int32x4));
                    AE_L32X2X2_IP(b8,b9,castxcc(ae_int32x4,pB),3*sizeof(ae_int32x4));
                    AE_L32X2_IP(c0,castxcc(ae_int32x2,pC),sizeof(ae_int32x2));
                    AE_MUL2P32X4(b4,b5,b4,b5,expB_coef,expB_coef);
                    AE_MUL2P32X4(b6,b7,b6,b7,expB_coef,expB_coef);
                    AE_MUL2P32X4(b8,b9,b8,b9,expB_coef,expB_coef);
                    ...
                    AE_S32X2X2_IP(b4,b5,castxcc(ae_int32x4,pBwr),sizeof(ae_int32x4));
                    AE_S32X2X2_IP(b6,b7,castxcc(ae_int32x4,pBwr),sizeof(ae_int32x4));
                    AE_S32X2X2_IP(b8,b9,castxcc(ae_int32x4,pBwr),3*sizeof(ae_int32x4));
                    AE_S32X2_IP(c0,castxcc(ae_int32x2,pCwr),sizeof(ae_int32x2));
                }
                __Pragma("no_reorder");
                pC=(ae_int32x2 *)C;
                ...
                AE_L32X2X2_I (Bk8,Bk9,(const ae_int32x4*)pB,2*sizeof(ae_int32x4));
                ...
                for (i=0; i<N-1; i++)
                {
                    ae_int32x2 Bin4,Bin5,Bin6,Bin7,Bin8,Bin9;
                    Ti=AE_L32X2_I(pT,0);
                    Ti=AE_NEG32S(Ti);
                    Cin=AE_L32X2_X (pT,(int)((uintptr_t)C-(uintptr_t)T));
                    Cin=AE_SLAA32S(Cin,-e);
                    ...
                    AE_L32X2X2_I (Bin8,Bin9,(const ae_int32x4*)pB,2*sizeof(ae_int32x4));
                    ...
                    AE_S32X2X2_I (Bin8,Bin9,(ae_int32x4*)pBwr,2*sizeof(ae_int32x4));
                ...
                AE_S32X2X2_I (Bk8,Bk9,(ae_int32x4*)pBwr,2*sizeof(ae_int32x4));
        ...
        case 2: // k=8..9
            {
                ...
                {
                    ae_int32x2 b8,b9,c0;
                    AE_L32X2X2_IP(b8,b9,castxcc(ae_int32x4,pB),5*sizeof(ae_int32x4));
                    AE_L32X2_IP(c0,castxcc(ae_int32x2,pC),sizeof(ae_int32x2));
                    AE_MUL2P32X4(b8,b9,b8,b9,expB_coef,expB_coef);
                    c0=AE_MULP32X2(c0,expC_coef);
                    AE_S32X2X2_IP(b8,b9,castxcc(ae_int32x4,pBwr),5*sizeof(ae_int32x4));
                    AE_S32X2_IP(c0,castxcc(ae_int32x2,pCwr),sizeof(ae_int32x2));
                }
                __Pragma("no_reorder");
                pC=(ae_int32x2 *)C;
                ...
                pB=(B+k*N+8);
                pT=(T+k);
                AE_L32X2X2_XC(Bk8,Bk9,castxcc(ae_int32x4,pB),N*sizeof(ae_int32x2));
                AE_ADDCIRC32X2_XC1(pT,sizeof(ae_int32x2));
                pBwr=pB;
                esh_coef=AE_SLAA32S(0x40000000,-e+1);
                for (i=0; i<N-1; i++)
                {
                    ae_int32x2 Bin8,Bin9;
                    Ti=AE_L32X2_I(pT,0);
                    Ti=AE_NEG32S(Ti);
                    Cin=AE_L32X2_X (pT,(int)((uintptr_t)C-(uintptr_t)T));
                    Cin=AE_SLAA32S(Cin,-e);
                    ...
                    AE_S32X2_X (Cin,pT,(int)((uintptr_t)C-(uintptr_t)T));
                    AE_ADDCIRC32X2_XC1(pT,sizeof(ae_int32x2));
                    AE_L32X2X2_XC(Bin8,Bin9,castxcc(ae_int32x4,pB),N*sizeof(ae_int32x2));
                    AE_MULF2P32X4RAS(Bin8,Bin9,Bin8,Bin9,esh_coef,esh_coef);
                    AE_MULAFC32RAS(Bin8,Bk8,Ti);
                    AE_MULAFC32RAS(Bin9,Bk9,Ti);
                    AE_S32X2X2_XC(Bin8,Bin9,castxcc(ae_int32x4,pBwr),N*sizeof(ae_int32x2));
                }
                Ti=AE_L32X2_I(pT,0);
                Ckn=AE_MULFC32RAS(Ckn,Ti);
                AE_S32X2_X (Ckn,pT,(int)((uintptr_t)C-(uintptr_t)T));
                Bk8=AE_MULFC32RAS(Bk8,Ti);
                Bk9=AE_MULFC32RAS(Bk9,Ti);
                AE_S32X2X2_XC(Bk8,Bk9,castxcc(ae_int32x4,pBwr),N*sizeof(ae_int32x2));
                pBwr=(B+k);
                for (i=0; i<N; i++)  AE_S32X2_XP(AE_ZERO32(),pBwr,N*sizeof(ae_int32x2));
                __Pragma("no_reorder");
            }
...
{ 
    return  (10*10+2*10)*sizeof(complex_fract32);  
}
