...
int  mtx_inv3x3_32x32  (void* pScr, int32_t *x, int qX) 
{
    ...
    // copy input
    {
        ...
        pC=(ae_int32x2*)C;
        AE_S32X2X2_I(AE_MOVDA32X2(0x7fffffff,0),0,(ae_int32x4*)pC,0*sizeof(ae_int32x4));
        AE_S32X2X2_I(AE_MOVDA32X2(0,0x7fffffff),0,(ae_int32x4*)pC,1*sizeof(ae_int32x4));
        AE_S32X2X2_I(0,AE_MOVDA32X2(0x7fffffff,0),(ae_int32x4*)pC,2*sizeof(ae_int32x4));
    }
    qB=31;
...
//            NASSERT(e>0);
    ...
    // copy back to the output
    {
        ...
        ax=AE_ZALIGN128();
        pX=(ae_int32x2*)x;
        AE_SA32X2X2_IP(c0,AE_SEL32_HH(c1,c2),ax,castxcc(ae_int32x4,pX));
        AE_SA32X2X2_IP(AE_SEL32_LH(c2,c3),c4,ax,castxcc(ae_int32x4,pX));
