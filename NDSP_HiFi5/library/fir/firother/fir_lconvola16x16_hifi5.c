...
/*
  NatureDSP Signal Processing Library. FIR part
    Linear Convolution, 16x16-bit, no requirements on vectors
                 ...
                 const int16_t  * restrict y, int N, int M)
{
    ...
    s_ptr = y_buf + M + 6;
    ASSERT((int8_t *)s_ptr - (int8_t *)s <= (int)FIR_LCONVOLA16X16_SCRATCH_SIZE(N, M));
    ...
    raw_lxcorr16x16(r, x_buf, y_buf, N, M);
} /* fir_lconvola16x16() */
