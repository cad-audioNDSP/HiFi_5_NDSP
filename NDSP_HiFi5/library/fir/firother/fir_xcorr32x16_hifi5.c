               ...
               int N, int M )
{
    ...
    for (n = 0; n < (N >> 4); n++)
    {
        ...
        AE_L32X2X2_XC(x0, x1, pX, 4 * sizeof(int32_t)); S0 = pX;
        AE_L32X2X2_XC(x2, x3, pX, 4 * sizeof(int32_t)); S1 = pX;
        AE_L32X2X2_XC(x4, x5, pX, 4 * sizeof(int32_t)); S2 = pX;
        AE_L32X2X2_XC(x6, x7, pX, 4 * sizeof(int32_t)); S3 = pX; S4 = pX;
        AE_L32X2X2_XC(x8, x9, S4, 4 * sizeof(int32_t));
        ...
        {
            AE_L16X4_IP(y0, pY, 4 * sizeof(int16_t));
            AE_L32X2X2_XC(x0, x1, S0, 4 * sizeof(int32_t));
            AE_L32X2X2_XC(x2, x3, S1, 4 * sizeof(int32_t));
            AE_L32X2X2_XC(x4, x5, S2, 4 * sizeof(int32_t));
            AE_L32X2X2_XC(x6, x7, S3, 4 * sizeof(int32_t));
            AE_L32X2X2_XC(x8, x9, S4, 4 * sizeof(int32_t));
