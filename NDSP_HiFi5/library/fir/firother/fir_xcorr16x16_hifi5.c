               ...
               int N, int M )
{
  ...
  //
    ...
    for (n = 0; n < (N >> 4); n++)
    {
        ...
        AE_L16X4_XC(x0, pX, 4 * sizeof(int16_t));
        S0 = pX;
        AE_L16X4_XC(x1, pX, 4 * sizeof(int16_t));
        AE_L16X4_XC(x2, pX, 4 * sizeof(int16_t));
        S1 = pX;
        AE_L16X4_XC(x3, pX, 4 * sizeof(int16_t));
        S2 = pX;
        AE_L16X4_XC(x4, S2, 4 * sizeof(int16_t));
        ...
        for (m = 0; m < (M >> 2) - 1; m++)
        {
            ...
            AE_L16X4_XC(x0, S0, 4 * sizeof(int16_t));
            x1 = AE_L16X4_I(S0, 0);
            AE_L16X4_XC(x2, S1, 4 * sizeof(int16_t));
            x3 = AE_L16X4_I(S1, 0);
            AE_L16X4_XC(x4, S2, 4 * sizeof(int16_t));
    ...
    if (N & 8)
    {
        ...
        for (m = 0; m < (M >> 2); m++)
        {
            ...
            AE_L16X4_XC(x0, S0, 4 * sizeof(int16_t));
            AE_L16X4_XC(x1, S1, 4 * sizeof(int16_t));
            x2 = AE_L16X4_I(S1, 0);
