...
void conv2d_gen_11x7_16x16(void * pScr, int16_t * z, const int16_t * x, const int16_t * y, int rsh, int P, int Q)
{
#define M 11
#define N 7
    ...
    // preload X and save in scratch
    {
        ...
        for (m = 0; m < M; ++m)
        {
            AE_L16_IP(w7, pX, sizeof(ae_int16));
            AE_L16_IP(w6, pX, sizeof(ae_int16));
            ...
            W01 = w0;
            W01 = AE_SEL16_6543(W01, w5);
            W01 = AE_SEL16_6543(W01, w6);
            W01 = AE_SEL16_6543(W01, w7);
            W01 = AE_SEL16_6543(W01, w0);
        ...
        if (mmax - mmin != 1)
        {
            ...
            //last iteration
            {
                ...
                if (j < Q)
                {
                    ...
                    for (; j < Q; ++j)
                    {
                        AE_DSEL16X4(T0, T1, T0, T1, AE_MOVF16X4_FROMINT64(0x0602050104000307));
                        Y00 = AE_SEL16_6543(Y00, Y01);
                        Y01 = AE_SEL16_6543(Y01, Y02);
                        Y02 = AE_SEL16_6543(Y02, Y03);
                        Y03 = AE_SEL16_6543(Y03, 0);
...
size_t conv2d_gen_11x7_16x16_getScratchSize(int P, int Q)
{
    const int M = 11;
    return (M + 1) * 2 * sizeof(ae_int16x4) + (Q + 16) * sizeof(int64_t);
} // MxN=11x7
