    ...
    for (i = 0; i < P + M - 1; i += 1)
    {
        ...
        if (mmax - mmin == 11)
        {
            ...
            // first 4 iteration
            {
                ...
                AE_L8X8_XP(Y01, pY0, 2 * sizeof(ae_int8));
                Y00 = AE_SEL8X8I(Y00, Y01, 5);
                al0 = AE_LA64_PP(pY0);

                AE_L8X8_XP(Y11, pY1, 2 * sizeof(ae_int8));
                Y10 = AE_SEL8X8I(Y10, Y11, 5);
                al1 = AE_LA64_PP(pY1);

                AE_L8X8_XP(Y21, pY2, 2 * sizeof(ae_int8));
                Y20 = AE_SEL8X8I(Y20, Y21, 5);
                al2 = AE_LA64_PP(pY2);

                AE_L8X8_XP(Y31, pY3, 2*sizeof(ae_int8));
...
#define N 7
    ...
    //ae_int16x4 Y40, Y41, Y42, Y43;
    //ae_int16x4 Y50, Y51, Y52, Y53;
    ...
    for (i = 0; i < P + M - 1; i += 1)
    {
        ...
        case 11:
        {
            ...
            // first 2 iteration
            {
                ...
                AE_L8X4S_IP(W20, pW, 4 * sizeof(ae_int8)); AE_L8X4S_IP(W21, pW, 4 * sizeof(ae_int8));

                for (j = 0; j < (Q >> 3); ++j)
                {
                    AE_L8X4S_IP(Y02, pY0, 4 * sizeof(int8_t)); AE_L8X4S_IP(Y03, pY0, 4 * sizeof(int8_t));
                    AE_L8X4S_IP(Y12, pY1, 4 * sizeof(int8_t)); AE_L8X4S_IP(Y13, pY1, 4 * sizeof(int8_t));
                    AE_L8X4S_IP(Y22, pY2, 4 * sizeof(int8_t)); AE_L8X4S_IP(Y23, pY2, 4 * sizeof(int8_t));
                    ...
                    AE_MULAFQ16X2_FIR_1(S0, S1, Y20, Y21, W20);
                    AE_MULAFQ16X2_FIR_3(S2, S3, Y21, Y22, W20);
                    ...
                    AE_MULAFQ16X2_FIR_1(S4, S5, Y21, Y22, W20);
                    AE_MULAFQ16X2_FIR_3(S6, S7, Y22, Y23, W20);
                    ...
                    AE_MULAFQ16X2_FIR_1(S0, S1, Y21, Y22, W21);
                    AE_MULAFQ16X2_FIR_3(S2, S3, Y22, Y23, W21);
                    ...
                    AE_MULAFQ16X2_FIR_1(S4, S5, Y22, Y23, W21);
                    AE_MULAFQ16X2_FIR_3(S6, S7, Y23, Y23, W21);
