...
void conv2d_gen_5x5_8x16(void* pScr, int16_t* z, const int8_t* x, const int16_t* y, int rsh, int P, int Q)
{
#define M 5
#define N 5
...
size_t conv2d_gen_5x5_8x16_getScratchSize(int P, int Q)
{
...
void conv2d_gen_5x5_8x16(void * pScr, int16_t * z, const int8_t * x, const int16_t * y, int rsh, int P, int Q)
{
    ...
    conv2d_gen_5x5_16x16((int16_t*)pScr + 32, z, (const int16_t*)pScr, y, rsh, P, Q);
}

// scratch allocatation functions. return required scratch size in bytes
size_t conv2d_gen_5x5_8x16_getScratchSize(int P, int Q)
{
    return 32 * sizeof(int16_t) + conv2d_gen_5x5_16x16_getScratchSize(P, Q);
}
