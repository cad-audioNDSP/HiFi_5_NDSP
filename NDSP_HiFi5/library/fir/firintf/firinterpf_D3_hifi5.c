...
int fir_interpf_3x( float32_t * restrict y,
              ...
              int wrIx, int D, int N, int M )
{
    ...
    for (n = 0; n < (N >> 3); n++)
    {
        ...
        for (d = 0; d < 3; d++)
        {
            ...
            AE_S32_H_IP(AE_MOVINT32X2_FROMXTFLOATX2(d0), pY, 3*sizeof(float32_t));
            AE_S32_L_IP(AE_MOVINT32X2_FROMXTFLOATX2(d0), pY, 3*sizeof(float32_t));
            AE_S32_H_IP(AE_MOVINT32X2_FROMXTFLOATX2(d1), pY, 3*sizeof(float32_t));
            AE_S32_L_IP(AE_MOVINT32X2_FROMXTFLOATX2(d1), pY, 3*sizeof(float32_t));
            AE_S32_H_IP(AE_MOVINT32X2_FROMXTFLOATX2(d2), pY, 3*sizeof(float32_t));
            AE_S32_L_IP(AE_MOVINT32X2_FROMXTFLOATX2(d2), pY, 3*sizeof(float32_t));
            AE_S32_H_IP(AE_MOVINT32X2_FROMXTFLOATX2(d3), pY, 3*sizeof(float32_t));
            AE_S32_L_XP(AE_MOVINT32X2_FROMXTFLOATX2(d3), pY, (1 - 7 * 3)*(int)sizeof(float32_t));
        }
        pY = (ae_int32 *)XT_ADDX4(7 * 3, (uintptr_t)pY);
    }
...
#elif HAVE_FPU
// for scalar FPU
int fir_interpf_3x( float32_t * restrict z,
