...
int fir32x16_D4_proc(int32_t * restrict y,
               ...
               int wrIx, int D, int N, int M)
{
    ...
    ae_int32x2 d0, d1, d2, d3, d4, d5, d6, d7, d8, d9, da, db, dc, dd;
    ...
    for (n = 0; n < (N >> 3); n++)
    {
        ...
        pH0 = (const ae_int16x8 *)h; pH1 = pH0 + 2;
        ...
        AE_L32X2X2_XC(d8, d9, pD0, 4 * sizeof(int32_t));
        AE_L32X2X2_XC(da, db, pD0, 4 * sizeof(int32_t));
        AE_L32X2X2_I(dc, dd, pD0, 0);

        AE_L16X4X2_I(h0, h1, pH0, 0 * sizeof(int16_t));
        AE_L16X4X2_I(h2, h3, pH0, 8 * sizeof(int16_t));

        AE_MULAAAAQ32X16(q0, d0, d1, h0);
        AE_MULAAAA2Q32X16(q1, q0, d2, d3, h0, h1);
        AE_MULAAAAQ32X16(q2, d4, d5, h0);
        AE_MULAAAA2Q32X16(q1, q0, d4, d5, h1, h2);
        AE_MULAAAA2Q32X16(q3, q2, d6, d7, h0, h1);
        AE_MULAAAA2Q32X16(q1, q0, d6, d7, h2, h3);
        AE_MULAAAA2Q32X16(q3, q2, d8, d9, h1, h2);
        AE_MULAAAAQ32X16(q1, d8, d9, h3);
        AE_MULAAAA2Q32X16(q3, q2, da, db, h2, h3);
        AE_MULAAAAQ32X16(q3, dc, dd, h3);
        ...
        for (m = 0; m < (M >> 3) - 1; m++)
        {
            AE_L32X2X2_XC(d4, d5, pD0, 4 * sizeof(int32_t));
            AE_L32X2X2_XC(d6, d7, pD0, 4 * sizeof(int32_t));
            AE_L32X2X2_I(d8, d9, pD0, 0);

            AE_L16X4X2_IP(h0, h1, pH0, 8 * sizeof(int16_t));
            AE_L16X4X2_IP(h2, h3, pH1, 8 * sizeof(int16_t));

            AE_MULAAAA2Q32X16(q4, q0, d0, d1, h0, h2);
            AE_MULAAAA2Q32X16(q5, q1, d2, d3, h0, h2);
            AE_MULAAAA2Q32X16(q6, q2, d4, d5, h0, h2);
            AE_MULAAAA2Q32X16(q7, q3, d6, d7, h0, h2);

            AE_MULAAAA2Q32X16(q4, q0, d2, d3, h1, h3);
            AE_MULAAAA2Q32X16(q5, q1, d4, d5, h1, h3);
            AE_MULAAAA2Q32X16(q6, q2, d6, d7, h1, h3);
            AE_MULAAAA2Q32X16(q7, q3, d8, d9, h1, h3);
        ...
        AE_MULAAAA2Q32X16(q5, q4, d2, d3, h0, h1);
        AE_MULAAAAQ32X16(q6, d4, d5, h0);
        AE_MULAAAA2Q32X16(q5, q4, d4, d5, h1, h2);
        AE_MULAAAA2Q32X16(q7, q6, d6, d7, h0, h1);
        AE_MULAAAA2Q32X16(q5, q4, d6, d7, h2, h3);
        AE_MULAAAA2Q32X16(q7, q6, d8, d9, h1, h2);
        AE_MULAAAAQ32X16(q5, d8, d9, h3);
        AE_MULAAAA2Q32X16(q7, q6, da, db, h2, h3);
        AE_MULAAAAQ32X16(q7, dc, dd, h3);
