               ...
               int wrIx, int D, int N, int M)
{
    ...
    for (n = 0; n < (N >> 3); n++)
    {
        ...
        AE_ADDCIRC_XC(pDr,  4 * sizeof(int32_t)); pD1 = (const ae_int32x4 *)pDr;
        ...
        for (m = 0; m < (M >> 2) + 1; m++)
        {
            ...
            AE_L32X2X2_I(d4, d5, pD1, 0);
            AE_L32X2X2_XC(d6, d7, pD2, 4 * sizeof(int32_t));
            d8 = AE_L32X2_I((ae_int32x2 *)pD2, 0);
            ...
            AE_MULAAF2D32RA_HH_LL(q0, q1, d1, d2, h1, h1);
            AE_MULAAF2D32RA_HH_LL(q2, q3, d3, d4, h1, h1);
            AE_MULAAF2D32RA_HH_LL(q4, q5, d5, d6, h1, h1);
            AE_MULAAF2D32RA_HH_LL(q6, q7, d7, d8, h1, h1);
