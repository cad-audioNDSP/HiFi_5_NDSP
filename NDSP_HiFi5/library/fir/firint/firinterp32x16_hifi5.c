...
firinterp32x16_handle_t firinterp32x16_init( void * objmem, int D, int M,
                                             const int16_t * restrict h )
{
    ...
    NASSERT((int8_t*)ptr - (int8_t*)objmem <= (int)firinterp32x16_alloc(D, M));
...
{
    firinterp32x16_ptr_t firinterp = (firinterp32x16_ptr_t)handle;
