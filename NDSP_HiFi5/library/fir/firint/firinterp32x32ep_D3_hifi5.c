...
/* Data processing function for a factor 2 interpolating FIR filter. */
 int firinterp32x32ep_D3_proc( int32_t * restrict y,
                                  int32_t * delayLine,
                                  int32_t delayLen,
...
//      D_rd1 = (ae_int32x2*)( (int32_t*)D_rd0 + 1 );
      ...
      AE_S32RA64S_XP( q3, Y, 4-3*D*4 );
      AE_ADDCIRC_XC(castxcc(ae_f64,D_rd0),-8);
      AE_ADDCIRC_XC(castxcc(ae_f64,D_rd1),-12);
    }
  }
