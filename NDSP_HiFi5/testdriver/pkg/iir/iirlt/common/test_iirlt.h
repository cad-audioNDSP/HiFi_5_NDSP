 ...
 */
#ifndef __TEST_IIRLT_H__
#define __TEST_IIRLT_H__
...
#include "../../common/testeng_iir_lat.h"
...
int main_iirlt( int phaseNum, int isFull, int isVerbose, int breakOnError, const tTbl *tbl, int szTbl );

#endif  /* __TEST_IIRLT_H__ */
