...
static const t_kalmanupd1_api kalmanupd1_32x32_api = { &kalmanupd1_32x32_getScratchSize };
...
static const struct {
    ...
    { FUNC_LIST( (tTestEngTarget)&kalmanupd1_32x32), TEST_DESC( FMT_REAL|FMT_FRACT32, 0, &kalmanupd1_32x32_api, TE_DIM_NUM_5, TE_ALIGN_YES,  &te_loadFxn_kalmanupd1, &te_processFxn_kalmanupd1) },
...
int func_iirkal1(int isFull, int isVerbose, int breakOnError)
{
    ...
    #define DO_TEST(fxn, seqFile)                                                                    \
        if ( res || !breakOnError ) res &= ( 0 != te_Exec( testDefTbl,                               \
                                                           ...
                                                           MAX_FUNC_NUM,                             \
                                                           (tTestEngTarget)(fxn), "iirkal1/" seqFile,    \
                                                           isFull, isVerbose, breakOnError ) )
    DO_TEST(&kalmanupd1_32x32, "kalmanupd1_32x32.seq");
    return res;
}
