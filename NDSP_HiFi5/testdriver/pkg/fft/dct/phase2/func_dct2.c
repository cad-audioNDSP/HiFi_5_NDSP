...
{
  { 2, "dct2/dct32f.seq"      , (tTestEngTarget)te_frameProc_stnd_dct     , TEST_DESC_STND( FMT_FLOAT32, ATTR_FAST                      , TE_ALIGN_YES, dctf      , NULL   ) },
  { 2, "dct2/dct64f.seq"      , (tTestEngTarget)te_frameProc_stnd_dct     , TEST_DESC_STND( FMT_FLOAT32, ATTR_FAST                      , TE_ALIGN_YES, dctf      , NULL   ) },
  { 0 } /* End of table */
};
