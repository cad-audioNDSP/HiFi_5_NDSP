...
int func_complexs2(int isFull, int isVerbose, int breakOnError)
{
  ...
  #define DO_TEST( fxn, seqFile, extraFlags )                                                         \
    if ( res || !breakOnError ) res &= ( 0 != testExec( (tTestEngTarget)(fxn), "complexs2/" seqFile,       \
  ...
  {
    {
      ...
      TEST_DESC( FMT_REAL|FMT_FLOAT32, TE_DIM_NUM_1, TE_ALIGN_NO, &te_loadFxn_vXcvZ, &processFxn_scl_vXcvZ ) },
    { 
