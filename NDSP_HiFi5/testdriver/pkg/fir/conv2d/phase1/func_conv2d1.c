...
static const tConv2dApi apiconv2d_gen_3x3_8x8 ={conv2d_gen_3x3_8x8_getScratchSize     ,FMT_REAL|FMT_INT8 ,FMT_REAL|FMT_INT8 };
static const tConv2dApi apiconv2d_gen_5x5_8x8 ={conv2d_gen_5x5_8x8_getScratchSize     ,FMT_REAL|FMT_INT8 ,FMT_REAL|FMT_INT8 };
static const tConv2dApi apiconv2d_gen_11x7_8x8={conv2d_gen_11x7_8x8_getScratchSize    ,FMT_REAL|FMT_INT8 ,FMT_REAL|FMT_INT8 };
static const tConv2dApi apiconv2d_gen_3x3_8x16 ={conv2d_gen_3x3_8x16_getScratchSize   ,FMT_REAL|FMT_INT8 ,FMT_REAL|FMT_INT16};
static const tConv2dApi apiconv2d_gen_5x5_8x16 ={conv2d_gen_5x5_8x16_getScratchSize   ,FMT_REAL|FMT_INT8 ,FMT_REAL|FMT_INT16};
static const tConv2dApi apiconv2d_gen_11x7_8x16={conv2d_gen_11x7_8x16_getScratchSize  ,FMT_REAL|FMT_INT8 ,FMT_REAL|FMT_INT16};
static const tConv2dApi apiconv2d_gen_3x3_16x16 ={conv2d_gen_3x3_16x16_getScratchSize ,FMT_REAL|FMT_INT16,FMT_REAL|FMT_INT16};
static const tConv2dApi apiconv2d_gen_5x5_16x16 ={conv2d_gen_5x5_16x16_getScratchSize ,FMT_REAL|FMT_INT16,FMT_REAL|FMT_INT16};
static const tConv2dApi apiconv2d_gen_11x7_16x16={conv2d_gen_11x7_16x16_getScratchSize,FMT_REAL|FMT_INT16,FMT_REAL|FMT_INT16};
...
testDefTbl[] =
{
    ...
    {   FUNC_LIST((tTestEngTarget)&conv2d_gen_3x3_16x16) ,TEST_DESC(FMT_REAL | FMT_INT16, TE_DIM_NUM_5, &apiconv2d_gen_3x3_16x16   , TE_ALIGN_NO, &te_loadFxn_conv2d, &te_processFxn_conv2d) },
    {   FUNC_LIST((tTestEngTarget)&conv2d_gen_5x5_16x16) ,TEST_DESC(FMT_REAL | FMT_INT16, TE_DIM_NUM_5, &apiconv2d_gen_5x5_16x16   , TE_ALIGN_NO, &te_loadFxn_conv2d, &te_processFxn_conv2d) },
    {   FUNC_LIST((tTestEngTarget)&conv2d_gen_11x7_16x16),TEST_DESC(FMT_REAL | FMT_INT16, TE_DIM_NUM_5, &apiconv2d_gen_11x7_16x16  , TE_ALIGN_NO, &te_loadFxn_conv2d, &te_processFxn_conv2d) },
    {   FUNC_LIST((tTestEngTarget)&conv2d_gen_3x3_8x16)  ,TEST_DESC(FMT_REAL | FMT_INT16, TE_DIM_NUM_5, &apiconv2d_gen_3x3_8x16    , TE_ALIGN_NO, &te_loadFxn_conv2d, &te_processFxn_conv2d) },
    {   FUNC_LIST((tTestEngTarget)&conv2d_gen_5x5_8x16)  ,TEST_DESC(FMT_REAL | FMT_INT16, TE_DIM_NUM_5, &apiconv2d_gen_5x5_8x16    , TE_ALIGN_NO, &te_loadFxn_conv2d, &te_processFxn_conv2d) },
    {   FUNC_LIST((tTestEngTarget)&conv2d_gen_11x7_8x16) ,TEST_DESC(FMT_REAL | FMT_INT16, TE_DIM_NUM_5, &apiconv2d_gen_11x7_8x16   , TE_ALIGN_NO, &te_loadFxn_conv2d, &te_processFxn_conv2d) },
    {   FUNC_LIST((tTestEngTarget)&conv2d_gen_3x3_8x8)   ,TEST_DESC(FMT_REAL | FMT_INT8 , TE_DIM_NUM_5, &apiconv2d_gen_3x3_8x8     , TE_ALIGN_NO, &te_loadFxn_conv2d, &te_processFxn_conv2d) },
    {   FUNC_LIST((tTestEngTarget)&conv2d_gen_5x5_8x8)   ,TEST_DESC(FMT_REAL | FMT_INT8 , TE_DIM_NUM_5, &apiconv2d_gen_5x5_8x8     , TE_ALIGN_NO, &te_loadFxn_conv2d, &te_processFxn_conv2d) },
    {   FUNC_LIST((tTestEngTarget)&conv2d_gen_11x7_8x8)  ,TEST_DESC(FMT_REAL | FMT_INT8 , TE_DIM_NUM_5, &apiconv2d_gen_11x7_8x8    , TE_ALIGN_NO, &te_loadFxn_conv2d, &te_processFxn_conv2d) },
    { {NULL}  } /* End of table */
};
...
int func_conv2d1(int isFull, int isVerbose, int breakOnError)
{
    ...
    #define DO_TEST(fxn, seqFile) if ( res || !breakOnError ) res &= ( 0 != testExec((tTestEngTarget)(fxn), "conv2d1/" seqFile, isFull, isVerbose, breakOnError ) )

    DO_TEST( &conv2d_3x3_8x8        , "conv2d_3x3_8x8.seq"      );
    DO_TEST( &conv2d_gen_3x3_8x8    , "conv2d_gen_3x3_8x8.seq"  );
    DO_TEST( &conv2d_5x5_8x8        , "conv2d_5x5_8x8.seq"      );
    DO_TEST( &conv2d_gen_5x5_8x8    , "conv2d_gen_5x5_8x8.seq"  );
    DO_TEST( &conv2d_11x7_8x8       , "conv2d_11x7_8x8.seq"     );
    DO_TEST( &conv2d_gen_11x7_8x8   , "conv2d_gen_11x7_8x8.seq" );
    
    DO_TEST( &conv2d_3x3_8x16       , "conv2d_3x3_8x16.seq"     );
    DO_TEST( &conv2d_gen_3x3_8x16   , "conv2d_gen_3x3_8x16.seq" );
    DO_TEST( &conv2d_5x5_8x16       , "conv2d_5x5_8x16.seq"     );
    DO_TEST( &conv2d_gen_5x5_8x16   , "conv2d_gen_5x5_8x16.seq" );
    DO_TEST( &conv2d_11x7_8x16      , "conv2d_11x7_8x16.seq"    );
    DO_TEST( &conv2d_gen_11x7_8x16  , "conv2d_gen_11x7_8x16.seq");
    
    DO_TEST( &conv2d_3x3_16x16      , "conv2d_3x3_16x16.seq"    );
    DO_TEST( &conv2d_gen_3x3_16x16  , "conv2d_gen_3x3_16x16.seq");
    DO_TEST( &conv2d_5x5_16x16      , "conv2d_5x5_16x16.seq"    );
    DO_TEST( &conv2d_gen_5x5_16x16  , "conv2d_gen_5x5_16x16.seq");
    DO_TEST( &conv2d_11x7_16x16     , "conv2d_11x7_16x16.seq"   );
    DO_TEST( &conv2d_gen_11x7_16x16 , "conv2d_gen_11x7_16x16.seq");
