...
static const tConv2dApi apiconv2d_gen_3x3f ={conv2d_gen_3x3f_getScratchSize           ,FMT_REAL|FMT_FLOAT32,FMT_REAL|FMT_FLOAT32};
static const tConv2dApi apiconv2d_gen_5x5f ={conv2d_gen_5x5f_getScratchSize           ,FMT_REAL|FMT_FLOAT32,FMT_REAL|FMT_FLOAT32};
static const tConv2dApi apiconv2d_gen_11x7f={conv2d_gen_11x7f_getScratchSize          ,FMT_REAL|FMT_FLOAT32,FMT_REAL|FMT_FLOAT32};
...
testDefTbl[] =
{
    ...
    {   FUNC_LIST((tTestEngTarget)&conv2d_gen_3x3f)      ,TEST_DESC(FMT_REAL | FMT_FLOAT32 , TE_DIM_NUM_5, &apiconv2d_gen_3x3f     , TE_ALIGN_NO, &te_loadFxn_conv2d, &te_processFxn_conv2d) },
    {   FUNC_LIST((tTestEngTarget)&conv2d_gen_5x5f)      ,TEST_DESC(FMT_REAL | FMT_FLOAT32 , TE_DIM_NUM_5, &apiconv2d_gen_5x5f     , TE_ALIGN_NO, &te_loadFxn_conv2d, &te_processFxn_conv2d) },
    {   FUNC_LIST((tTestEngTarget)&conv2d_gen_11x7f)     ,TEST_DESC(FMT_REAL | FMT_FLOAT32 , TE_DIM_NUM_5, &apiconv2d_gen_11x7f    , TE_ALIGN_NO, &te_loadFxn_conv2d, &te_processFxn_conv2d) },
    { {NULL}  } /* End of table */
};
...
int func_conv2d2(int isFull, int isVerbose, int breakOnError)
{
    ...
    #define DO_TEST(fxn, seqFile) if ( res || !breakOnError ) res &= ( 0 != testExec((tTestEngTarget)(fxn), "conv2d2/" seqFile, isFull, isVerbose, breakOnError ) )

    DO_TEST( &conv2d_3x3f       , "conv2d_3x3f.seq"     );
    DO_TEST( &conv2d_gen_3x3f   , "conv2d_gen_3x3f.seq" );
    DO_TEST( &conv2d_5x5f       , "conv2d_5x5f.seq"     );
    DO_TEST( &conv2d_gen_5x5f   , "conv2d_gen_5x5f.seq" );
    DO_TEST( &conv2d_11x7f      , "conv2d_11x7f.seq"    );
    DO_TEST( &conv2d_gen_11x7f  , "conv2d_gen_11x7f.seq");
