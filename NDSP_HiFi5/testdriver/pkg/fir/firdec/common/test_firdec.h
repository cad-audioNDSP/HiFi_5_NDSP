 ...
 */
#ifndef __TEST_FIRDEC_H__
#define __TEST_FIRDEC_H__
...
int test_firdec( int phaseNum, int isFull, int isVerbose, int breakOnError, const tTbl * tbl, int szTbl );

#endif /* __TEST_FIRDEC_H__ */
