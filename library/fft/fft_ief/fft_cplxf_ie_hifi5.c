...
int fft_cplxf_ie    (complex_float * y, complex_float * x, const complex_float* twd, int twdstep, int N )
{
    ...
    if (N == 8)
    {
...

        {
            ...
            ADDANDSUBC_SX2(b2, b6, a4, a5);
            ADDANDSUBC_SX2(b3, b7, a6, a7);
    ...
    for (n = 0; n < N4 / 2; n++)
    {
        ...
        /* a1 <- b2-j*b3 */
        /* a3 <- b2+j*b3 */
        ADDANDSUBJC_S(a3, a1, b2, b3);
        ADDANDSUBJC_S(d3, d1, e2, e3);
...
//        AE_LSX2X2_IP(tw1, tw2, castxcc(xtfloatx4,p_twd), 2 * SZ_CF32);
        ...
        MULMUX_SX2X2(e1, b1, d1, a1, tw1, tw4, 0);
        MADDMUX_SX2X2(e1, b1, d1, a1, tw1, tw4, 1);
        MULMUX_SX2X2(e2, b2, d2, a2, tw2, tw5, 0);
        MADDMUX_SX2X2(e2, b2, d2, a2, tw2, tw5, 1);
        MULMUX_SX2X2(e3, b3, d3, a3, tw3, tw6, 0);
        MADDMUX_SX2X2(e3, b3, d3, a3, tw3, tw6, 1);
    ...
    for (stride = N4 >> 2; stride > 2; stride >>= 2)
    {
        ...
        for (m = 0; m < N4; m += (stride << 1))
        {
            ...
            for (n = 0; n < (stride/2); n++)
            {
                ...
                /* a1 <- b2-j*b3 */
                /* a3 <- b2+j*b3 */
                ADDANDSUBJC_S(a3_n, a1_n, b2_n, b3_n);
                ADDANDSUBJC_S(d3_n, d1_n, e2_n, e3_n);
                ...
                MULMUXQ_S(e1, e1_n, d1, d1_n, tw1, 0);
                MULMUXQ_S(b1, b1_n, a1, a1_n, tw4, 0);
                MADDMUXQ_S(e1, e1_n, d1, d1_n, tw1, 1);
                MADDMUXQ_S(b1, b1_n, a1, a1_n, tw4, 1);

                MULMUX_SX2X2(e2, b2, d2, a2, tw2, tw5, 0);
                MULMUX_SX2X2(e2_n, b2_n, d2_n, a2_n, tw2, tw5, 0);
                MADDMUX_SX2X2(e2, b2, d2, a2, tw2, tw5, 1);
                MADDMUX_SX2X2(e2_n, b2_n, d2_n, a2_n, tw2, tw5, 1);

                MULMUX_SX2X2(e3, b3, d3, a3, tw3, tw6, 0);
                MULMUX_SX2X2(e3_n, b3_n, d3_n, a3_n, tw3, tw6, 0);
                MADDMUX_SX2X2(e3, b3, d3, a3, tw3, tw6, 1);
                MADDMUX_SX2X2(e3_n, b3_n, d3_n, a3_n, tw3, tw6, 1);
    ...
    else
    {
        ...
        for (n = 0; n < (N4 >> 2); n++)
        {
            ...
            ADDANDSUBJC_S(a7, a5, b6, b7);
            ADDANDSUBJC_S(d7, d5, e6, e7);
